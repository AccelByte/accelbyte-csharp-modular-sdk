...
namespace AccelByte.Sdk.Core.Repository
{
    ...
    public static class SharedTokenRepository_SdkBuilderExts
    {
        public static IAccelByteSdkBuilder<T> UseSharedTokenRepository<T>(this IAccelByteSdkBuilder<T> builder)
        {
