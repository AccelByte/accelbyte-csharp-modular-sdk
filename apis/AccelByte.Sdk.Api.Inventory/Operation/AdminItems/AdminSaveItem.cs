...
namespace AccelByte.Sdk.Api.Inventory.Operation
{
    ...
    public class AdminSaveItem : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminSaveItemBuilder
        {
        ...
        public abstract class AdminSaveItemAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminSaveItemBuilder
            where TImpl : AdminSaveItemAbstractBuilder<TImpl>
        {
            ...
            public AdminSaveItemAbstractBuilder() { }

            public AdminSaveItemAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminSaveItem.Response InternalExecute(
                ApimodelsSaveItemReq body,
                string namespace_,
                string userId
            )
            ...
            protected async Task<AdminSaveItem.Response> InternalExecuteAsync(
                ApimodelsSaveItemReq body,
                string namespace_,
                string userId
            )
            ...
            protected AdminSaveItem.Response<T1, T2, T3> InternalExecute<T1, T2, T3>(
                ApimodelsSaveItemReq body,
                string namespace_,
                string userId
            )
            ...
            protected async Task<AdminSaveItem.Response<T1, T2, T3>> InternalExecuteAsync<T1, T2, T3>(
                ApimodelsSaveItemReq body,
                string namespace_,
                string userId
            )
        ...
        public class AdminSaveItemBuilder : AdminSaveItemAbstractBuilder<AdminSaveItemBuilder>
        {
            public AdminSaveItemBuilder() : base() { }

            public AdminSaveItemBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public AdminSaveItem(IAdminSaveItemBuilder builder,
            ApimodelsSaveItemReq body,
            string namespace_,
            string userId
        )
