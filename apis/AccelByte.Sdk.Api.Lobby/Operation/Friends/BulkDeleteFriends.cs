...
namespace AccelByte.Sdk.Api.Lobby.Operation
{
    ...
    public class BulkDeleteFriends : AccelByte.Sdk.Core.Operation
    {
        ...
        public BulkDeleteFriends.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                response.Data = JsonSerializer.Deserialize<Model.ModelBulkFriendsResponse>(payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
            ...
            {
                response.Error500 = JsonSerializer.Deserialize<ModelBulkFriendsResponse>(payload, ResponseJsonOptions);
