...
namespace AccelByte.Sdk.Api.Lobby.Operation
{
    ...
    public class UserGetFriendshipStatus : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ModelUserGetFriendshipStatusResponse>
        {
            ...
            protected override string GetFullOperationId() => "Lobby::Friends::UserGetFriendshipStatus";
        }
        ...
        public UserGetFriendshipStatus.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new UserGetFriendshipStatus.Response()
            {
                StatusCode = code,
