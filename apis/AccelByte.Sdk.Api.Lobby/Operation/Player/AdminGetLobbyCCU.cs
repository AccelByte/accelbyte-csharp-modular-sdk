...
namespace AccelByte.Sdk.Api.Lobby.Operation
{
    ...
    public class AdminGetLobbyCCU : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminGetLobbyCCUBuilder
        {
        ...
        public abstract class AdminGetLobbyCCUAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminGetLobbyCCUBuilder
            where TImpl : AdminGetLobbyCCUAbstractBuilder<TImpl>
        {
            ...
            public AdminGetLobbyCCUAbstractBuilder() { }

            public AdminGetLobbyCCUAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminGetLobbyCCU.Response InternalExecute(
                string namespace_
            )
            {
            ...
            protected async Task<AdminGetLobbyCCU.Response> InternalExecuteAsync(
                string namespace_
            )
            {
                AdminGetLobbyCCU op = Build(
        ...
        public class AdminGetLobbyCCUBuilder : AdminGetLobbyCCUAbstractBuilder<AdminGetLobbyCCUBuilder>
        {
            public AdminGetLobbyCCUBuilder() : base() { }

            public AdminGetLobbyCCUBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public AdminGetLobbyCCU(IAdminGetLobbyCCUBuilder builder,
            string namespace_
        )
        {
        ...
        public AdminGetLobbyCCU.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            else if ((code == (HttpStatusCode)201) || (code == (HttpStatusCode)202) || (code == (HttpStatusCode)200))
            {
                ...
                response.Data = JsonSerializer.Deserialize<Model.ModelsGetLobbyCcuResponse>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
