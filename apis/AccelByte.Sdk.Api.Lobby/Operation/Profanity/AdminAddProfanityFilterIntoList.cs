...
namespace AccelByte.Sdk.Api.Lobby.Operation
{
    ...
    public class AdminAddProfanityFilterIntoList : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminAddProfanityFilterIntoListBuilder
        {
        ...
        public abstract class AdminAddProfanityFilterIntoListAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminAddProfanityFilterIntoListBuilder
            where TImpl : AdminAddProfanityFilterIntoListAbstractBuilder<TImpl>
        {
            ...
            public AdminAddProfanityFilterIntoListAbstractBuilder() { }

            public AdminAddProfanityFilterIntoListAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminAddProfanityFilterIntoList.Response InternalExecute(
                ModelsAdminAddProfanityFilterIntoListRequest body,
                string list,
                string namespace_
            )
            ...
            protected async Task<AdminAddProfanityFilterIntoList.Response> InternalExecuteAsync(
                ModelsAdminAddProfanityFilterIntoListRequest body,
                string list,
                string namespace_
            )
        ...
        public class AdminAddProfanityFilterIntoListBuilder : AdminAddProfanityFilterIntoListAbstractBuilder<AdminAddProfanityFilterIntoListBuilder>
        {
            public AdminAddProfanityFilterIntoListBuilder() : base() { }

            public AdminAddProfanityFilterIntoListBuilder(IAccelByteSdk sdk) : base(sdk) { }

            [Obsolete(DiagnosticId ="ab_deprecated_operation_wrapper")]
            public AdminAddProfanityFilterIntoList.Response Execute(
                ModelsAdminAddProfanityFilterIntoListRequest body,
                string list,
                string namespace_
            )
            ...
            public async Task<AdminAddProfanityFilterIntoList.Response> ExecuteAsync(
                ModelsAdminAddProfanityFilterIntoListRequest body,
                string list,
                string namespace_
            )
        ...
        public AdminAddProfanityFilterIntoList(IAdminAddProfanityFilterIntoListBuilder builder,
            ModelsAdminAddProfanityFilterIntoListRequest body,
            string list,
            string namespace_
        )
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Lobby::Profanity::AdminAddProfanityFilterIntoList";
        }
        ...
        public AdminAddProfanityFilterIntoList.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AdminAddProfanityFilterIntoList.Response()
            {
                StatusCode = code,
