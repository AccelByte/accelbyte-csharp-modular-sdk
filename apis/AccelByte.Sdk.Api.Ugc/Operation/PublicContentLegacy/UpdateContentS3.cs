...
namespace AccelByte.Sdk.Api.Ugc.Operation
{
    ...
    public class UpdateContentS3 : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ModelsCreateContentResponse>
        {
            ...
            protected override string GetFullOperationId() => "Ugc::PublicContentLegacy::UpdateContentS3";
        }
        ...
        public UpdateContentS3.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new UpdateContentS3.Response()
            {
                StatusCode = code,
        ...
        public UpdateContentS3.Response<T1> ParseResponse<T1>(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new UpdateContentS3.Response<T1>()
            {
                StatusCode = code,
                ContentType = contentType
            };
