...
namespace AccelByte.Sdk.Api.Ugc.Operation
{
    ...
    public class AdminGetTag : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<AdminGetTagBuilder>
        {
            ...
            public async Task<Model.ModelsPaginatedGetTagResponse?> ExecuteAsync(
                string namespace_
            )
            {
                AdminGetTag op = Build(
        ...
        public Model.ModelsPaginatedGetTagResponse? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<Model.ModelsPaginatedGetTagResponse>(payload, ResponseJsonOptions);
            }
