...
namespace AccelByte.Sdk.Api.Ugc.Operation
{
    ...
    public class PublicCreateChannel : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ModelsChannelResponse>
        {
            ...
            protected override string GetFullOperationId() => "Ugc::PublicChannel::PublicCreateChannel";
        }
        ...
        public PublicCreateChannel.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new PublicCreateChannel.Response()
            {
                StatusCode = code,
