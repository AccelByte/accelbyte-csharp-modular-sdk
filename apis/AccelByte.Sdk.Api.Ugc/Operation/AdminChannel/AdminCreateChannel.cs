...
namespace AccelByte.Sdk.Api.Ugc.Operation
{
    ...
    public class AdminCreateChannel : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ModelsChannelResponse>
        {
            ...
            protected override string GetFullOperationId() => "Ugc::AdminChannel::AdminCreateChannel";
        }
        ...
        public AdminCreateChannel.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AdminCreateChannel.Response()
            {
                StatusCode = code,
