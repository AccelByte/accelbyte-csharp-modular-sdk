...
namespace AccelByte.Sdk.Api.Session.Operation
{
    ...
    public class AdminQueryPlayerAttributes : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<AdminQueryPlayerAttributesBuilder>
        {
            ...
            public async Task<List<Model.ApimodelsPlayerAttributesResponseBody>?> ExecuteAsync(
                string namespace_
            )
            {
                AdminQueryPlayerAttributes op = Build(
            ...
            public async Task<List<Model.ApimodelsPlayerAttributesResponseBody<T1>>?> ExecuteAsync<T1>(
                string namespace_
            )
            {
                AdminQueryPlayerAttributes op = Build(
