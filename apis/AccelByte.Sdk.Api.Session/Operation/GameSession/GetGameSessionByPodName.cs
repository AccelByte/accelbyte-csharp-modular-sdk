...
namespace AccelByte.Sdk.Api.Session.Operation
{
    ...
    public class GetGameSessionByPodName : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IGetGameSessionByPodNameBuilder
        {
        ...
        public abstract class GetGameSessionByPodNameAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IGetGameSessionByPodNameBuilder
            where TImpl : GetGameSessionByPodNameAbstractBuilder<TImpl>
        {
            ...
            public GetGameSessionByPodNameAbstractBuilder() { }

            public GetGameSessionByPodNameAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected GetGameSessionByPodName.Response InternalExecute(
                string namespace_,
                string podName
            )
            {
            ...
            protected async Task<GetGameSessionByPodName.Response> InternalExecuteAsync(
                string namespace_,
                string podName
            )
            {
            ...
            protected GetGameSessionByPodName.Response<T1, T2> InternalExecute<T1, T2>(
                string namespace_,
                string podName
            )
            {
            ...
            protected async Task<GetGameSessionByPodName.Response<T1, T2>> InternalExecuteAsync<T1, T2>(
                string namespace_,
                string podName
            )
            {
        ...
        public class GetGameSessionByPodNameBuilder : GetGameSessionByPodNameAbstractBuilder<GetGameSessionByPodNameBuilder>
        {
            public GetGameSessionByPodNameBuilder() : base() { }

            public GetGameSessionByPodNameBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public GetGameSessionByPodName(IGetGameSessionByPodNameBuilder builder,
            string namespace_,
            string podName
        )
        {
