...
namespace AccelByte.Sdk.Api.Session.Operation
{
    ...
    public class AdminSyncPlatformCredentials : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminSyncPlatformCredentialsBuilder
        {
        ...
        public abstract class AdminSyncPlatformCredentialsAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminSyncPlatformCredentialsBuilder
            where TImpl : AdminSyncPlatformCredentialsAbstractBuilder<TImpl>
        {
            ...
            public AdminSyncPlatformCredentialsAbstractBuilder() { }

            public AdminSyncPlatformCredentialsAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminSyncPlatformCredentials.Response InternalExecute(
                string namespace_,
                string platformId
            )
            {
            ...
            protected async Task<AdminSyncPlatformCredentials.Response> InternalExecuteAsync(
                string namespace_,
                string platformId
            )
            {
        ...
        public class AdminSyncPlatformCredentialsBuilder : AdminSyncPlatformCredentialsAbstractBuilder<AdminSyncPlatformCredentialsBuilder>
        {
            public AdminSyncPlatformCredentialsBuilder() : base() { }

            public AdminSyncPlatformCredentialsBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public AdminSyncPlatformCredentials(IAdminSyncPlatformCredentialsBuilder builder,
            string namespace_,
            AdminSyncPlatformCredentialsPlatformId platformId
        )
        {
        ...
        public AdminSyncPlatformCredentials.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            else if ((code == (HttpStatusCode)201) || (code == (HttpStatusCode)202) || (code == (HttpStatusCode)200))
            {
                ...
                response.Data = JsonSerializer.Deserialize<Model.ApimodelsXblCertificateResponseBody>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
