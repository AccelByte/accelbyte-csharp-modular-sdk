...
namespace AccelByte.Sdk.Api.Session.Operation
{
    ...
    public class AdminCreateConfigurationTemplateV1 : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminCreateConfigurationTemplateV1Builder
        {
        ...
        public abstract class AdminCreateConfigurationTemplateV1AbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminCreateConfigurationTemplateV1Builder
            where TImpl : AdminCreateConfigurationTemplateV1AbstractBuilder<TImpl>
        {
            ...
            public AdminCreateConfigurationTemplateV1AbstractBuilder() { }

            public AdminCreateConfigurationTemplateV1AbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminCreateConfigurationTemplateV1.Response InternalExecute(
                ApimodelsCreateConfigurationTemplateRequest body,
                string namespace_
            )
            {
            ...
            protected async Task<AdminCreateConfigurationTemplateV1.Response> InternalExecuteAsync(
                ApimodelsCreateConfigurationTemplateRequest body,
                string namespace_
            )
            {
            ...
            protected AdminCreateConfigurationTemplateV1.Response<T1> InternalExecute<T1>(
                ApimodelsCreateConfigurationTemplateRequest body,
                string namespace_
            )
            {
            ...
            protected async Task<AdminCreateConfigurationTemplateV1.Response<T1>> InternalExecuteAsync<T1>(
                ApimodelsCreateConfigurationTemplateRequest body,
                string namespace_
            )
            {
        ...
        public class AdminCreateConfigurationTemplateV1Builder : AdminCreateConfigurationTemplateV1AbstractBuilder<AdminCreateConfigurationTemplateV1Builder>
        {
            public AdminCreateConfigurationTemplateV1Builder() : base() { }

            public AdminCreateConfigurationTemplateV1Builder(IAccelByteSdk sdk) : base(sdk) { }

            public AdminCreateConfigurationTemplateV1.Response Execute(
                ApimodelsCreateConfigurationTemplateRequest body,
                string namespace_
            )
            {
            ...
            public async Task<AdminCreateConfigurationTemplateV1.Response> ExecuteAsync(
                ApimodelsCreateConfigurationTemplateRequest body,
                string namespace_
            )
            {
            ...
            public AdminCreateConfigurationTemplateV1.Response<T1> Execute<T1>(
                ApimodelsCreateConfigurationTemplateRequest body,
                string namespace_
            )
            {
            ...
            public async Task<AdminCreateConfigurationTemplateV1.Response<T1>> ExecuteAsync<T1>(
                ApimodelsCreateConfigurationTemplateRequest body,
                string namespace_
            )
            {
        ...
        public AdminCreateConfigurationTemplateV1(IAdminCreateConfigurationTemplateV1Builder builder,
            ApimodelsCreateConfigurationTemplateRequest body,
            string namespace_
        )
        {
        ...
        public class Response : ApiResponse<Model.ApimodelsConfigurationTemplateResponse>
        {
            ...
            protected override string GetFullOperationId() => "Session::ConfigurationTemplate::AdminCreateConfigurationTemplateV1";
        }
        ...
        public AdminCreateConfigurationTemplateV1.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AdminCreateConfigurationTemplateV1.Response()
            {
                StatusCode = code,
            ...
            else if ((code == (HttpStatusCode)201) || (code == (HttpStatusCode)202) || (code == (HttpStatusCode)200))
            {
                ...
                response.Data = JsonSerializer.Deserialize<Model.ApimodelsConfigurationTemplateResponse>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
        ...
        public AdminCreateConfigurationTemplateV1.Response<T1> ParseResponse<T1>(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AdminCreateConfigurationTemplateV1.Response<T1>()
            {
                StatusCode = code,
                ContentType = contentType
            };
            ...
            {
                response.Payload = payload.ReadToString();
                response.Data = JsonSerializer.Deserialize<Model.ApimodelsConfigurationTemplateResponse<T1>>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
            else if (code == (HttpStatusCode)400)
            {
