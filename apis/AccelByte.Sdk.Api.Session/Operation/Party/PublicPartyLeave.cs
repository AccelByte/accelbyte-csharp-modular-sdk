...
namespace AccelByte.Sdk.Api.Session.Operation
{
    ...
    public class PublicPartyLeave : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Session::Party::PublicPartyLeave";
        }
        ...
        public PublicPartyLeave.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new PublicPartyLeave.Response()
            {
                StatusCode = code,
