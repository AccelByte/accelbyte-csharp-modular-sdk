...
namespace AccelByte.Sdk.Api.Session.Operation
{
    ...
    public class CmdlineHandler : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<CmdlineHandlerBuilder>
        {
            ...
            internal CmdlineHandlerBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            )
            {
                ...
                op.SetBaseFields<CmdlineHandlerBuilder>(this);
                return op;
            }
        ...
        public override string Path => "/session/admin/internal/pprof/cmdline";
