...
namespace AccelByte.Sdk.Api.Iam.Operation
{
    ...
    {
        #region Builder Part
        public static AdminUpdateRolePermissionsV3Builder Builder { get => new AdminUpdateRolePermissionsV3Builder(); }

        public interface IAdminUpdateRolePermissionsV3Builder
        {
        ...
        public abstract class AdminUpdateRolePermissionsV3AbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminUpdateRolePermissionsV3Builder
            where TImpl : AdminUpdateRolePermissionsV3AbstractBuilder<TImpl>
        {
            ...
            public AdminUpdateRolePermissionsV3AbstractBuilder() { }

            public AdminUpdateRolePermissionsV3AbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            {
                AdminUpdateRolePermissionsV3 op = new AdminUpdateRolePermissionsV3(this,
                    body,                    
                    roleId                    
                );
            ...
            protected AdminUpdateRolePermissionsV3.Response InternalExecute(
                AccountcommonPermissionsV3 body,
                string roleId
            )
            {
                AdminUpdateRolePermissionsV3 op = Build(
                    body,
                    roleId
                );
            ...
            protected async Task<AdminUpdateRolePermissionsV3.Response> InternalExecuteAsync(
                AccountcommonPermissionsV3 body,
                string roleId
            )
            {
        ...
        public class AdminUpdateRolePermissionsV3Builder : AdminUpdateRolePermissionsV3AbstractBuilder<AdminUpdateRolePermissionsV3Builder>
        {
            public AdminUpdateRolePermissionsV3Builder() : base() { }

            public AdminUpdateRolePermissionsV3Builder(IAccelByteSdk sdk) : base(sdk) { }

            public AdminUpdateRolePermissionsV3.Response Execute(
                AccountcommonPermissionsV3 body,
                string roleId
            )
            {
            ...
            public async Task<AdminUpdateRolePermissionsV3.Response> ExecuteAsync(
                AccountcommonPermissionsV3 body,
                string roleId
            )
            {
        ...
        public AdminUpdateRolePermissionsV3(IAdminUpdateRolePermissionsV3Builder builder,
            AccountcommonPermissionsV3 body,
            string roleId
        )
        {
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Iam::Roles::AdminUpdateRolePermissionsV3";
        }
        ...
        public AdminUpdateRolePermissionsV3.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AdminUpdateRolePermissionsV3.Response()
            {
                StatusCode = code,
