...
namespace AccelByte.Sdk.Api.Iam.Operation
{
    ...
    public class AdminAddRolePermissionsV4 : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminAddRolePermissionsV4Builder
        {
        ...
        public abstract class AdminAddRolePermissionsV4AbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminAddRolePermissionsV4Builder
            where TImpl : AdminAddRolePermissionsV4AbstractBuilder<TImpl>
        {
            ...
            public AdminAddRolePermissionsV4AbstractBuilder() { }

            public AdminAddRolePermissionsV4AbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminAddRolePermissionsV4.Response InternalExecute(
                AccountcommonPermissionsV3 body,
                string roleId
            )
            {
            ...
            protected async Task<AdminAddRolePermissionsV4.Response> InternalExecuteAsync(
                AccountcommonPermissionsV3 body,
                string roleId
            )
            {
        ...
        public class AdminAddRolePermissionsV4Builder : AdminAddRolePermissionsV4AbstractBuilder<AdminAddRolePermissionsV4Builder>
        {
            public AdminAddRolePermissionsV4Builder() : base() { }

            public AdminAddRolePermissionsV4Builder(IAccelByteSdk sdk) : base(sdk) { }

            public AdminAddRolePermissionsV4.Response Execute(
                AccountcommonPermissionsV3 body,
                string roleId
            )
            {
            ...
            public async Task<AdminAddRolePermissionsV4.Response> ExecuteAsync(
                AccountcommonPermissionsV3 body,
                string roleId
            )
            {
        ...
        public AdminAddRolePermissionsV4(IAdminAddRolePermissionsV4Builder builder,
            AccountcommonPermissionsV3 body,
            string roleId
        )
        {
        ...
        public class Response : ApiResponse<Model.ModelRoleV4Response>
        {
            ...
            protected override string GetFullOperationId() => "Iam::Roles::AdminAddRolePermissionsV4";
        }
