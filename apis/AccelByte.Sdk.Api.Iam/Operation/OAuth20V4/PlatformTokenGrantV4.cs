...
namespace AccelByte.Sdk.Api.Iam.Operation
{
    ...
    /// action code : 10704
    /// </summary>
    public class PlatformTokenGrantV4 : AccelByte.Sdk.Core.Operation
    {
        #region Builder Part
            ...
            where TImpl : PlatformTokenGrantV4AbstractBuilder<TImpl>
        {
            ...
            public PlatformTokenGrantV4CodeChallengeMethod? CodeChallengeMethod { get; set; }
        ...
        public class Response : ApiResponse<Model.OauthmodelTokenResponseV3>
        {
            ...
            protected override string GetFullOperationId() => "Iam::OAuth20V4::PlatformTokenGrantV4";
        }
        ...
        public override string Path => "/iam/v4/oauth/platforms/{platformId}/token";
    ...
    public class PlatformTokenGrantV4CodeChallengeMethod : StringEnum<PlatformTokenGrantV4CodeChallengeMethod>
    {
        public static readonly PlatformTokenGrantV4CodeChallengeMethod S256
            = new PlatformTokenGrantV4CodeChallengeMethod("S256");

        public static readonly PlatformTokenGrantV4CodeChallengeMethod Plain
            = new PlatformTokenGrantV4CodeChallengeMethod("plain");


        public static implicit operator PlatformTokenGrantV4CodeChallengeMethod(string value)
        {
            return NewValue(value);
        }

        public PlatformTokenGrantV4CodeChallengeMethod(string enumValue)
            : base(enumValue)
        {
