...
namespace AccelByte.Sdk.Api.Iam.Operation
{
    ...
    public class RequestGameTokenCodeResponseV3 : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<RequestGameTokenCodeResponseV3Builder>
        {
            ...
            internal RequestGameTokenCodeResponseV3Builder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            public Model.OauthmodelGameTokenCodeResponse? Execute(
                string clientId,
                string namespace_
            )
            {
                RequestGameTokenCodeResponseV3 op = Build(
                    clientId,
                    namespace_
                );
        ...
        {            
            ...
            {
                return JsonSerializer.Deserialize<Model.OauthmodelGameTokenCodeResponse>(payload, ResponseJsonOptions);
            }
