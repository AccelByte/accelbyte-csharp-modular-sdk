...
namespace AccelByte.Sdk.Api.Iam.Operation
{
    ...
    public class AdminPlatformUnlinkAllV3 : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Iam::Users::AdminPlatformUnlinkAllV3";
        }
        ...
        public AdminPlatformUnlinkAllV3.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AdminPlatformUnlinkAllV3.Response()
            {
                StatusCode = code,
