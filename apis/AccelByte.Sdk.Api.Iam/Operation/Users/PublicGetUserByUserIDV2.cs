...
namespace AccelByte.Sdk.Api.Iam.Operation
{
    ...
    public class PublicGetUserByUserIDV2 : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ModelUserResponse>
        {
            ...
            protected override string GetFullOperationId() => "Iam::Users::PublicGetUserByUserIDV2";
        }
        ...
        public PublicGetUserByUserIDV2.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new PublicGetUserByUserIDV2.Response()
            {
                StatusCode = code,
