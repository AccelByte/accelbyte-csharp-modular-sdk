...
namespace AccelByte.Sdk.Api.Iam.Operation
{
    ...
    public class AdminGetListBanReasonV3 : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.AccountcommonBanReasonsV3>
        {
            ...
            protected override string GetFullOperationId() => "Iam::Bans::AdminGetListBanReasonV3";
        }
        ...
        public AdminGetListBanReasonV3.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AdminGetListBanReasonV3.Response()
            {
                StatusCode = code,
