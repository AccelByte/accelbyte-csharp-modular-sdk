...
namespace AccelByte.Sdk.Api.Matchmaking.Operation
{
    ...
    public class QuerySessionHandler : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<QuerySessionHandlerBuilder>
        {
            ...
            public async Task<QuerySessionHandler.Response> ExecuteAsync(
                string matchID,
                string namespace_
            )
            {
            ...
            public QuerySessionHandler.Response<T1> Execute<T1>(
                string matchID,
                string namespace_
            )
            {
            ...
            public async Task<QuerySessionHandler.Response<T1>> ExecuteAsync<T1>(
                string matchID,
                string namespace_
            )
            {
        ...
        public class Response : ApiResponse<Model.ModelsMatchmakingResult>
        {
            ...
            protected override string GetFullOperationId() => "Matchmaking::Matchmaking::QuerySessionHandler";
        }

        public class Response<T1> : ApiResponse<Model.ModelsMatchmakingResult<T1>>
        {
            public ResponseError? Error400 { get; set; } = null;
        ...
        public QuerySessionHandler.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                response.Data = JsonSerializer.Deserialize<Model.ModelsMatchmakingResult>(payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
        ...
        public QuerySessionHandler.Response<T1> ParseResponse<T1>(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new QuerySessionHandler.Response<T1>()
            {
                StatusCode = code,
                ContentType = contentType
            };
