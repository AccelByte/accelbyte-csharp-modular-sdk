...
namespace AccelByte.Sdk.Api.Matchmaking.Operation
{
    ...
    public class GetAllMockTickets : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<GetAllMockTicketsBuilder>
        {
            ...
            public GetAllMockTickets.Response Execute(
                string channelName,
                string namespace_
            )
            {
            ...
            public async Task<GetAllMockTickets.Response> ExecuteAsync(
                string channelName,
                string namespace_
            )
            {
        ...
        public class Response : ApiResponse<Model.ModelsGetMockTicketsResponse>
        {
            ...
            protected override string GetFullOperationId() => "Matchmaking::MockMatchmaking::GetAllMockTickets";
        }
        ...
        public GetAllMockTickets.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new GetAllMockTickets.Response()
            {
                StatusCode = code,
