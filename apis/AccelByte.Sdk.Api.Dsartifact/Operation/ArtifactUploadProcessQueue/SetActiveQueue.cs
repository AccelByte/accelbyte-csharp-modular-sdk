...
namespace AccelByte.Sdk.Api.Dsartifact.Operation
{
    ...
    public class SetActiveQueue : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<SetActiveQueueBuilder>
        {
            ...
            public SetActiveQueue.Response Execute(
                string nodeIP,
                string podName
            )
            {
            ...
            public async Task<SetActiveQueue.Response> ExecuteAsync(
                string nodeIP,
                string podName
            )
            {
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Dsartifact::ArtifactUploadProcessQueue::SetActiveQueue";
        }
        ...
        public SetActiveQueue.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new SetActiveQueue.Response()
            {
                StatusCode = code,
