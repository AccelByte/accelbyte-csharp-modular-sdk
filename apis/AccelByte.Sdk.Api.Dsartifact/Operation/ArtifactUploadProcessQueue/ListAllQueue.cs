...
namespace AccelByte.Sdk.Api.Dsartifact.Operation
{
    ...
    public class ListAllQueue : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<ListAllQueueBuilder>
        {
            ...
            public ListAllQueue.Response Execute(
                string namespace_
            )
            {
            ...
            public async Task<ListAllQueue.Response> ExecuteAsync(
                string namespace_
            )
            {
                ListAllQueue op = Build(
        ...
        public class Response : ApiResponse<Model.ModelsListAllQueueResponse>
        {
            ...
            protected override string GetFullOperationId() => "Dsartifact::ArtifactUploadProcessQueue::ListAllQueue";
        }
