...
namespace AccelByte.Sdk.Api.Seasonpass.Operation
{
    ...
    public class CloneSeason : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.SeasonInfo>
        {
            ...
            protected override string GetFullOperationId() => "Seasonpass::Season::CloneSeason";
        }
        ...
        public CloneSeason.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new CloneSeason.Response()
            {
                StatusCode = code,
