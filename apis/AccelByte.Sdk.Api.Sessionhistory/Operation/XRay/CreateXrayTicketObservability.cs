...
namespace AccelByte.Sdk.Api.Sessionhistory.Operation
{
    ...
    public class CreateXrayTicketObservability : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface ICreateXrayTicketObservabilityBuilder
        {
        ...
        public abstract class CreateXrayTicketObservabilityAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, ICreateXrayTicketObservabilityBuilder
            where TImpl : CreateXrayTicketObservabilityAbstractBuilder<TImpl>
        {
            ...
            public CreateXrayTicketObservabilityAbstractBuilder() { }

            public CreateXrayTicketObservabilityAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected CreateXrayTicketObservability.Response InternalExecute(
                ApimodelsXRayTicketObservabilityRequest body,
                string namespace_
            )
            {
            ...
            protected async Task<CreateXrayTicketObservability.Response> InternalExecuteAsync(
                ApimodelsXRayTicketObservabilityRequest body,
                string namespace_
            )
            {
        ...
        public class CreateXrayTicketObservabilityBuilder : CreateXrayTicketObservabilityAbstractBuilder<CreateXrayTicketObservabilityBuilder>
        {
            public CreateXrayTicketObservabilityBuilder() : base() { }

            public CreateXrayTicketObservabilityBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public CreateXrayTicketObservability(ICreateXrayTicketObservabilityBuilder builder,
            ApimodelsXRayTicketObservabilityRequest body,
            string namespace_
        )
        {
        ...
        public CreateXrayTicketObservability.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            else if ((code == (HttpStatusCode)201) || (code == (HttpStatusCode)202) || (code == (HttpStatusCode)200))
            {
                ...
                response.Data = JsonSerializer.Deserialize<Model.ApimodelsXRayTicketObservabilityResponse>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
