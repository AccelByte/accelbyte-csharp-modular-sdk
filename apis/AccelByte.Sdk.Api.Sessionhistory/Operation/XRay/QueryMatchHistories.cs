...
namespace AccelByte.Sdk.Api.Sessionhistory.Operation
{
    ...
    public class QueryMatchHistories : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<QueryMatchHistoriesBuilder>
        {
            ...
            public QueryMatchHistories.Response Execute(
                string matchId,
                string namespace_
            )
            {
            ...
            public async Task<QueryMatchHistories.Response> ExecuteAsync(
                string matchId,
                string namespace_
            )
            {
        ...
        public class Response : ApiResponse<Model.ApimodelsXRayMatchHistorQueryResponse>
        {
            ...
            protected override string GetFullOperationId() => "Sessionhistory::XRay::QueryMatchHistories";
        }
        ...
        public QueryMatchHistories.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new QueryMatchHistories.Response()
            {
                StatusCode = code,
            ...
            {
                response.Data = JsonSerializer.Deserialize<Model.ApimodelsXRayMatchHistorQueryResponse>(payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
