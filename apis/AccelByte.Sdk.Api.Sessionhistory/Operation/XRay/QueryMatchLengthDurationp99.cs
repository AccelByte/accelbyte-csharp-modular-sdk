...
namespace AccelByte.Sdk.Api.Sessionhistory.Operation
{
    ...
    public class QueryMatchLengthDurationp99 : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<QueryMatchLengthDurationp99Builder>
        {
            ...
            public QueryMatchLengthDurationp99.Response Execute(
                string namespace_,
                string endDate,
                string startDate
            )
            ...
            public async Task<QueryMatchLengthDurationp99.Response> ExecuteAsync(
                string namespace_,
                string endDate,
                string startDate
            )
        ...
        public class Response : ApiResponse<Model.ApimodelsXRayMatchLengthDurationQueryResponse>
        {
            ...
            protected override string GetFullOperationId() => "Sessionhistory::XRay::QueryMatchLengthDurationp99";
        }
        ...
        public QueryMatchLengthDurationp99.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new QueryMatchLengthDurationp99.Response()
            {
                StatusCode = code,
