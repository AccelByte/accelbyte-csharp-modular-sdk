...
namespace AccelByte.Sdk.Api.Sessionhistory.Operation
{
    ...
    public class QueryXrayTimelineByTicketID : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<QueryXrayTimelineByTicketIDBuilder>
        {
            ...
            public QueryXrayTimelineByTicketID.Response Execute(
                string namespace_,
                string ticketId,
                string endDate,
                string startDate
            ...
            public async Task<QueryXrayTimelineByTicketID.Response> ExecuteAsync(
                string namespace_,
                string ticketId,
                string endDate,
                string startDate
        ...
        public class Response : ApiResponse<Model.ApimodelsXRayTicketQueryResponse>
        {
            ...
            protected override string GetFullOperationId() => "Sessionhistory::XRay::QueryXrayTimelineByTicketID";
        }
