...
namespace AccelByte.Sdk.Api.Sessionhistory.Operation
{
    ...
    public class AdminQueryPartyDetail : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<AdminQueryPartyDetailBuilder>
        {
            ...
            public AdminQueryPartyDetail.Response Execute(
                string namespace_
            )
            {
            ...
            public async Task<AdminQueryPartyDetail.Response> ExecuteAsync(
                string namespace_
            )
            {
                AdminQueryPartyDetail op = Build(
        ...
        public class Response : ApiResponse<Model.ApimodelsPartyDetailQueryResponse>
        {
            ...
            protected override string GetFullOperationId() => "Sessionhistory::GameSessionDetail::AdminQueryPartyDetail";
        }
        ...
        public AdminQueryPartyDetail.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                response.Data = JsonSerializer.Deserialize<Model.ApimodelsPartyDetailQueryResponse>(payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
