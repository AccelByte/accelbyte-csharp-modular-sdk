...
namespace AccelByte.Sdk.Api.Sessionbrowser.Operation
{
    ...
    public class AdminSearchSessionsV2 : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<AdminSearchSessionsV2Builder>
        {
            ...
            public async Task<AdminSearchSessionsV2.Response> ExecuteAsync(
                string namespace_,
                long limit,
                long offset
            )
        ...
        public class Response : ApiResponse<Model.ModelsGetSessionHistorySearchResponseV2>
        {
            ...
            protected override string GetFullOperationId() => "Sessionbrowser::Session::AdminSearchSessionsV2";
        }
        ...
        public AdminSearchSessionsV2.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                response.Data = JsonSerializer.Deserialize<Model.ModelsGetSessionHistorySearchResponseV2>(payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
