...
namespace AccelByte.Sdk.Api.Sessionbrowser.Operation
{
    ...
    public class JoinSession : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<JoinSessionBuilder>
        {
            ...
            public async Task<JoinSession.Response> ExecuteAsync(
                ModelsJoinGameSessionRequest body,
                string namespace_,
                string sessionID
            )
        ...
        public class Response : ApiResponse<Model.ModelsSessionResponse>
        {
            ...
            protected override string GetFullOperationId() => "Sessionbrowser::Session::JoinSession";
        }
        ...
        public JoinSession.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new JoinSession.Response()
            {
                StatusCode = code,
