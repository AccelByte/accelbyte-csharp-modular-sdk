    ...
    public class DeleteSessionLocalDS : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<DeleteSessionLocalDSBuilder>
        {
            ...
            )
            {
                ...
                op.SetBaseFields<DeleteSessionLocalDSBuilder>(this);
                return op;
            }

            public DeleteSessionLocalDS.Response Execute(
                string namespace_,
                string sessionID
            )
            {
            ...
            public async Task<DeleteSessionLocalDS.Response> ExecuteAsync(
                string namespace_,
                string sessionID
            )
            {
        ...
        public class Response : ApiResponse<Model.ModelsSessionResponse>
        {
            ...
            protected override string GetFullOperationId() => "Sessionbrowser::Session::DeleteSessionLocalDS";
        }
        ...
        public DeleteSessionLocalDS.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new DeleteSessionLocalDS.Response()
            {
                StatusCode = code,
