...
namespace AccelByte.Sdk.Api.Eventlog.Operation
{
    ...
    public class GetEventByEventTypeHandler : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<GetEventByEventTypeHandlerBuilder>
        {
            ...
            internal GetEventByEventTypeHandlerBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            )
            {
                ...
                op.SetBaseFields<GetEventByEventTypeHandlerBuilder>(this);
                return op;
            }
            ...
            {
                GetEventByEventTypeHandler op = Build(
                    eventType,
                    namespace_,
                    endDate,
                    pageSize,
