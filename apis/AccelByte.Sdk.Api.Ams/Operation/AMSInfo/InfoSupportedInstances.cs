...
namespace AccelByte.Sdk.Api.Ams.Operation
{
    ...
    public class InfoSupportedInstances : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ApiAvailableInstanceTypesResponse>
        {
        ...
        public InfoSupportedInstances.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                response.Data = JsonSerializer.Deserialize<Model.ApiAvailableInstanceTypesResponse>(payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
