...
namespace AccelByte.Sdk.Api.Social.Operation
{
    ...
    public class CreateStat : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface ICreateStatBuilder
        {
        ...
        public abstract class CreateStatAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, ICreateStatBuilder
            where TImpl : CreateStatAbstractBuilder<TImpl>
        {
            ...
            public CreateStatAbstractBuilder() { }

            public CreateStatAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected CreateStat.Response InternalExecute(
                StatCreate body,
                string namespace_
            )
            {
            ...
            protected async Task<CreateStat.Response> InternalExecuteAsync(
                StatCreate body,
                string namespace_
            )
            {
        ...
        public class CreateStatBuilder : CreateStatAbstractBuilder<CreateStatBuilder>
        {
            public CreateStatBuilder() : base() { }

            public CreateStatBuilder(IAccelByteSdk sdk) : base(sdk) { }

            public CreateStat.Response Execute(
                StatCreate body,
                string namespace_
            )
            {
            ...
            public async Task<CreateStat.Response> ExecuteAsync(
                StatCreate body,
                string namespace_
            )
            {
        ...
        public CreateStat(ICreateStatBuilder builder,
            StatCreate body,
            string namespace_
        )
        {
        ...
        public class Response : ApiResponse<Model.StatInfo>
        {
            ...
            protected override string GetFullOperationId() => "Social::StatConfiguration::CreateStat";
        }
        ...
        public CreateStat.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new CreateStat.Response()
            {
                StatusCode = code,
