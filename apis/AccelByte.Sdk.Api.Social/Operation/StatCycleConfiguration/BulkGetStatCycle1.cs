...
namespace AccelByte.Sdk.Api.Social.Operation
{
    ...
    public class BulkGetStatCycle1 : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.BulkStatCycleResult>
        {
            ...
            protected override string GetFullOperationId() => "Social::StatCycleConfiguration::BulkGetStatCycle1";
        }
        ...
        public BulkGetStatCycle1.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new BulkGetStatCycle1.Response()
            {
                StatusCode = code,
