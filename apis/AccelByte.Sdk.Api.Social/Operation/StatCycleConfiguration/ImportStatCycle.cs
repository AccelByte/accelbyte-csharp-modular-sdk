...
namespace AccelByte.Sdk.Api.Social.Operation
{
    ...
    public class ImportStatCycle : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IImportStatCycleBuilder
        {
        ...
        public abstract class ImportStatCycleAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IImportStatCycleBuilder
            where TImpl : ImportStatCycleAbstractBuilder<TImpl>
        {
            ...
            public ImportStatCycleAbstractBuilder() { }

            public ImportStatCycleAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected ImportStatCycle.Response InternalExecute(
                string namespace_
            )
            {
            ...
            protected async Task<ImportStatCycle.Response> InternalExecuteAsync(
                string namespace_
            )
            {
                ImportStatCycle op = Build(
        ...
        public class ImportStatCycleBuilder : ImportStatCycleAbstractBuilder<ImportStatCycleBuilder>
        {
            public ImportStatCycleBuilder() : base() { }

            public ImportStatCycleBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public ImportStatCycle(IImportStatCycleBuilder builder,
            string namespace_
        )
        {
