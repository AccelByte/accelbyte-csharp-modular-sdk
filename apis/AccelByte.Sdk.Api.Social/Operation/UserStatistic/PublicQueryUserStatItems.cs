...
namespace AccelByte.Sdk.Api.Social.Operation
{
    ...
    public class PublicQueryUserStatItems : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IPublicQueryUserStatItemsBuilder
        {
        ...
        public abstract class PublicQueryUserStatItemsAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IPublicQueryUserStatItemsBuilder
            where TImpl : PublicQueryUserStatItemsAbstractBuilder<TImpl>
        {
            ...
            public PublicQueryUserStatItemsAbstractBuilder() { }

            public PublicQueryUserStatItemsAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected PublicQueryUserStatItems.Response InternalExecute(
                string namespace_,
                string userId
            )
            {
            ...
            protected async Task<PublicQueryUserStatItems.Response> InternalExecuteAsync(
                string namespace_,
                string userId
            )
            {
        ...
        public class PublicQueryUserStatItemsBuilder : PublicQueryUserStatItemsAbstractBuilder<PublicQueryUserStatItemsBuilder>
        {
            public PublicQueryUserStatItemsBuilder() : base() { }

            public PublicQueryUserStatItemsBuilder(IAccelByteSdk sdk) : base(sdk) { }

            public PublicQueryUserStatItems.Response Execute(
                string namespace_,
                string userId
            )
            {
            ...
            public async Task<PublicQueryUserStatItems.Response> ExecuteAsync(
                string namespace_,
                string userId
            )
            {
        ...
        public PublicQueryUserStatItems(IPublicQueryUserStatItemsBuilder builder,
            string namespace_,
            string userId
        )
        {
        ...
        public class Response : ApiResponse<List<Model.ADTOObjectForUserStatItemValue>>
        {
            ...
            protected override string GetFullOperationId() => "Social::UserStatistic::PublicQueryUserStatItems";
        }
        ...
        public PublicQueryUserStatItems.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new PublicQueryUserStatItems.Response()
            {
                StatusCode = code,
