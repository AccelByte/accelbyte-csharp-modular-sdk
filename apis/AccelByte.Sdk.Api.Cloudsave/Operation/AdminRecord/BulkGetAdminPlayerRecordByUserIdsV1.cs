...
namespace AccelByte.Sdk.Api.Cloudsave.Operation
{
    ...
    public class BulkGetAdminPlayerRecordByUserIdsV1 : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IBulkGetAdminPlayerRecordByUserIdsV1Builder
        {
        ...
        public abstract class BulkGetAdminPlayerRecordByUserIdsV1AbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IBulkGetAdminPlayerRecordByUserIdsV1Builder
            where TImpl : BulkGetAdminPlayerRecordByUserIdsV1AbstractBuilder<TImpl>
        {
            ...
            public BulkGetAdminPlayerRecordByUserIdsV1AbstractBuilder() { }

            public BulkGetAdminPlayerRecordByUserIdsV1AbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected BulkGetAdminPlayerRecordByUserIdsV1.Response InternalExecute(
                ModelsBulkUserIDsRequest body,
                string key,
                string namespace_
            )
            ...
            protected async Task<BulkGetAdminPlayerRecordByUserIdsV1.Response> InternalExecuteAsync(
                ModelsBulkUserIDsRequest body,
                string key,
                string namespace_
            )
        ...
        public class BulkGetAdminPlayerRecordByUserIdsV1Builder : BulkGetAdminPlayerRecordByUserIdsV1AbstractBuilder<BulkGetAdminPlayerRecordByUserIdsV1Builder>
        {
            public BulkGetAdminPlayerRecordByUserIdsV1Builder() : base() { }

            public BulkGetAdminPlayerRecordByUserIdsV1Builder(IAccelByteSdk sdk) : base(sdk) { }

            public BulkGetAdminPlayerRecordByUserIdsV1.Response Execute(
                ModelsBulkUserIDsRequest body,
                string key,
                string namespace_
            )
            ...
            public async Task<BulkGetAdminPlayerRecordByUserIdsV1.Response> ExecuteAsync(
                ModelsBulkUserIDsRequest body,
                string key,
                string namespace_
            )
        ...
        public BulkGetAdminPlayerRecordByUserIdsV1(IBulkGetAdminPlayerRecordByUserIdsV1Builder builder,
            ModelsBulkUserIDsRequest body,
            string key,
            string namespace_
        )
        ...
        public class Response : ApiResponse<Model.ModelsBulkGetAdminPlayerRecordResponse>
        {
            ...
            protected override string GetFullOperationId() => "Cloudsave::AdminRecord::BulkGetAdminPlayerRecordByUserIdsV1";
        }
        ...
        public BulkGetAdminPlayerRecordByUserIdsV1.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new BulkGetAdminPlayerRecordByUserIdsV1.Response()
            {
                StatusCode = code,
