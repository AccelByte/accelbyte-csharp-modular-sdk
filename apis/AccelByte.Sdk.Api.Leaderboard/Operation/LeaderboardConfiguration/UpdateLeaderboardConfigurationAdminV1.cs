...
namespace AccelByte.Sdk.Api.Leaderboard.Operation
{
    ...
    public class UpdateLeaderboardConfigurationAdminV1 : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IUpdateLeaderboardConfigurationAdminV1Builder
        {
        ...
        public abstract class UpdateLeaderboardConfigurationAdminV1AbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IUpdateLeaderboardConfigurationAdminV1Builder
            where TImpl : UpdateLeaderboardConfigurationAdminV1AbstractBuilder<TImpl>
        {
            ...
            public UpdateLeaderboardConfigurationAdminV1AbstractBuilder() { }

            public UpdateLeaderboardConfigurationAdminV1AbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected UpdateLeaderboardConfigurationAdminV1.Response InternalExecute(
                ModelsUpdateLeaderboardConfigReq body,
                string leaderboardCode,
                string namespace_
            )
            ...
            protected async Task<UpdateLeaderboardConfigurationAdminV1.Response> InternalExecuteAsync(
                ModelsUpdateLeaderboardConfigReq body,
                string leaderboardCode,
                string namespace_
            )
        ...
        public class UpdateLeaderboardConfigurationAdminV1Builder : UpdateLeaderboardConfigurationAdminV1AbstractBuilder<UpdateLeaderboardConfigurationAdminV1Builder>
        {
            public UpdateLeaderboardConfigurationAdminV1Builder() : base() { }

            public UpdateLeaderboardConfigurationAdminV1Builder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public UpdateLeaderboardConfigurationAdminV1(IUpdateLeaderboardConfigurationAdminV1Builder builder,
            ModelsUpdateLeaderboardConfigReq body,
            string leaderboardCode,
            string namespace_
        )
        ...
        public UpdateLeaderboardConfigurationAdminV1.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            else if ((code == (HttpStatusCode)201) || (code == (HttpStatusCode)202) || (code == (HttpStatusCode)200))
            {
                ...
                response.Data = JsonSerializer.Deserialize<Model.ModelsGetLeaderboardConfigResp>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
