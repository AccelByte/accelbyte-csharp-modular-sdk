...
namespace AccelByte.Sdk.Api.Leaderboard.Operation
{
    ...
    public class GetTodayLeaderboardRankingAdminV1 : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IGetTodayLeaderboardRankingAdminV1Builder
        {
        ...
        public abstract class GetTodayLeaderboardRankingAdminV1AbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IGetTodayLeaderboardRankingAdminV1Builder
            where TImpl : GetTodayLeaderboardRankingAdminV1AbstractBuilder<TImpl>
        {
            ...
            public GetTodayLeaderboardRankingAdminV1AbstractBuilder() { }

            public GetTodayLeaderboardRankingAdminV1AbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected GetTodayLeaderboardRankingAdminV1.Response InternalExecute(
                string leaderboardCode,
                string namespace_
            )
            {
            ...
            protected async Task<GetTodayLeaderboardRankingAdminV1.Response> InternalExecuteAsync(
                string leaderboardCode,
                string namespace_
            )
            {
        ...
        public class GetTodayLeaderboardRankingAdminV1Builder : GetTodayLeaderboardRankingAdminV1AbstractBuilder<GetTodayLeaderboardRankingAdminV1Builder>
        {
            public GetTodayLeaderboardRankingAdminV1Builder() : base() { }

            public GetTodayLeaderboardRankingAdminV1Builder(IAccelByteSdk sdk) : base(sdk) { }

            public GetTodayLeaderboardRankingAdminV1.Response Execute(
                string leaderboardCode,
                string namespace_
            )
            {
            ...
            public async Task<GetTodayLeaderboardRankingAdminV1.Response> ExecuteAsync(
                string leaderboardCode,
                string namespace_
            )
            {
        ...
        public GetTodayLeaderboardRankingAdminV1(IGetTodayLeaderboardRankingAdminV1Builder builder,
            string leaderboardCode,
            string namespace_
        )
        {
        ...
        public class Response : ApiResponse<Model.ModelsGetLeaderboardRankingResp>
        {
            ...
            protected override string GetFullOperationId() => "Leaderboard::LeaderboardData::GetTodayLeaderboardRankingAdminV1";
        }
        ...
        public GetTodayLeaderboardRankingAdminV1.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new GetTodayLeaderboardRankingAdminV1.Response()
            {
                StatusCode = code,
