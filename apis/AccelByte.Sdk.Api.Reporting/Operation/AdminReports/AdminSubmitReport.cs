...
namespace AccelByte.Sdk.Api.Reporting.Operation
{
    ...
    public class AdminSubmitReport : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminSubmitReportBuilder
        {
        ...
        public abstract class AdminSubmitReportAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminSubmitReportBuilder
            where TImpl : AdminSubmitReportAbstractBuilder<TImpl>
        {
            ...
            public AdminSubmitReportAbstractBuilder() { }

            public AdminSubmitReportAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminSubmitReport.Response InternalExecute(
                RestapiSubmitReportRequest body,
                string namespace_
            )
            {
            ...
            protected async Task<AdminSubmitReport.Response> InternalExecuteAsync(
                RestapiSubmitReportRequest body,
                string namespace_
            )
            {
        ...
        public class AdminSubmitReportBuilder : AdminSubmitReportAbstractBuilder<AdminSubmitReportBuilder>
        {
            public AdminSubmitReportBuilder() : base() { }

            public AdminSubmitReportBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public AdminSubmitReport(IAdminSubmitReportBuilder builder,
            RestapiSubmitReportRequest body,
            string namespace_
        )
        {
