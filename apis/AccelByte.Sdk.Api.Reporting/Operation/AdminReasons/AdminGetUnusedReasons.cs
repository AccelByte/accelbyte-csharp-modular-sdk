...
namespace AccelByte.Sdk.Api.Reporting.Operation
{
    ...
    public class AdminGetUnusedReasons : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<AdminGetUnusedReasonsBuilder>
        {
            ...
            public async Task<Model.RestapiUnusedReasonListResponse?> ExecuteAsync(
                string namespace_,
                string category
            )
            {
        ...
        public Model.RestapiUnusedReasonListResponse? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<Model.RestapiUnusedReasonListResponse>(payload, ResponseJsonOptions);
            }
