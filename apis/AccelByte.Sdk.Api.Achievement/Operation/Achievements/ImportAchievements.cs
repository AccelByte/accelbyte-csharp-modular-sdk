...
namespace AccelByte.Sdk.Api.Achievement.Operation
{
    ...
    public class ImportAchievements : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<ImportAchievementsBuilder>
        {
            ...
            public Model.ServiceImportConfigResponse? Execute(
                string namespace_
            )
            {
            ...
            public async Task<Model.ServiceImportConfigResponse?> ExecuteAsync(
                string namespace_
            )
            {
                ImportAchievements op = Build(
        ...
        public Model.ServiceImportConfigResponse? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<Model.ServiceImportConfigResponse>(payload, ResponseJsonOptions);
            }
