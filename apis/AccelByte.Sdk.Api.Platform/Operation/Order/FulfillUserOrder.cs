...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class FulfillUserOrder : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.OrderInfo>
        {
            ...
            protected override string GetFullOperationId() => "Platform::Order::FulfillUserOrder";
        }
        ...
        public FulfillUserOrder.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new FulfillUserOrder.Response()
            {
                StatusCode = code,
        ...
        public FulfillUserOrder.Response<T1> ParseResponse<T1>(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new FulfillUserOrder.Response<T1>()
            {
                StatusCode = code,
                ContentType = contentType
            };
