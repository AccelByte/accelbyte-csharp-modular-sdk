...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class PublicQueryUserOrders : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.OrderPagingSlicedResult>
        {
            ...
            protected override string GetFullOperationId() => "Platform::Order::PublicQueryUserOrders";
        }
        ...
        public PublicQueryUserOrders.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new PublicQueryUserOrders.Response()
            {
                StatusCode = code,
