...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class UpdateAdyenConfig : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.PaymentMerchantConfigInfo>
        {
            ...
            protected override string GetFullOperationId() => "Platform::PaymentConfig::UpdateAdyenConfig";
        }
        ...
        public UpdateAdyenConfig.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new UpdateAdyenConfig.Response()
            {
                StatusCode = code,
