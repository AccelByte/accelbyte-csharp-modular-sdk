...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class QueryRevocationHistories : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.RevocationHistoryPagingSlicedResult>
        {


            protected override string GetFullOperationId() => "Platform::Revocation::QueryRevocationHistories";
        }
