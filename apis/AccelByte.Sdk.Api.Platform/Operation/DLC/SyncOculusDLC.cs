...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class SyncOculusDLC : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Platform::DLC::SyncOculusDLC";
        }
        ...
        public SyncOculusDLC.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new SyncOculusDLC.Response()
            {
                StatusCode = code,
