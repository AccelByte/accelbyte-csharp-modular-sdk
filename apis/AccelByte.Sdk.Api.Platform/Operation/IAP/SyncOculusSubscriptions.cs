...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class SyncOculusSubscriptions : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<SyncOculusSubscriptionsBuilder>
        {
            ...
            {
                SyncOculusSubscriptions op = Build(
                    namespace_,
                    userId
                );
        ...
        public class Response : ApiResponse<List<Model.ThirdPartySubscriptionTransactionInfo>>
        {
            ...
            protected override string GetFullOperationId() => "Platform::IAP::SyncOculusSubscriptions";
        }
        ...
        public SyncOculusSubscriptions.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new SyncOculusSubscriptions.Response()
            {
                StatusCode = code,
