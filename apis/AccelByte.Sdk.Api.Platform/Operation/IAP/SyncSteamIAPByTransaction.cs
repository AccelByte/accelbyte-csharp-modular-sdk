...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class SyncSteamIAPByTransaction : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<SyncSteamIAPByTransactionBuilder>
        {
            ...
            {
                SyncSteamIAPByTransaction op = Build(
                    body,
                    namespace_,
                    userId
                );
        ...
        public class Response : ApiResponse<Model.IAPOrderShortInfo>
        {
            ...
            protected override string GetFullOperationId() => "Platform::IAP::SyncSteamIAPByTransaction";
        }
        ...
        public SyncSteamIAPByTransaction.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new SyncSteamIAPByTransaction.Response()
            {
                StatusCode = code,
