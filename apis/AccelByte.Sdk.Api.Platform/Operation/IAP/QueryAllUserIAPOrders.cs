...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class QueryAllUserIAPOrders : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.IAPOrderPagingSlicedResult>
        {
            ...
            protected override string GetFullOperationId() => "Platform::IAP::QueryAllUserIAPOrders";
        }
        ...
        public QueryAllUserIAPOrders.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new QueryAllUserIAPOrders.Response()
            {
                StatusCode = code,
