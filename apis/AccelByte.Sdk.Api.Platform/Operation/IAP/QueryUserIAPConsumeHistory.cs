...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class QueryUserIAPConsumeHistory : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.IAPConsumeHistoryPagingSlicedResult>
        {


            protected override string GetFullOperationId() => "Platform::IAP::QueryUserIAPConsumeHistory";
        }
