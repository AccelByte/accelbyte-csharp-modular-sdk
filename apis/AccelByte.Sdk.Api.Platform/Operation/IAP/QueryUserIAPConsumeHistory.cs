...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class QueryUserIAPConsumeHistory : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<QueryUserIAPConsumeHistoryBuilder>
        {
            ...
            public Model.IAPConsumeHistoryPagingSlicedResult? Execute(
                string namespace_,
                string userId
            )
            {
                QueryUserIAPConsumeHistory op = Build(
                    namespace_,
                    userId
                );
            ...
            public async Task<Model.IAPConsumeHistoryPagingSlicedResult?> ExecuteAsync(
                string namespace_,
                string userId
            )
            {
        ...
        public Model.IAPConsumeHistoryPagingSlicedResult? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<Model.IAPConsumeHistoryPagingSlicedResult>(payload, ResponseJsonOptions);
            }
