...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class SellUserEntitlement : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.EntitlementSoldResult>
        {
            ...
            protected override string GetFullOperationId() => "Platform::Entitlement::SellUserEntitlement";
        }
        ...
        public SellUserEntitlement.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new SellUserEntitlement.Response()
            {
                StatusCode = code,
