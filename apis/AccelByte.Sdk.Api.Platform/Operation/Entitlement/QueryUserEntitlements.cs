...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class QueryUserEntitlements : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<QueryUserEntitlementsBuilder>
        {
            ...
            {
                QueryUserEntitlements op = Build(
                    namespace_,
                    userId
                );
        ...
        public class Response : ApiResponse<Model.EntitlementPagingSlicedResult>
        {
            ...
            protected override string GetFullOperationId() => "Platform::Entitlement::QueryUserEntitlements";
        }
        ...
        public QueryUserEntitlements.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new QueryUserEntitlements.Response()
            {
                StatusCode = code,
