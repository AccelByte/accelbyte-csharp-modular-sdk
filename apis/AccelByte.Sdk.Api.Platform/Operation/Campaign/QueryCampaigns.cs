...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class QueryCampaigns : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<QueryCampaignsBuilder>
        {
            ...
            public Model.CampaignPagingSlicedResult? Execute(
                string namespace_
            )
            {
            ...
            public async Task<Model.CampaignPagingSlicedResult?> ExecuteAsync(
                string namespace_
            )
            {
                QueryCampaigns op = Build(
        ...
        public Model.CampaignPagingSlicedResult? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<Model.CampaignPagingSlicedResult>(payload, ResponseJsonOptions);
            }
