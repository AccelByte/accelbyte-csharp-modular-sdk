...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class GetCampaignDynamic : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<GetCampaignDynamicBuilder>
        {
            ...
            public Model.CampaignDynamicInfo? Execute(
                string campaignId,
                string namespace_
            )
            {
            ...
            public async Task<Model.CampaignDynamicInfo?> ExecuteAsync(
                string campaignId,
                string namespace_
            )
            {
        ...
        {            
            ...
            {
                return JsonSerializer.Deserialize<Model.CampaignDynamicInfo>(payload, ResponseJsonOptions);
            }
