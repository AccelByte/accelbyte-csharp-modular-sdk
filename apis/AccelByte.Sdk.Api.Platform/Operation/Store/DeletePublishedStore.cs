...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class DeletePublishedStore : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.StoreInfo>
        {
            ...
            protected override string GetFullOperationId() => "Platform::Store::DeletePublishedStore";
        }
        ...
        public DeletePublishedStore.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new DeletePublishedStore.Response()
            {
                StatusCode = code,
