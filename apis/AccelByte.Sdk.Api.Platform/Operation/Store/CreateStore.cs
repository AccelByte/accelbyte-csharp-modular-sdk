...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class CreateStore : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.StoreInfo>
        {
            ...
            protected override string GetFullOperationId() => "Platform::Store::CreateStore";
        }
        ...
        public CreateStore.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new CreateStore.Response()
            {
                StatusCode = code,
