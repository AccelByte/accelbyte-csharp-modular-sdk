...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class GetPublishedStoreBackup : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IGetPublishedStoreBackupBuilder
        {
        ...
        public abstract class GetPublishedStoreBackupAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IGetPublishedStoreBackupBuilder
            where TImpl : GetPublishedStoreBackupAbstractBuilder<TImpl>
        {
            ...
            public GetPublishedStoreBackupAbstractBuilder() { }

            public GetPublishedStoreBackupAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected GetPublishedStoreBackup.Response InternalExecute(
                string namespace_
            )
            {
            ...
            protected async Task<GetPublishedStoreBackup.Response> InternalExecuteAsync(
                string namespace_
            )
            {
                GetPublishedStoreBackup op = Build(
        ...
        public class GetPublishedStoreBackupBuilder : GetPublishedStoreBackupAbstractBuilder<GetPublishedStoreBackupBuilder>
        {
            public GetPublishedStoreBackupBuilder() : base() { }

            public GetPublishedStoreBackupBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public GetPublishedStoreBackup(IGetPublishedStoreBackupBuilder builder,
            string namespace_
        )
        {
        ...
        public GetPublishedStoreBackup.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            else if ((code == (HttpStatusCode)201) || (code == (HttpStatusCode)202) || (code == (HttpStatusCode)200))
            {
                ...
                response.Data = JsonSerializer.Deserialize<Model.StoreBackupInfo>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
