...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class RedeemCode : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.FulfillmentResult>
        {
            ...
            protected override string GetFullOperationId() => "Platform::Fulfillment::RedeemCode";
        }
        ...
        public RedeemCode.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new RedeemCode.Response()
            {
                StatusCode = code,
