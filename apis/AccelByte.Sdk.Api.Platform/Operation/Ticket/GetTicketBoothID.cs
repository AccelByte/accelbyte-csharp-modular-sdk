...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class GetTicketBoothID : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<GetTicketBoothIDBuilder>
        {
            ...
            public Model.TicketBoothID? Execute(
                string boothName,
                string namespace_
            )
            {
            ...
            public async Task<Model.TicketBoothID?> ExecuteAsync(
                string boothName,
                string namespace_
            )
            {
        ...
        public Model.TicketBoothID? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<Model.TicketBoothID>(payload, ResponseJsonOptions);
            }
