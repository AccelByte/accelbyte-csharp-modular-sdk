...
namespace AccelByte.Sdk.Api.Platform.Operation
{
    ...
    public class AnonymizeOrder : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Platform::Anonymization::AnonymizeOrder";
        }
        ...
        public AnonymizeOrder.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AnonymizeOrder.Response()
            {
                StatusCode = code,
