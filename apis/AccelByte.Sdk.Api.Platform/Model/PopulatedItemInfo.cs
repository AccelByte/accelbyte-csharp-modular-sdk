...
namespace AccelByte.Sdk.Api.Platform.Model
{
    ...
    public class PopulatedItemInfo<T1, T2> : AccelByte.Sdk.Core.Model
    {
        [JsonPropertyName("appId")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public string? AppId { get; set; }
    ...
    public class PopulatedItemInfoItemType : StringEnum<PopulatedItemInfoItemType>
    {
        ...
        public static readonly PopulatedItemInfoItemType LOOTBOX
            = new PopulatedItemInfoItemType("LOOTBOX");
