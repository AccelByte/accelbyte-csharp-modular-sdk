...
namespace AccelByte.Sdk.Api.Legal.Wrapper
{
    public class AdminUserAgreement
    {
        ...
        public AdminUserAgreement(IAccelByteSdk sdk, string customBasePath)
        {
            _sdk = sdk;
        ...
        public IndirectBulkAcceptVersionedPolicy.IndirectBulkAcceptVersionedPolicyBuilder IndirectBulkAcceptVersionedPolicyOp
        {
            get
            {
                var opBuilder = new Operation.IndirectBulkAcceptVersionedPolicy.IndirectBulkAcceptVersionedPolicyBuilder(_sdk);
                if (_CustomBasePath != "")
