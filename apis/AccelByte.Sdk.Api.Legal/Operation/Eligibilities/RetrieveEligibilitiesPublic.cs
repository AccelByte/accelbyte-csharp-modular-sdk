...
namespace AccelByte.Sdk.Api.Legal.Operation
{
    ...
    public class RetrieveEligibilitiesPublic : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<RetrieveEligibilitiesPublicBuilder>
        {
            ...
            public async Task<List<Model.RetrieveUserEligibilitiesResponse>?> ExecuteAsync(
                string namespace_
            )
            {
                RetrieveEligibilitiesPublic op = Build(
        ...
        public List<Model.RetrieveUserEligibilitiesResponse>? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<List<Model.RetrieveUserEligibilitiesResponse>>(payload, ResponseJsonOptions);
            }
