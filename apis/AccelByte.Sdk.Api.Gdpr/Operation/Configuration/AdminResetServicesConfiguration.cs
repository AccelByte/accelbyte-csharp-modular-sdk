...
namespace AccelByte.Sdk.Api.Gdpr.Operation
{
    ...
    public class AdminResetServicesConfiguration : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Gdpr::Configuration::AdminResetServicesConfiguration";
        }
        ...
        public AdminResetServicesConfiguration.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AdminResetServicesConfiguration.Response()
            {
                StatusCode = code,
