...
namespace AccelByte.Sdk.Api.Chat.Operation
{
    ...
    public class AdminUpdateInboxMessage : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminUpdateInboxMessageBuilder
        {
        ...
        public abstract class AdminUpdateInboxMessageAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminUpdateInboxMessageBuilder
            where TImpl : AdminUpdateInboxMessageAbstractBuilder<TImpl>
        {
            ...
            public AdminUpdateInboxMessageAbstractBuilder() { }

            public AdminUpdateInboxMessageAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminUpdateInboxMessage.Response InternalExecute(
                ModelsUpdateInboxMessageRequest body,
                string messageId,
                string namespace_
            )
            ...
            protected async Task<AdminUpdateInboxMessage.Response> InternalExecuteAsync(
                ModelsUpdateInboxMessageRequest body,
                string messageId,
                string namespace_
            )
        ...
        public class AdminUpdateInboxMessageBuilder : AdminUpdateInboxMessageAbstractBuilder<AdminUpdateInboxMessageBuilder>
        {
            public AdminUpdateInboxMessageBuilder() : base() { }

            public AdminUpdateInboxMessageBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public AdminUpdateInboxMessage(IAdminUpdateInboxMessageBuilder builder,
            ModelsUpdateInboxMessageRequest body,
            string messageId,
            string namespace_
        )
