...
namespace AccelByte.Sdk.Api.Chat.Operation
{
    ...
    public class AdminGetInboxStats : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminGetInboxStatsBuilder
        {
        ...
        public abstract class AdminGetInboxStatsAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminGetInboxStatsBuilder
            where TImpl : AdminGetInboxStatsAbstractBuilder<TImpl>
        {
            ...
            public AdminGetInboxStatsAbstractBuilder() { }

            public AdminGetInboxStatsAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminGetInboxStats.Response InternalExecute(
                string namespace_
            )
            {
            ...
            protected async Task<AdminGetInboxStats.Response> InternalExecuteAsync(
                string namespace_
            )
            {
                AdminGetInboxStats op = Build(
        ...
        public class AdminGetInboxStatsBuilder : AdminGetInboxStatsAbstractBuilder<AdminGetInboxStatsBuilder>
        {
            public AdminGetInboxStatsBuilder() : base() { }

            public AdminGetInboxStatsBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public AdminGetInboxStats(IAdminGetInboxStatsBuilder builder,
            string namespace_
        )
        {
        ...
        public AdminGetInboxStats.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            else if ((code == (HttpStatusCode)201) || (code == (HttpStatusCode)202) || (code == (HttpStatusCode)200))
            {
                ...
                response.Data = JsonSerializer.Deserialize<Model.ModelsGetInboxStatsResponse>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
