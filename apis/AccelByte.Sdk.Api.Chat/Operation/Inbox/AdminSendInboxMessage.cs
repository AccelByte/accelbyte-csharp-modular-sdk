...
namespace AccelByte.Sdk.Api.Chat.Operation
{
    ...
    public class AdminSendInboxMessage : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ModelsSendInboxMessageResponse>
        {
            ...
            protected override string GetFullOperationId() => "Chat::Inbox::AdminSendInboxMessage";
        }
        ...
        public AdminSendInboxMessage.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AdminSendInboxMessage.Response()
            {
                StatusCode = code,
