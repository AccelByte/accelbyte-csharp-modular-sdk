    ...
    public class AdminUnbanTopicMembers : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<AdminUnbanTopicMembersBuilder>
        {
            ...
            )
            {
                ...
                op.SetBaseFields<AdminUnbanTopicMembersBuilder>(this);
                return op;
            }
        ...
        public AdminUnbanTopicMembers.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                response.Data = JsonSerializer.Deserialize<Model.ModelsUnbanTopicMemberResult>(payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
