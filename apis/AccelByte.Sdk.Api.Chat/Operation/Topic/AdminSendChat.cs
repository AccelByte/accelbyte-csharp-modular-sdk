...
namespace AccelByte.Sdk.Api.Chat.Operation
{
    ...
    public class AdminSendChat : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminSendChatBuilder
        {
        ...
        public abstract class AdminSendChatAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminSendChatBuilder
            where TImpl : AdminSendChatAbstractBuilder<TImpl>
        {
            ...
            public AdminSendChatAbstractBuilder() { }

            public AdminSendChatAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminSendChat.Response InternalExecute(
                ApiSendChatParams body,
                string namespace_,
                string topic
            )
            ...
            protected async Task<AdminSendChat.Response> InternalExecuteAsync(
                ApiSendChatParams body,
                string namespace_,
                string topic
            )
        ...
        public class AdminSendChatBuilder : AdminSendChatAbstractBuilder<AdminSendChatBuilder>
        {
            public AdminSendChatBuilder() : base() { }

            public AdminSendChatBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public AdminSendChat(IAdminSendChatBuilder builder,
            ApiSendChatParams body,
            string namespace_,
            string topic
        )
