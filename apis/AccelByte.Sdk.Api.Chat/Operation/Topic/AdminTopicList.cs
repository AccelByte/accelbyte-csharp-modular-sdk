...
namespace AccelByte.Sdk.Api.Chat.Operation
{
    ...
    public class AdminTopicList : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminTopicListBuilder
        {
        ...
        public abstract class AdminTopicListAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminTopicListBuilder
            where TImpl : AdminTopicListAbstractBuilder<TImpl>
        {
            ...
            public AdminTopicListAbstractBuilder() { }

            public AdminTopicListAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminTopicList.Response InternalExecute(
                string namespace_
            )
            {
            ...
            protected async Task<AdminTopicList.Response> InternalExecuteAsync(
                string namespace_
            )
            {
                AdminTopicList op = Build(
        ...
        public class AdminTopicListBuilder : AdminTopicListAbstractBuilder<AdminTopicListBuilder>
        {
            public AdminTopicListBuilder() : base() { }

            public AdminTopicListBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public AdminTopicList(IAdminTopicListBuilder builder,
            string namespace_
        )
        {
        ...
        public AdminTopicList.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            else if ((code == (HttpStatusCode)201) || (code == (HttpStatusCode)202) || (code == (HttpStatusCode)200))
            {
                ...
                response.Data = JsonSerializer.Deserialize<List<Model.ModelsTopicResponse>>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
