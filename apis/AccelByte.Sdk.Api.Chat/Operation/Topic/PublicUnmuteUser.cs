...
namespace AccelByte.Sdk.Api.Chat.Operation
{
    ...
    public class PublicUnmuteUser : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Chat::Topic::PublicUnmuteUser";
        }
        ...
        public PublicUnmuteUser.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new PublicUnmuteUser.Response()
            {
                StatusCode = code,
