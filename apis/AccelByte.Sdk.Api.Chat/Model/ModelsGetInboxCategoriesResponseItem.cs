...
{
    public class ModelsGetInboxCategoriesResponseItem : AccelByte.Sdk.Core.Model
    {
    ...
    public class ModelsGetInboxCategoriesResponseItem<T1> : AccelByte.Sdk.Core.Model
    {
        [JsonPropertyName("enabled")]
        public bool? Enabled { get; set; }
