...
namespace AccelByte.Sdk.Api.Csm.Operation
{
    ...
    public class UpdateAppV2 : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IUpdateAppV2Builder
        {
        ...
        public abstract class UpdateAppV2AbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IUpdateAppV2Builder
            where TImpl : UpdateAppV2AbstractBuilder<TImpl>
        {
            ...
            public UpdateAppV2AbstractBuilder() { }

            public UpdateAppV2AbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected UpdateAppV2.Response InternalExecute(
                ApimodelUpdateAppV2Request body,
                string app,
                string namespace_
            )
            {
                UpdateAppV2 op = Build(
                    body,
                    app,
                    namespace_
                );
            ...
            protected async Task<UpdateAppV2.Response> InternalExecuteAsync(
                ApimodelUpdateAppV2Request body,
                string app,
                string namespace_
            )
        ...
        public class UpdateAppV2Builder : UpdateAppV2AbstractBuilder<UpdateAppV2Builder>
        {
            public UpdateAppV2Builder() : base() { }

            public UpdateAppV2Builder(IAccelByteSdk sdk) : base(sdk) { }

            public UpdateAppV2.Response Execute(
                ApimodelUpdateAppV2Request body,
                string app,
                string namespace_
            )
            ...
            public async Task<UpdateAppV2.Response> ExecuteAsync(
                ApimodelUpdateAppV2Request body,
                string app,
                string namespace_
            )
        ...
        public UpdateAppV2(IUpdateAppV2Builder builder,
            ApimodelUpdateAppV2Request body,
            string app,
            string namespace_
        )
        ...
        public class Response : ApiResponse<Model.ApimodelAppItem>
        {
            ...
            protected override string GetFullOperationId() => "Csm::AppV2::UpdateAppV2";
        }
        ...
        public UpdateAppV2.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new UpdateAppV2.Response()
            {
                StatusCode = code,
