...
namespace AccelByte.Sdk.Api.Csm.Operation
{
    ...
    public class DeleteSecretV1 : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IDeleteSecretV1Builder
        {
        ...
        public abstract class DeleteSecretV1AbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IDeleteSecretV1Builder
            where TImpl : DeleteSecretV1AbstractBuilder<TImpl>
        {
            ...
            public DeleteSecretV1AbstractBuilder() { }

            public DeleteSecretV1AbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected DeleteSecretV1.Response InternalExecute(
                string app,
                string configId,
                string namespace_
            )
            ...
            protected async Task<DeleteSecretV1.Response> InternalExecuteAsync(
                string app,
                string configId,
                string namespace_
            )
        ...
        public class DeleteSecretV1Builder : DeleteSecretV1AbstractBuilder<DeleteSecretV1Builder>
        {
            public DeleteSecretV1Builder() : base() { }

            public DeleteSecretV1Builder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public DeleteSecretV1(IDeleteSecretV1Builder builder,
            string app,
            string configId,
            string namespace_
        )
