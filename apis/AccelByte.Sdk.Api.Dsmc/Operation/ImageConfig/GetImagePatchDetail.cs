...
namespace AccelByte.Sdk.Api.Dsmc.Operation
{
    ...
    public class GetImagePatchDetail : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<GetImagePatchDetailBuilder>
        {
            ...
            public async Task<Model.ModelsGetImagePatchDetailResponse?> ExecuteAsync(
                string namespace_,
                string version,
                string versionPatch
            )
        ...
        public Model.ModelsGetImagePatchDetailResponse? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<Model.ModelsGetImagePatchDetailResponse>(payload, ResponseJsonOptions);
            }
