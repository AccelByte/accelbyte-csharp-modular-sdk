    ...
    public class ImageDetailClient : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<ImageDetailClientBuilder>
        {
            ...
            )
            {
                ...
                op.SetBaseFields<ImageDetailClientBuilder>(this);
                return op;
            }

            public ImageDetailClient.Response Execute(
                string namespace_,
                string version
            )
            {
            ...
            public async Task<ImageDetailClient.Response> ExecuteAsync(
                string namespace_,
                string version
            )
            {
        ...
        public class Response : ApiResponse<Model.ModelsGetImageDetailResponse>
        {
            ...
            protected override string GetFullOperationId() => "Dsmc::ImageConfig::ImageDetailClient";
        }
        ...
        public ImageDetailClient.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new ImageDetailClient.Response()
            {
                StatusCode = code,
