...
namespace AccelByte.Sdk.Api.Dsmc.Operation
{
    ...
    public class UpdateImage : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<UpdateImageBuilder>
        {
            ...
            public UpdateImage.Response Execute(
                ModelsImageRecordUpdate body
            )
            {
            ...
            public async Task<UpdateImage.Response> ExecuteAsync(
                ModelsImageRecordUpdate body
            )
            {
                UpdateImage op = Build(
        ...
        public class Response : ApiResponse
        {
            ...
            protected override string GetFullOperationId() => "Dsmc::ImageConfig::UpdateImage";
        }
        ...
        public UpdateImage.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new UpdateImage.Response()
            {
                StatusCode = code,
