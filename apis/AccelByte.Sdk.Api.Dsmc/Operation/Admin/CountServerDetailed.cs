...
namespace AccelByte.Sdk.Api.Dsmc.Operation
{
    ...
    public class CountServerDetailed : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<CountServerDetailedBuilder>
        {
            ...
            public CountServerDetailed.Response Execute(
                string namespace_
            )
            {
            ...
            public async Task<CountServerDetailed.Response> ExecuteAsync(
                string namespace_
            )
            {
                CountServerDetailed op = Build(
        ...
        public class Response : ApiResponse<Model.ModelsDetailedCountServerResponse>
        {
            ...
            protected override string GetFullOperationId() => "Dsmc::Admin::CountServerDetailed";
        }
        ...
        public CountServerDetailed.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new CountServerDetailed.Response()
            {
                StatusCode = code,
