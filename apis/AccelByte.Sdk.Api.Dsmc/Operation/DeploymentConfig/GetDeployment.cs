...
namespace AccelByte.Sdk.Api.Dsmc.Operation
{
    ...
    public class GetDeployment : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<GetDeploymentBuilder>
        {
            ...
            public GetDeployment.Response Execute(
                string deployment,
                string namespace_
            )
            {
            ...
            public async Task<GetDeployment.Response> ExecuteAsync(
                string deployment,
                string namespace_
            )
            {
        ...
        public class Response : ApiResponse<Model.ModelsDeploymentWithOverride>
        {
            ...
            protected override string GetFullOperationId() => "Dsmc::DeploymentConfig::GetDeployment";
        }
