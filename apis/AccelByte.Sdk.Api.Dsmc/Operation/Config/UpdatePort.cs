...
namespace AccelByte.Sdk.Api.Dsmc.Operation
{
    ...
    public class UpdatePort : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<UpdatePortBuilder>
        {
            ...
            public UpdatePort.Response Execute(
                ModelsUpdatePortRequest body,
                string name,
                string namespace_
            )
            ...
            public async Task<UpdatePort.Response> ExecuteAsync(
                ModelsUpdatePortRequest body,
                string name,
                string namespace_
            )
        ...
        public class Response : ApiResponse<Model.ModelsDSMConfigRecord>
        {
            ...
            protected override string GetFullOperationId() => "Dsmc::Config::UpdatePort";
        }
