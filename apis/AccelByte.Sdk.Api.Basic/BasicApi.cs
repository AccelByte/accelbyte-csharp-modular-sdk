...
namespace AccelByte.Sdk.Api.Basic
{
    public class BasicApi : ISdkApi
    {
        ...
        public Wrapper.Namespace Namespace
        {
            ...
            {
                if (_Namespace == null)
                    _Namespace = new Wrapper.Namespace(_Sdk);
                return _Namespace;
            }
        }
        ...
        public Wrapper.UserAction UserAction
        {
            ...
            {
                if (_UserAction == null)
                    _UserAction = new Wrapper.UserAction(_Sdk);
                return _UserAction;
            }
        }
        ...
        public Wrapper.EQU8Config EQU8Config
        {
            ...
            {
                if (_EQU8Config == null)
                    _EQU8Config = new Wrapper.EQU8Config(_Sdk);
                return _EQU8Config;
            }
        }
        ...
        public Wrapper.FileUpload FileUpload
        {
            ...
            {
                if (_FileUpload == null)
                    _FileUpload = new Wrapper.FileUpload(_Sdk);
                return _FileUpload;
            }
        }
        ...
        public Wrapper.UserProfile UserProfile
        {
            get
            {
                if (_UserProfile == null)
                    _UserProfile = new Wrapper.UserProfile(_Sdk);
                return _UserProfile;
            }
        }
