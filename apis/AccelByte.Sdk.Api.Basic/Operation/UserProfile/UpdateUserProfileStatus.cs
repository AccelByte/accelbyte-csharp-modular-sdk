...
namespace AccelByte.Sdk.Api.Basic.Operation
{
    ...
    public class UpdateUserProfileStatus : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IUpdateUserProfileStatusBuilder
        {
        ...
        public abstract class UpdateUserProfileStatusAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IUpdateUserProfileStatusBuilder
            where TImpl : UpdateUserProfileStatusAbstractBuilder<TImpl>
        {
            ...
            public UpdateUserProfileStatusAbstractBuilder() { }

            public UpdateUserProfileStatusAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected UpdateUserProfileStatus.Response InternalExecute(
                string namespace_,
                string userId
            )
            {
            ...
            protected async Task<UpdateUserProfileStatus.Response> InternalExecuteAsync(
                string namespace_,
                string userId
            )
            {
            ...
            protected UpdateUserProfileStatus.Response<T1, T2> InternalExecute<T1, T2>(
                string namespace_,
                string userId
            )
            {
            ...
            protected async Task<UpdateUserProfileStatus.Response<T1, T2>> InternalExecuteAsync<T1, T2>(
                string namespace_,
                string userId
            )
            {
        ...
        public class UpdateUserProfileStatusBuilder : UpdateUserProfileStatusAbstractBuilder<UpdateUserProfileStatusBuilder>
        {
            public UpdateUserProfileStatusBuilder() : base() { }

            public UpdateUserProfileStatusBuilder(IAccelByteSdk sdk) : base(sdk) { }

            public UpdateUserProfileStatus.Response Execute(
                string namespace_,
                string userId
            )
            {
            ...
            public async Task<UpdateUserProfileStatus.Response> ExecuteAsync(
                string namespace_,
                string userId
            )
            {
            ...
            public UpdateUserProfileStatus.Response<T1, T2> Execute<T1, T2>(
                string namespace_,
                string userId
            )
            {
            ...
            public async Task<UpdateUserProfileStatus.Response<T1, T2>> ExecuteAsync<T1, T2>(
                string namespace_,
                string userId
            )
            {
        ...
        public UpdateUserProfileStatus(IUpdateUserProfileStatusBuilder builder,
            string namespace_,
            string userId
        )
        {
        ...
        public class Response : ApiResponse<Model.UserProfilePrivateInfo>
        {
            ...
            protected override string GetFullOperationId() => "Basic::UserProfile::UpdateUserProfileStatus";
        }
        ...
        public UpdateUserProfileStatus.Response<T1, T2> ParseResponse<T1, T2>(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new UpdateUserProfileStatus.Response<T1, T2>()
            {
                StatusCode = code,
                ContentType = contentType
            };
