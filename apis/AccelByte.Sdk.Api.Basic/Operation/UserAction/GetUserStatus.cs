...
namespace AccelByte.Sdk.Api.Basic.Operation
{
    ...
    public class GetUserStatus : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<GetUserStatusBuilder>
        {
            ...
            internal GetUserStatusBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            )
            {
                ...
                op.SetBaseFields<GetUserStatusBuilder>(this);
                return op;
            }

            public Model.ADTOObjectForEqu8UserStatus? Execute(
                string namespace_,
                string userId
            )
            {
                GetUserStatus op = Build(
                    namespace_,
                    userId
                );
            ...
            public async Task<Model.ADTOObjectForEqu8UserStatus?> ExecuteAsync(
                string namespace_,
                string userId
            )
            {
        ...
        public Model.ADTOObjectForEqu8UserStatus? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<Model.ADTOObjectForEqu8UserStatus>(payload, ResponseJsonOptions);
            }
