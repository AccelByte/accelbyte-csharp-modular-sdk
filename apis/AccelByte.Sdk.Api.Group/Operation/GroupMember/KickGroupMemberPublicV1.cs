...
namespace AccelByte.Sdk.Api.Group.Operation
{
    ...
    public class KickGroupMemberPublicV1 : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ModelsKickGroupMemberResponseV1>
        {
            ...
            protected override string GetFullOperationId() => "Group::GroupMember::KickGroupMemberPublicV1";
        }
        ...
        public KickGroupMemberPublicV1.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new KickGroupMemberPublicV1.Response()
            {
                StatusCode = code,
