...
namespace AccelByte.Sdk.Api.Group.Operation
{
    ...
    public class AcceptGroupJoinRequestPublicV2 : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAcceptGroupJoinRequestPublicV2Builder
        {
        ...
        public abstract class AcceptGroupJoinRequestPublicV2AbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAcceptGroupJoinRequestPublicV2Builder
            where TImpl : AcceptGroupJoinRequestPublicV2AbstractBuilder<TImpl>
        {
            ...
            public AcceptGroupJoinRequestPublicV2AbstractBuilder() { }

            public AcceptGroupJoinRequestPublicV2AbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AcceptGroupJoinRequestPublicV2.Response InternalExecute(
                string groupId,
                string namespace_,
                string userId
            )
            ...
            protected async Task<AcceptGroupJoinRequestPublicV2.Response> InternalExecuteAsync(
                string groupId,
                string namespace_,
                string userId
            )
        ...
        public class AcceptGroupJoinRequestPublicV2Builder : AcceptGroupJoinRequestPublicV2AbstractBuilder<AcceptGroupJoinRequestPublicV2Builder>
        {
            public AcceptGroupJoinRequestPublicV2Builder() : base() { }

            public AcceptGroupJoinRequestPublicV2Builder(IAccelByteSdk sdk) : base(sdk) { }

            public AcceptGroupJoinRequestPublicV2.Response Execute(
                string groupId,
                string namespace_,
                string userId
            )
            ...
            public async Task<AcceptGroupJoinRequestPublicV2.Response> ExecuteAsync(
                string groupId,
                string namespace_,
                string userId
            )
        ...
        public AcceptGroupJoinRequestPublicV2(IAcceptGroupJoinRequestPublicV2Builder builder,
            string groupId,
            string namespace_,
            string userId
        )
        ...
        public class Response : ApiResponse<Model.ModelsMemberRequestGroupResponseV1>
        {
            ...
            protected override string GetFullOperationId() => "Group::GroupMember::AcceptGroupJoinRequestPublicV2";
        }
        ...
        public AcceptGroupJoinRequestPublicV2.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new AcceptGroupJoinRequestPublicV2.Response()
            {
                StatusCode = code,
