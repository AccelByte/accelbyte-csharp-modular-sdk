...
namespace AccelByte.Sdk.Api.Group.Operation
{
    ...
    public class LeaveGroupPublicV2 : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ModelsLeaveGroupResponseV1>
        {
            ...
            protected override string GetFullOperationId() => "Group::GroupMember::LeaveGroupPublicV2";
        }
        ...
        public LeaveGroupPublicV2.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new LeaveGroupPublicV2.Response()
            {
                StatusCode = code,
