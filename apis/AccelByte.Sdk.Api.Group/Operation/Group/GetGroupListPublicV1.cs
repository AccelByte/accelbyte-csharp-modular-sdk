...
namespace AccelByte.Sdk.Api.Group.Operation
{
    ...
    public class GetGroupListPublicV1 : AccelByte.Sdk.Core.Operation
    {
            ...
            : OperationBuilder<GetGroupListPublicV1Builder>
        {
            ...
            public async Task<Model.ModelsGetGroupsListResponseV1?> ExecuteAsync(
                string namespace_
            )
            {
                GetGroupListPublicV1 op = Build(
        ...
        public Model.ModelsGetGroupsListResponseV1? ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            {
                return JsonSerializer.Deserialize<Model.ModelsGetGroupsListResponseV1>(payload, ResponseJsonOptions);
            }
