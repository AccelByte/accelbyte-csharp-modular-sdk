...
namespace AccelByte.Sdk.Api.Loginqueue.Operation
{
    ...
    public class RefreshTicket : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ApimodelsRefreshTicketResponse>
        {
            ...
            protected override string GetFullOperationId() => "Loginqueue::TicketV1::RefreshTicket";
        }
        ...
        public RefreshTicket.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new RefreshTicket.Response()
            {
                StatusCode = code,
