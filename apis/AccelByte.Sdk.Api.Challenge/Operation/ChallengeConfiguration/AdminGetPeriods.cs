...
namespace AccelByte.Sdk.Api.Challenge.Operation
{
    ...
    public class AdminGetPeriods : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ModelListPeriodsResponse>
        {
            ...
            protected override string GetFullOperationId() => "Challenge::ChallengeConfiguration::AdminGetPeriods";
        }
