...
namespace AccelByte.Sdk.Api.Challenge.Operation
{
    ...
    public class AdminCreateGoal : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface IAdminCreateGoalBuilder
        {
        ...
        public abstract class AdminCreateGoalAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, IAdminCreateGoalBuilder
            where TImpl : AdminCreateGoalAbstractBuilder<TImpl>
        {
            ...
            public AdminCreateGoalAbstractBuilder() { }

            public AdminCreateGoalAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected AdminCreateGoal.Response InternalExecute(
                ModelCreateGoalRequest body,
                string challengeCode,
                string namespace_
            )
            ...
            protected async Task<AdminCreateGoal.Response> InternalExecuteAsync(
                ModelCreateGoalRequest body,
                string challengeCode,
                string namespace_
            )
        ...
        public class AdminCreateGoalBuilder : AdminCreateGoalAbstractBuilder<AdminCreateGoalBuilder>
        {
            public AdminCreateGoalBuilder() : base() { }

            public AdminCreateGoalBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public AdminCreateGoal(IAdminCreateGoalBuilder builder,
            ModelCreateGoalRequest body,
            string challengeCode,
            string namespace_
        )
