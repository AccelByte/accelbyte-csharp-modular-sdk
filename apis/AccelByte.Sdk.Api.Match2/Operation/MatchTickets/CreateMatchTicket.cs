...
namespace AccelByte.Sdk.Api.Match2.Operation
{
    ...
    public class CreateMatchTicket : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface ICreateMatchTicketBuilder
        {
        ...
        public abstract class CreateMatchTicketAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, ICreateMatchTicketBuilder
            where TImpl : CreateMatchTicketAbstractBuilder<TImpl>
        {
            ...
            public CreateMatchTicketAbstractBuilder() { }

            public CreateMatchTicketAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected CreateMatchTicket.Response InternalExecute(
                ApiMatchTicketRequest body,
                string namespace_
            )
            {
            ...
            protected async Task<CreateMatchTicket.Response> InternalExecuteAsync(
                ApiMatchTicketRequest body,
                string namespace_
            )
            {
        ...
        public class CreateMatchTicketBuilder : CreateMatchTicketAbstractBuilder<CreateMatchTicketBuilder>
        {
            public CreateMatchTicketBuilder() : base() { }

            public CreateMatchTicketBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public CreateMatchTicket(ICreateMatchTicketBuilder builder,
            ApiMatchTicketRequest body,
            string namespace_
        )
        {
        ...
        public CreateMatchTicket.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            ...
            else if ((code == (HttpStatusCode)201) || (code == (HttpStatusCode)202) || (code == (HttpStatusCode)200))
            {
                ...
                response.Data = JsonSerializer.Deserialize<Model.ApiMatchTicketResponse>(response.Payload, ResponseJsonOptions);
                response.IsSuccess = true;
            }
