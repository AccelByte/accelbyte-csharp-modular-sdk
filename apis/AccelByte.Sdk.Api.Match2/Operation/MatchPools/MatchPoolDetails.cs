...
namespace AccelByte.Sdk.Api.Match2.Operation
{
    ...
    public class MatchPoolDetails : AccelByte.Sdk.Core.Operation
    {
        ...
        public class Response : ApiResponse<Model.ApiMatchPool>
        {
            ...
            protected override string GetFullOperationId() => "Match2::MatchPools::MatchPoolDetails";
        }
        ...
        public MatchPoolDetails.Response ParseResponse(HttpStatusCode code, string contentType, Stream payload)
        {
            var response = new MatchPoolDetails.Response()
            {
                StatusCode = code,
