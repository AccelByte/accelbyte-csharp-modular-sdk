...
namespace AccelByte.Sdk.Api.Match2.Operation
{
    ...
    public class CreateMatchPool : AccelByte.Sdk.Core.Operation
    {
        ...
        public interface ICreateMatchPoolBuilder
        {
        ...
        public abstract class CreateMatchPoolAbstractBuilder<TImpl>
            : OperationBuilder<TImpl>, ICreateMatchPoolBuilder
            where TImpl : CreateMatchPoolAbstractBuilder<TImpl>
        {
            ...
            public CreateMatchPoolAbstractBuilder() { }

            public CreateMatchPoolAbstractBuilder(IAccelByteSdk sdk)
            {
                _Sdk = sdk;
            }
            ...
            protected CreateMatchPool.Response InternalExecute(
                ApiMatchPool body,
                string namespace_
            )
            {
            ...
            protected async Task<CreateMatchPool.Response> InternalExecuteAsync(
                ApiMatchPool body,
                string namespace_
            )
            {
        ...
        public class CreateMatchPoolBuilder : CreateMatchPoolAbstractBuilder<CreateMatchPoolBuilder>
        {
            public CreateMatchPoolBuilder() : base() { }

            public CreateMatchPoolBuilder(IAccelByteSdk sdk) : base(sdk) { }
        ...
        public CreateMatchPool(ICreateMatchPoolBuilder builder,
            ApiMatchPool body,
            string namespace_
        )
        {
