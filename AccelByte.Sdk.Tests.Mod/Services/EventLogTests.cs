...
namespace AccelByte.Sdk.Tests.Mod.Services
{
    ...
    public class EventLogTests : BaseServiceTests
    {
        ...
        public void EventLogServiceTests()
        {
            ...
            ModelsEventResponseV2? eResp = _Sdk.GetEventlogApi().EventV2.QueryEventStreamHandlerOp
                .SetOffset(0)
                .SetPageSize(10)
            ...
            try
            {
                ...
                ModelsEventResponseV2? cResp = _Sdk.GetEventlogApi().EventV2.GetEventSpecificUserV2HandlerOp
                    .SetOffset(0)
                    .SetPageSize(10)
