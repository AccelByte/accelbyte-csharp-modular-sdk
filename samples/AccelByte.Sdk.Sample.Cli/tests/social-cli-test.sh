...
#- 48 UpdateStat
# body param: body
echo '{"cycleIds": ["zRvUdK1uOV1ZJTYu", "vTMICtWyUtVDnhgT", "GXO8Utpwxug8Mpqc"], "defaultValue": 0.5381247324752749, "description": "pnpVX5u4gw4XBXDD", "ignoreAdditionalDataOnValueRejected": false, "isPublic": true, "name": "1o9zV6rhVfcQmLfE", "tags": ["6skHMfl4Hjw9KEnx", "n5ZUGeYlOwODWBAz", "8cNfDK45zWtwYhRo"]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn social \
    --op UpdateStat \
    --namespace $AB_NAMESPACE \
...
# body param: body
echo '{"cycleIds": ["sfOZbgnCmULqltV5", "DCk0koCGDPfbiGdB", "xjjrXKhZOekpygvR"]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn social \
