...
# body param: body
echo '{"clientId": "vIt8FOCD", "eventName": "mpjqgCGG", "payloadQuery": {"ecAUo7oH": {}, "rSjxAEn3": {}, "rEjIwjg2": {}}, "sessionId": "lInNnCac", "traceId": "VzPXE5cG", "userId": "Z2RpuJQK", "version": 95}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
