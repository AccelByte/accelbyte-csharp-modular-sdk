...
# body param: body
echo '{"clientId": "577xbVbb", "eventName": "Ly5OeeiH", "payloadQuery": {"lkuok7fp": {}, "1CmRNZ5r": {}, "jinV1yls": {}}, "sessionId": "RE2eFEt5", "traceId": "C9Q5zeBC", "userId": "X2TMGQTF", "version": 93}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
