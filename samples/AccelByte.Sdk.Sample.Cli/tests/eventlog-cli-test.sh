...
# body param: body
echo '{"clientId": "zqirG8IG", "eventName": "FpBk5Pw7", "payloadQuery": {"0nTeSGLS": {}, "YIboQbRV": {}, "5GLCLsNz": {}}, "sessionId": "XEtDOB0i", "traceId": "2wQw8dw5", "userId": "a3alyAo8", "version": 55}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
