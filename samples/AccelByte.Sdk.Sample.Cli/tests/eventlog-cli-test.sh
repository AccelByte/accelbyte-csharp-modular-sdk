...
# body param: body
echo '{"clientId": "jTV2uSui", "eventName": "8sIYGFdg", "payloadQuery": {"txtZfUa3": {}, "pLgbhxUu": {}, "TnjPBje0": {}}, "sessionId": "cIwMzx4A", "traceId": "CKQauhNT", "userId": "rQAgfZBp", "version": 54}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
