...
# body param: body
echo '{"clientId": "QDV2EorX", "eventName": "UvfbgPFd", "payloadQuery": {"s8qJm3Kh": {}, "dE3O3zqx": {}, "Ul9bYeRn": {}}, "sessionId": "8xh9Nbta", "traceId": "RcQWQsIX", "userId": "EGNtk5Ss", "version": 88}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
