...
# body param: body
echo '{"clientId": "7lhWVv0s", "eventName": "GcRETp3i", "payloadQuery": {"BMw21iDO": {}, "DQyh6G63": {}, "PmuqIKuI": {}}, "sessionId": "ueHYZNPy", "traceId": "CBruibOm", "userId": "VdZAeyuV", "version": 35}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
