...
# body param: body
echo '{"clientId": "CmWjUxxV", "eventName": "a6o3Xr5z", "payloadQuery": {"mTK5Yi4U": {}, "Zc8NlaA9": {}, "rKlQllGC": {}}, "sessionId": "AyKgHAYJ", "traceId": "LIDzTTXG", "userId": "vNhOfOtI", "version": 15}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
