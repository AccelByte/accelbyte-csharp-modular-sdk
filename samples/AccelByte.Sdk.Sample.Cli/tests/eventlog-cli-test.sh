...
# body param: body
echo '{"clientId": "ZdJUxRrz", "eventName": "emHalr1Y", "payloadQuery": {"on3wRmpG": {}, "6tYhuIBC": {}, "vXkVZdDm": {}}, "sessionId": "GPJndZQ2", "traceId": "R7PRduLv", "userId": "b8bhaOY1", "version": 87}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
