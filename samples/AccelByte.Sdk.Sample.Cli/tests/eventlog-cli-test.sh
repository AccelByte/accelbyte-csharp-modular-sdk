...
# body param: body
echo '{"clientId": "kWsHRz1P", "eventName": "AHTTWjWy", "payloadQuery": {"QQ9j4gD6": {}, "sUDU4WDK": {}, "gvNVJnkt": {}}, "sessionId": "zcY6dqiN", "traceId": "5OjFm2ea", "userId": "jrVijo3x", "version": 79}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
