...
# body param: body
echo '{"clientId": "AoEFkKfw", "eventName": "A7evZwZ9", "payloadQuery": {"drC2w5y1": {}, "m2QUPczO": {}, "0DacD39T": {}}, "sessionId": "UVWaOuLm", "traceId": "vRWaEh0v", "userId": "Dxr0Aoum", "version": 83}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
