...
# body param: body
echo '{"clientId": "qylSSsT2", "eventName": "vFlsTMO6", "payloadQuery": {"1imlGwTK": {}, "wJaegCm7": {}, "j9jOsYD4": {}}, "sessionId": "1lhU7om6", "traceId": "lYTEeegx", "userId": "xO6rmusi", "version": 59}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
