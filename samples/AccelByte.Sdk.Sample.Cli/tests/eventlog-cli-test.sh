...
# body param: body
echo '{"clientId": "A3fTR56s", "eventName": "cSt6lVHD", "payloadQuery": {"N3tF0wv1": {}, "KAEBCOrr": {}, "g6ADBrNe": {}}, "sessionId": "rEOl1qFf", "traceId": "f48dKI6B", "userId": "sjhTCUoG", "version": 40}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
