...
# body param: body
echo '{"clientId": "9dtfJk1t", "eventName": "Xe1kMYPt", "payloadQuery": {"YROOAFEP": {}, "ExnFsCNB": {}, "Slg0zI9A": {}}, "sessionId": "TlaTtTZG", "traceId": "ZvU9dnaF", "userId": "J9MQcEK3", "version": 59}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
