...
# body param: body
echo '{"clientId": "SdCWU0Wg", "eventName": "rBg0sQc2", "payloadQuery": {"h9ixc2iD": {}, "1MqTIOVt": {}, "9RMT8qQS": {}}, "sessionId": "KmlqBfAR", "traceId": "18ZIuYJ6", "userId": "HLhHClNx", "version": 49}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn eventlog \
