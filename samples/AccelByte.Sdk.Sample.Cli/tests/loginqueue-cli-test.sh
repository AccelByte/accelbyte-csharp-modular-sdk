...
# body param: body
echo '{"enabled": false, "maxConcurrency": 25, "maxLoginRate": 93, "minActivationPeriodInSecond": 60, "playerPollingTimeInSecond": 86, "playerReconnectGracePeriodInSecond": 95, "queueReconnectGracePeriodInSecond": 82, "safetyMarginPercentage": 75}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn loginqueue \
