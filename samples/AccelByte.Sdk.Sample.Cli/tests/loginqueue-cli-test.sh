...
# body param: body
echo '{"enabled": false, "maxConcurrency": 2, "maxLoginRate": 56, "minActivationPeriodInSecond": 72, "playerPollingTimeInSecond": 16, "playerReconnectGracePeriodInSecond": 57, "queueReconnectGracePeriodInSecond": 36, "safetyMarginPercentage": 90}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn loginqueue \
