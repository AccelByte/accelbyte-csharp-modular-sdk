...
#- 20 CreatePolicy1
# body param: body
echo '{"affectedClientIds": ["qMIpfgxw2ff5twRY", "86un0L98WUoXvfU4", "USD1pZGMfPdGIOAZ"], "affectedCountries": ["afo9b4xJyNnvHKrm", "btdK2r4wWs6IpYBx", "8UuNlT86N9yO0vyD"], "basePolicyName": "6J5brVo20e6POTjr", "description": "inAVVovpAAXNzcpb", "tags": ["PgQ0hb2tLrsMeoZi", "mX3lLFeXCiaXP8jB", "jK81t2V9TVauFcGk"], "typeId": "RYkbhEM1zTNY3lpi"}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
    --op CreatePolicy1 \
    --namespace $AB_NAMESPACE \
...
# body param: body
echo '{"affectedClientIds": ["icGQAVv32ftRAsmC", "cQmnsUigVynjGFyV", "Bam8jPtKHTmzo0Jm"], "affectedCountries": ["ADRqJvaZrf2qXQFC", "zRV1paELj5dw3LK0", "0RuRA8j1AJ3hNWWh"], "basePolicyName": "gPYhPPG5sAIfYtYo", "description": "zA2OntGCwQSHHdPL", "tags": ["BhRAYjR7c4x5bIk8", "wjTngrvb2E1X9ecB", "pVpxdUWOPel3TiwT"]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
...
# body param: body
echo '[{"isAccepted": false, "isNeedToSendEventMarketing": false, "localizedPolicyVersionId": "SCe7du68Ce6T4pYH", "policyId": "3BPyFurT4p8zoRYG", "policyVersionId": "8WKTaUyB0UyrKKul"}, {"isAccepted": false, "isNeedToSendEventMarketing": false, "localizedPolicyVersionId": "nompTrS7DIOakX65", "policyId": "w7RpxY6pd1QTpFpa", "policyVersionId": "xbCjHSCXM7sL1nnO"}, {"isAccepted": false, "isNeedToSendEventMarketing": true, "localizedPolicyVersionId": "RIg7oSh4yVttp53w", "policyId": "asuHbA0keUomVCh6", "policyVersionId": "81OMZFNRw8YvLGLn"}]' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
    --op IndirectBulkAcceptVersionedPolicy1 \
    --userId 'B4xfqdHhPHA2ZbIv' \
    --reqfile $TEMP_JSON_INPUT \
    > test.out 2>&1
...
$CLI_EXE \
    ...
    --clientId 'W1oxENH4MsVlbCMc' \
    --countryCode '5hx0W14SkvovINeg' \
    --namespace $AB_NAMESPACE \
...
$CLI_EXE \
    ...
    --localizedPolicyVersionId 'k8EM0OFW93FkJicm' \
    > test.out 2>&1
...
$CLI_EXE \
    ...
    --localizedPolicyVersionId 'K6qeaDEm9bPCS2a5' \
    --namespace $AB_NAMESPACE \
    > test.out 2>&1
...
$CLI_EXE \
    ...
    --countryCode 'WoOtwavdioadjCN0' \
    --defaultOnEmpty 'false' \
    --policyType 'LEGAL_DOCUMENT_TYPE' \
    --tags 'C0MZRZAvhZ7XQmcT' \
    > test.out 2>&1
...
$CLI_EXE \
    ...
    --countryCode 'Env4ipAVJzPHM6kT' \
    --namespace $AB_NAMESPACE \
    --alwaysIncludeDefault 'true' \
    --defaultOnEmpty 'true' \
    --policyType 'LEGAL_DOCUMENT_TYPE' \
    --tags 'AIsJ06QlFCAa55r8' \
    > test.out 2>&1
