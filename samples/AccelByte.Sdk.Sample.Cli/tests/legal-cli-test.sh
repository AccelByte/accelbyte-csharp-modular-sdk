...
#- 20 CreatePolicy1
# body param: body
echo '{"affectedClientIds": ["86un0L98WUoXvfU4", "USD1pZGMfPdGIOAZ", "qMIpfgxw2ff5twRY"], "affectedCountries": ["8UuNlT86N9yO0vyD", "btdK2r4wWs6IpYBx", "afo9b4xJyNnvHKrm"], "basePolicyName": "6J5brVo20e6POTjr", "description": "inAVVovpAAXNzcpb", "tags": ["mX3lLFeXCiaXP8jB", "PgQ0hb2tLrsMeoZi", "jK81t2V9TVauFcGk"], "typeId": "RYkbhEM1zTNY3lpi"}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
    --op CreatePolicy1 \
    --namespace $AB_NAMESPACE \
...
# body param: body
echo '{"affectedClientIds": ["cQmnsUigVynjGFyV", "icGQAVv32ftRAsmC", "Bam8jPtKHTmzo0Jm"], "affectedCountries": ["ADRqJvaZrf2qXQFC", "zRV1paELj5dw3LK0", "0RuRA8j1AJ3hNWWh"], "basePolicyName": "gPYhPPG5sAIfYtYo", "description": "zA2OntGCwQSHHdPL", "tags": ["pVpxdUWOPel3TiwT", "wjTngrvb2E1X9ecB", "BhRAYjR7c4x5bIk8"]}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn legal \
