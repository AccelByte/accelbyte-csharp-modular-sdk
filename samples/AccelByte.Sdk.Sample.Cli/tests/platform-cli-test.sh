...
# body param: body
echo '{"purchaseCondition": {"conditionGroups": [{"operator": "and", "predicates": [{"anyOf": 77, "comparison": "isGreaterThan", "name": "b0eqOcteeCdOhAs9", "predicateType": "SeasonPassPredicate", "value": "uj4Q4JFO685fpmek", "values": ["6ZE19elq1AQS5T2i", "RXZOiCWpjxyGuKJm", "VOMXprk3xnlp9dbs"]}, {"anyOf": 36, "comparison": "is", "name": "gcG56QuPIwtH47gz", "predicateType": "EntitlementPredicate", "value": "cdGcXWPGk9g9o4ZW", "values": ["rjhe1BQ3WyL3WXZ7", "r20TtVASVUB72Rop", "1yOUwZT9AOydyI4I"]}, {"anyOf": 31, "comparison": "isGreaterThanOrEqual", "name": "Q8lJvBQfZCPcvrJU", "predicateType": "SeasonTierPredicate", "value": "3INtlxMMqG0kuoQs", "values": ["IOlEpfw2hILzhfli", "BTnyiGFuZS5sEeLa", "HblRWi3iM6LjneQz"]}]}, {"operator": "or", "predicates": [{"anyOf": 45, "comparison": "includes", "name": "1kqvFWMvOTeeTzcN", "predicateType": "EntitlementPredicate", "value": "t0H7uGHolFYqyxw8", "values": ["MKwmiHQNZNPucoJJ", "tNClZ28GvRW3Bep4", "V2ZEFH62dVDcGl9w"]}, {"anyOf": 8, "comparison": "isNot", "name": "jFswIX3s95J7VtCC", "predicateType": "SeasonTierPredicate", "value": "QaIAoGdnGlHHx3qM", "values": ["2tpCjKIRzcYeJbBJ", "wPDtr7ejnj0OTnXc", "vKO9h5xbZKPG24wS"]}, {"anyOf": 69, "comparison": "excludes", "name": "oUe3vHUQpc5384Qe", "predicateType": "EntitlementPredicate", "value": "UaTM2MVk1AoBX7le", "values": ["0UBG2m0hHixeKRMu", "IWLUGGbNPkX6fcsr", "LeSNGRzRMIn7imzk"]}]}, {"operator": "and", "predicates": [{"anyOf": 70, "comparison": "isLessThan", "name": "1Ck4ZWBXatLAAnvL", "predicateType": "SeasonTierPredicate", "value": "jhsQe6Es4YzSrCXG", "values": ["1H8DmRnYweB4PJoF", "TWkR0RAGgoHpxBuE", "vGnLlUvDAOneZXLW"]}, {"anyOf": 92, "comparison": "is", "name": "GD5TALEFs4iv4KPD", "predicateType": "EntitlementPredicate", "value": "IGmuKco4zMotDuoW", "values": ["b3FDTIkDx3JX7BC3", "ACAZUZ8Rs9mjRlJe", "R2Sy9d0LOrtHuXT4"]}, {"anyOf": 5, "comparison": "includes", "name": "IRfYNYRzrbVAC1mv", "predicateType": "SeasonPassPredicate", "value": "vXPvqSHzQP4r11zN", "values": ["mIdfOy8B8ua5YzPL", "zbKseToolMT1anou", "vBsYt9hHSQO7N3pS"]}]}]}}' > $TEMP_JSON_INPUT
$CLI_EXE \
    --sn platform \
...
$CLI_EXE \
    ...
    --sortBy '["name:desc", "displayOrder:asc", "updatedAt:asc"]' \
