...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class GetPublicEditHistoryCommand : ISdkConsoleCommand
    {
        ...
        public GetPublicEditHistoryCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.GetPublicEditHistory.Builder;
            ...
            GetPublicEditHistory operation = opBuilder.Build(
                Namespace,
                UserId
            );
