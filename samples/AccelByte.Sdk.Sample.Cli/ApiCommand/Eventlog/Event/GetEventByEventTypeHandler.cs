...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class GetEventByEventTypeHandlerCommand : ISdkConsoleCommand
    {
        ...
        public GetEventByEventTypeHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.GetEventByEventTypeHandler.Builder;
            ...
            GetEventByEventTypeHandler operation = opBuilder.Build(
                EventType,
                Namespace,
                EndDate,
                PageSize,
