...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class GetEventByNamespaceHandlerCommand: ISdkConsoleCommand
    {
        ...
        public GetEventByNamespaceHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.GetEventByNamespaceHandler.Builder;
            ...
            GetEventByNamespaceHandler operation = opBuilder.Build(
                Namespace,
                EndDate,
                PageSize,
                StartDate
