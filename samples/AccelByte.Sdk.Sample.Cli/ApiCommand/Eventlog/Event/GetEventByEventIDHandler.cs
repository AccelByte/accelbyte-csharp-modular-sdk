...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class GetEventByEventIDHandlerCommand : ISdkConsoleCommand
    {
        ...
        public GetEventByEventIDHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.GetEventByEventIDHandler.Builder;
            ...
            GetEventByEventIDHandler operation = opBuilder.Build(
                EventId,
                Namespace,
                EndDate,
                PageSize,
