...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class UXNameDescriptionHandlerCommand: ISdkConsoleCommand
    {
        ...
        public UXNameDescriptionHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.UXNameDescriptionHandler.Builder;





            UXNameDescriptionHandler operation = opBuilder.Build(
            );
