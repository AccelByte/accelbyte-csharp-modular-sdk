...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class EventTypeDescriptionHandlerCommand : ISdkConsoleCommand
    {
        ...
        public EventTypeDescriptionHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.EventTypeDescriptionHandler.Builder;





            EventTypeDescriptionHandler operation = opBuilder.Build(
            );
