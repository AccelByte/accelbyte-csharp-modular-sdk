...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class SpecificEventLevelDescriptionHandlerCommand : ISdkConsoleCommand
    {
        ...
        public SpecificEventLevelDescriptionHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.SpecificEventLevelDescriptionHandler.Builder;

            if (EventLevels != null)
                opBuilder.SetEventLevels((string)EventLevels);




            SpecificEventLevelDescriptionHandler operation = opBuilder.Build(
            );
