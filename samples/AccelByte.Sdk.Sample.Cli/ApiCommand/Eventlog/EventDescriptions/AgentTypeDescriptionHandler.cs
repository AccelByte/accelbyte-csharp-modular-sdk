...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class AgentTypeDescriptionHandlerCommand : ISdkConsoleCommand
    {
        ...
        public AgentTypeDescriptionHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.AgentTypeDescriptionHandler.Builder;





            AgentTypeDescriptionHandler operation = opBuilder.Build(
            );
