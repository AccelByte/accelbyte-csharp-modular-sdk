...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class EventIDDescriptionHandlerCommand: ISdkConsoleCommand
    {
        ...
        public EventIDDescriptionHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.EventIDDescriptionHandler.Builder;





            EventIDDescriptionHandler operation = opBuilder.Build(
            );
