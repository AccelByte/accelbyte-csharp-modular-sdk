...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class GetUserActivitiesHandlerCommand: ISdkConsoleCommand
    {
        ...
        public GetUserActivitiesHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.GetUserActivitiesHandler.Builder;
            ...
            GetUserActivitiesHandler operation = opBuilder.Build(
                Namespace,
                UserId,
                PageSize
            );
