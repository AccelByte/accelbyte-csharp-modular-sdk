...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Eventlog
{
    ...
    public class UnregisterEventIDHandlerCommand : ISdkConsoleCommand
    {
        ...
        public UnregisterEventIDHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Eventlog.Operation.UnregisterEventIDHandler.Builder;





            UnregisterEventIDHandler operation = opBuilder.Build(
                EventId
            );
