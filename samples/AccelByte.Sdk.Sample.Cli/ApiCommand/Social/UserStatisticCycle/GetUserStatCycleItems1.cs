...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class GetUserStatCycleItems1Command : ISdkConsoleCommand
    {
        ...
        public GetUserStatCycleItems1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.GetUserStatCycleItems1.Builder;
            ...
            GetUserStatCycleItems1 operation = opBuilder.Build(
                CycleId,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.GetUserStatCycleItems1(operation);
