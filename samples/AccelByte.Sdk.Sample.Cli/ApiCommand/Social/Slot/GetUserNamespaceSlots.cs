...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class GetUserNamespaceSlotsCommand: ISdkConsoleCommand
    {
        ...
        public GetUserNamespaceSlotsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.GetUserNamespaceSlots.Builder;





            GetUserNamespaceSlots operation = opBuilder.Build(
                Namespace,
                UserId
            );
            ...
            var response = wrapper.GetUserNamespaceSlots(operation);
