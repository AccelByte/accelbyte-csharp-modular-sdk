...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class PublicDeleteProfileCommand : ISdkConsoleCommand
    {
        ...
        public PublicDeleteProfileCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.PublicDeleteProfile.Builder;





            PublicDeleteProfile operation = opBuilder.Build(
                Namespace,
                ProfileId,
                UserId
            );
            ...
            var response = wrapper.PublicDeleteProfile(operation);
