...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class GetStatCommand : ISdkConsoleCommand
    {
        ...
        public GetStatCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.GetStat.Builder;





            GetStat operation = opBuilder.Build(
                Namespace,
                StatCode
            );


            var response = wrapper.GetStat(operation);
