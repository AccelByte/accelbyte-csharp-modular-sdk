...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class BulkIncUserStatItemValue1Command: ISdkConsoleCommand
    {
        ...
        public BulkIncUserStatItemValue1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.BulkIncUserStatItemValue1.Builder;
            ...
            BulkIncUserStatItemValue1 operation = opBuilder.Build(
                Namespace,
                UserId
            );


            List<AccelByte.Sdk.Api.Social.Model.BulkStatOperationResult>? response = wrapper.BulkIncUserStatItemValue1(operation);
            if (response == null)
