...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class PublicIncUserStatItemCommand : ISdkConsoleCommand
    {
        ...
        public PublicIncUserStatItemCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.PublicIncUserStatItem.Builder;





            PublicIncUserStatItem operation = opBuilder.Build(
                Body,
                Namespace,
                StatCode,
                UserId
            ...
            var response = wrapper.PublicIncUserStatItem(operation);
