...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class BulkIncUserStatItemCommand: ISdkConsoleCommand
    {
        ...
        public BulkIncUserStatItemCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.BulkIncUserStatItem.Builder;
            ...
            BulkIncUserStatItem operation = opBuilder.Build(
                Namespace
            );


            List<AccelByte.Sdk.Api.Social.Model.BulkStatOperationResult>? response = wrapper.BulkIncUserStatItem(operation);
            if (response == null)
