...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class PublicIncUserStatItemValueCommand: ISdkConsoleCommand
    {
        ...
        public PublicIncUserStatItemValueCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.PublicIncUserStatItemValue.Builder;





            PublicIncUserStatItemValue operation = opBuilder.Build(
                Body,
                Namespace,
                StatCode,
                UserId
            ...
            var response = wrapper.PublicIncUserStatItemValue(operation);
