...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class BulkUpdateUserStatItem2Command: ISdkConsoleCommand
    {
        ...
        public BulkUpdateUserStatItem2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.BulkUpdateUserStatItem2.Builder;
            ...
            BulkUpdateUserStatItem2 operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.BulkUpdateUserStatItem2(operation);
