...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class PublicCreateUserStatItemCommand: ISdkConsoleCommand
    {
        ...
        public PublicCreateUserStatItemCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.PublicCreateUserStatItem.Builder;





            PublicCreateUserStatItem operation = opBuilder.Build(
                Namespace,
                StatCode,
                UserId
            );
            ...
            var response = wrapper.PublicCreateUserStatItem(operation);
