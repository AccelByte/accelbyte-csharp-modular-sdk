...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class UpdateUserStatItemValueCommand: ISdkConsoleCommand
    {
        ...
        public UpdateUserStatItemValueCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.UpdateUserStatItemValue.Builder;
            ...
            UpdateUserStatItemValue operation = opBuilder.Build(
                Namespace,
                StatCode,
                UserId
            );
            ...
            var response = wrapper.UpdateUserStatItemValue(operation);
