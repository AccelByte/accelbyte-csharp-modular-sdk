...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class DeleteUserStatItemsCommand : ISdkConsoleCommand
    {
        ...
        public DeleteUserStatItemsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.DeleteUserStatItems.Builder;





            DeleteUserStatItems operation = opBuilder.Build(
                Namespace,
                StatCode,
                UserId
            );
            ...
            var response = wrapper.DeleteUserStatItems(operation);
