...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class BulkIncUserStatItem1Command: ISdkConsoleCommand
    {
        ...
        public BulkIncUserStatItem1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.BulkIncUserStatItem1.Builder;
            ...
            BulkIncUserStatItem1 operation = opBuilder.Build(
                Namespace,
                UserId
            );


            List<AccelByte.Sdk.Api.Social.Model.BulkStatOperationResult>? response = wrapper.BulkIncUserStatItem1(operation);
            if (response == null)
