...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Social
{
    ...
    public class UpdateUserSlotConfigCommand: ISdkConsoleCommand
    {
        ...
        public UpdateUserSlotConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Social.Operation.UpdateUserSlotConfig.Builder;
            ...
            UpdateUserSlotConfig operation = opBuilder.Build(
                Namespace,
                UserId
            );
            ...
            var response = wrapper.UpdateUserSlotConfig(operation);
