...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class VerifyTokenV3Command: ISdkConsoleCommand
    {
        ...
        public VerifyTokenV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.VerifyTokenV3.Builder;





            VerifyTokenV3 operation = opBuilder.Build(
                Token
            );


            var response = wrapper.VerifyTokenV3(operation);
