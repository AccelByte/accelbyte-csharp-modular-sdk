...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PlatformTokenGrantV3Command: ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PlatformTokenGrantV3.Builder;
            ...
            PlatformTokenGrantV3 operation = opBuilder.Build(
                PlatformId
            );


            var response = wrapper.PlatformTokenGrantV3(operation);
