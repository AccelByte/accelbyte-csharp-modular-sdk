...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class TokenIntrospectionV3Command : ISdkConsoleCommand
    {
        ...
        public TokenIntrospectionV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.TokenIntrospectionV3.Builder;





            TokenIntrospectionV3 operation = opBuilder.Build(
                Token
            );


            var response = wrapper.TokenIntrospectionV3(operation);
