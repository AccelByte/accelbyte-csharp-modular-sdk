...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class Verify2faCodeCommand : ISdkConsoleCommand
    {
        ...
        public Verify2faCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.Verify2faCode.Builder;





            Verify2faCode operation = opBuilder.Build(
                Code,
                Factor,
                MfaToken,
                RememberDevice
            ...
            var response = wrapper.Verify2faCode(operation);
