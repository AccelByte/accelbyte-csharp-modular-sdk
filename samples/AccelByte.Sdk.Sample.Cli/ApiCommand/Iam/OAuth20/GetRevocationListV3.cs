...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class GetRevocationListV3Command: ISdkConsoleCommand
    {
        ...
        public GetRevocationListV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.GetRevocationListV3.Builder;





            GetRevocationListV3 operation = opBuilder.Build(
            );


            var response = wrapper.GetRevocationListV3(operation);
