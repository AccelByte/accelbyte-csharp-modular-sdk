...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class SendMFAAuthenticationCodeCommand : ISdkConsoleCommand
    {
        ...
        public SendMFAAuthenticationCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.SendMFAAuthenticationCode.Builder;





            SendMFAAuthenticationCode operation = opBuilder.Build(
                ClientId,
                Factor,
                MfaToken
            );
            ...
            var response = wrapper.SendMFAAuthenticationCode(operation);
