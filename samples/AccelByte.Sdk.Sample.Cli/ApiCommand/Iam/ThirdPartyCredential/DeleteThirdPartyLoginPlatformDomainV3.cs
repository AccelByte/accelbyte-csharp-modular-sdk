...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class DeleteThirdPartyLoginPlatformDomainV3Command : ISdkConsoleCommand
    {
        ...
        public DeleteThirdPartyLoginPlatformDomainV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.DeleteThirdPartyLoginPlatformDomainV3.Builder;





            DeleteThirdPartyLoginPlatformDomainV3 operation = opBuilder.Build(
                Body,
                Namespace,
                PlatformId
            );
            ...
            var response = wrapper.DeleteThirdPartyLoginPlatformDomainV3(operation);
