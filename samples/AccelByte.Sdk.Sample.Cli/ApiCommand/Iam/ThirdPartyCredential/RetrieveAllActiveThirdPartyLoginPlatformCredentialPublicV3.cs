...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3Command: ISdkConsoleCommand
    {
        ...
        public RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3.Builder;





            RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3(operation);
