...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class RetrieveAllThirdPartyLoginPlatformCredentialV3Command: ISdkConsoleCommand
    {
        ...
        public RetrieveAllThirdPartyLoginPlatformCredentialV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.RetrieveAllThirdPartyLoginPlatformCredentialV3.Builder;





            RetrieveAllThirdPartyLoginPlatformCredentialV3 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.RetrieveAllThirdPartyLoginPlatformCredentialV3(operation);
