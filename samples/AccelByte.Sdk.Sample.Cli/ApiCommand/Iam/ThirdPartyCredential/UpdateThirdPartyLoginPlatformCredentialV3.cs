...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class UpdateThirdPartyLoginPlatformCredentialV3Command : ISdkConsoleCommand
    {
        ...
        public UpdateThirdPartyLoginPlatformCredentialV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.UpdateThirdPartyLoginPlatformCredentialV3.Builder;





            UpdateThirdPartyLoginPlatformCredentialV3 operation = opBuilder.Build(
                Body,
                Namespace,
                PlatformId
            );
            ...
            var response = wrapper.UpdateThirdPartyLoginPlatformCredentialV3(operation);
