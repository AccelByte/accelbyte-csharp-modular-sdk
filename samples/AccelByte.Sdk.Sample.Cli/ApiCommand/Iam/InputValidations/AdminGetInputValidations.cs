...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminGetInputValidationsCommand : ISdkConsoleCommand
    {
        ...
        public AdminGetInputValidationsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminGetInputValidations.Builder;





            AdminGetInputValidations operation = opBuilder.Build(
            );


            var response = wrapper.AdminGetInputValidations(operation);
