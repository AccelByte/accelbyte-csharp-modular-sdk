...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminResetInputValidationsCommand: ISdkConsoleCommand
    {
        ...
        public AdminResetInputValidationsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminResetInputValidations.Builder;





            AdminResetInputValidations operation = opBuilder.Build(
                Field
            );


            var response = wrapper.AdminResetInputValidations(operation);
