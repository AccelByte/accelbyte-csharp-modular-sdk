...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminUpdateDeviceBanV4Command: ISdkConsoleCommand
    {
        ...
        public AdminUpdateDeviceBanV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminUpdateDeviceBanV4.Builder;





            AdminUpdateDeviceBanV4 operation = opBuilder.Build(
                Body,
                BanId,
                Namespace
            );
            ...
            var response = wrapper.AdminUpdateDeviceBanV4(operation);
