...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminDecryptDeviceV4Command : ISdkConsoleCommand
    {
        ...
        public AdminDecryptDeviceV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminDecryptDeviceV4.Builder;





            AdminDecryptDeviceV4 operation = opBuilder.Build(
                DeviceId,
                Namespace
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.AdminDecryptDeviceV4(operation);
