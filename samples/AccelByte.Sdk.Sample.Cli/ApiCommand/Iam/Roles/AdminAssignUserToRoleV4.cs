...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminAssignUserToRoleV4Command: ISdkConsoleCommand
    {
        ...
        public AdminAssignUserToRoleV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminAssignUserToRoleV4.Builder;





            AdminAssignUserToRoleV4 operation = opBuilder.Build(
                Body,
                RoleId
            );


            var response = wrapper.AdminAssignUserToRoleV4(operation);
