...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminUpdateRolePermissionsV4Command: ISdkConsoleCommand
    {
        ...
        public AdminUpdateRolePermissionsV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminUpdateRolePermissionsV4.Builder;





            AdminUpdateRolePermissionsV4 operation = opBuilder.Build(
                Body,
                RoleId
            );


            var response = wrapper.AdminUpdateRolePermissionsV4(operation);
