...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminUpdateRoleV4Command: ISdkConsoleCommand
    {
        ...
        public AdminUpdateRoleV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminUpdateRoleV4.Builder;





            AdminUpdateRoleV4 operation = opBuilder.Build(
                Body,
                RoleId
            );


            var response = wrapper.AdminUpdateRoleV4(operation);
