...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminRevokeUserFromRoleV4Command: ISdkConsoleCommand
    {
        ...
        public AdminRevokeUserFromRoleV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminRevokeUserFromRoleV4.Builder;





            AdminRevokeUserFromRoleV4 operation = opBuilder.Build(
                Body,
                RoleId
            );


            var response = wrapper.AdminRevokeUserFromRoleV4(operation);
