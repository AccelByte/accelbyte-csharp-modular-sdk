...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminRemoveRoleMembersV3Command : ISdkConsoleCommand
    {
        ...
        public AdminRemoveRoleMembersV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminRemoveRoleMembersV3.Builder;





            AdminRemoveRoleMembersV3 operation = opBuilder.Build(
                Body,
                RoleId
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.AdminRemoveRoleMembersV3(operation);
