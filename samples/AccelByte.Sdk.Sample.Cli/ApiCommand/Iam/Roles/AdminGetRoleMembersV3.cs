...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminGetRoleMembersV3Command : ISdkConsoleCommand
    {
        ...
        public AdminGetRoleMembersV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminGetRoleMembersV3.Builder;
            ...
            AdminGetRoleMembersV3 operation = opBuilder.Build(
                RoleId
            );


            var response = wrapper.AdminGetRoleMembersV3(operation);
