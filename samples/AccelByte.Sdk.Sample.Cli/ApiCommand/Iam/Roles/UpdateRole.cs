...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class UpdateRoleCommand : ISdkConsoleCommand
    {
        ...
        public UpdateRoleCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.UpdateRole.Builder;





            UpdateRole operation = opBuilder.Build(
                Body,
                RoleId
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.UpdateRole(operation);
