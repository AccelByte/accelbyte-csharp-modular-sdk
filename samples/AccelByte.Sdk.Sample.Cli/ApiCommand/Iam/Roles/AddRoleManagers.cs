...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AddRoleManagersCommand: ISdkConsoleCommand
    {
        ...
        public AddRoleManagersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AddRoleManagers.Builder;





            AddRoleManagers operation = opBuilder.Build(
                Body,
                RoleId
            );
            ...
            var response = wrapper.AddRoleManagers(operation);
