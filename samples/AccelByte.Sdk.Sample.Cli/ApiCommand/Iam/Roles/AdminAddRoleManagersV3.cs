...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminAddRoleManagersV3Command: ISdkConsoleCommand
    {
        ...
        public AdminAddRoleManagersV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminAddRoleManagersV3.Builder;





            AdminAddRoleManagersV3 operation = opBuilder.Build(
                Body,
                RoleId
            );


            var response = wrapper.AdminAddRoleManagersV3(operation);
