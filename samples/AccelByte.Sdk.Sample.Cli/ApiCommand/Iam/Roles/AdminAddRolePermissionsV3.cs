...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminAddRolePermissionsV3Command: ISdkConsoleCommand
    {
        ...
        public AdminAddRolePermissionsV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminAddRolePermissionsV3.Builder;





            AdminAddRolePermissionsV3 operation = opBuilder.Build(
                Body,
                RoleId
            );


            var response = wrapper.AdminAddRolePermissionsV3(operation);
