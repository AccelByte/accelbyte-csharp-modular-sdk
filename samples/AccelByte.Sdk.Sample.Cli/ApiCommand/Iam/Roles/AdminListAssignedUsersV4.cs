...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminListAssignedUsersV4Command : ISdkConsoleCommand
    {
        ...
        public AdminListAssignedUsersV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminListAssignedUsersV4.Builder;
            ...
            AdminListAssignedUsersV4 operation = opBuilder.Build(
                RoleId
            );


            var response = wrapper.AdminListAssignedUsersV4(operation);
