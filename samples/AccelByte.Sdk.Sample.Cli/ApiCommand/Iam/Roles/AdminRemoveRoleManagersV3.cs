...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminRemoveRoleManagersV3Command: ISdkConsoleCommand
    {
        ...
        public AdminRemoveRoleManagersV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminRemoveRoleManagersV3.Builder;





            AdminRemoveRoleManagersV3 operation = opBuilder.Build(
                Body,
                RoleId
            );


            var response = wrapper.AdminRemoveRoleManagersV3(operation);
