...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class GetClientsbyNamespaceCommand: ISdkConsoleCommand
    {
        ...
        public GetClientsbyNamespaceCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.GetClientsbyNamespace.Builder;





            GetClientsbyNamespace operation = opBuilder.Build(
                Namespace
            );
            ...
            var response = wrapper.GetClientsbyNamespace(operation);
