...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class CreateClientCommand : ISdkConsoleCommand
    {
        ...
        public CreateClientCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.CreateClient.Builder;





            CreateClient operation = opBuilder.Build(
                Body
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.CreateClient(operation);
