...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class DeleteClientPermissionCommand : ISdkConsoleCommand
    {
        ...
        public DeleteClientPermissionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.DeleteClientPermission.Builder;





            DeleteClientPermission operation = opBuilder.Build(
                Action,
                ClientId,
                Resource
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.DeleteClientPermission(operation);
