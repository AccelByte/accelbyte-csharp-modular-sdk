...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class LoginSSOClientCommand: ISdkConsoleCommand
    {
        ...
        public LoginSSOClientCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.LoginSSOClient.Builder;
            ...
            LoginSSOClient operation = opBuilder.Build(
                PlatformId
            );


            var response = wrapper.LoginSSOClient(operation);
