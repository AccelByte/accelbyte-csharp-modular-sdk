...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class RevokeAUserCommand : ISdkConsoleCommand
    {
        ...
        public RevokeAUserCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.RevokeAUser.Builder;





            RevokeAUser operation = opBuilder.Build(
                UserID
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.RevokeAUser(operation);
