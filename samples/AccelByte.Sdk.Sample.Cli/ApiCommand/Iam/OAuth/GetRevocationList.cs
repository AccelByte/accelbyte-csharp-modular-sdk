...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class GetRevocationListCommand: ISdkConsoleCommand
    {
        ...
        public GetRevocationListCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.GetRevocationList.Builder;





            GetRevocationList operation = opBuilder.Build(
            );

            #pragma warning restore ab_deprecated_operation

            #pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.GetRevocationList(operation);
