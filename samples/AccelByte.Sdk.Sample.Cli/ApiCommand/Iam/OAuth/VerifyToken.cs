...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class VerifyTokenCommand: ISdkConsoleCommand
    {
        ...
        public VerifyTokenCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.VerifyToken.Builder;





            VerifyToken operation = opBuilder.Build(
                Token
            );
            ...
            var response = wrapper.VerifyToken(operation);
