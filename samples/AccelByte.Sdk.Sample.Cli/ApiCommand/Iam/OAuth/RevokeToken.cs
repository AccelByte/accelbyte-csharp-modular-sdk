...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class RevokeTokenCommand: ISdkConsoleCommand
    {
        ...
        public RevokeTokenCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.RevokeToken.Builder;





            RevokeToken operation = opBuilder.Build(
                Token
            );
            ...
            var response = wrapper.RevokeToken(operation);
