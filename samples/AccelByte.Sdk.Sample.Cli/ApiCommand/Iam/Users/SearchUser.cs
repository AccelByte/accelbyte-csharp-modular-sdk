...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class SearchUserCommand : ISdkConsoleCommand
    {
        ...
        public SearchUserCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.SearchUser.Builder;
            ...
            SearchUser operation = opBuilder.Build(
                Namespace
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.SearchUser(operation);
