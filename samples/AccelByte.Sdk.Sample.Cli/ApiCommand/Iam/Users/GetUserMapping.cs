...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class GetUserMappingCommand : ISdkConsoleCommand
    {
        ...
        public GetUserMappingCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.GetUserMapping.Builder;





            GetUserMapping operation = opBuilder.Build(
                Namespace,
                TargetNamespace,
                UserId
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.GetUserMapping(operation);
