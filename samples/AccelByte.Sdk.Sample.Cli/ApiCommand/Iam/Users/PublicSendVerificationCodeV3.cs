...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicSendVerificationCodeV3Command : ISdkConsoleCommand
    {
        ...
        public PublicSendVerificationCodeV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicSendVerificationCodeV3.Builder;





            PublicSendVerificationCodeV3 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.PublicSendVerificationCodeV3(operation);
