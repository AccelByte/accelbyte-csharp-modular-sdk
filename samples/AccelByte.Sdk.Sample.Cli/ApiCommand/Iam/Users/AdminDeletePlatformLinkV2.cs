...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminDeletePlatformLinkV2Command: ISdkConsoleCommand
    {
        ...
        public AdminDeletePlatformLinkV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminDeletePlatformLinkV2.Builder;
            ...
            AdminDeletePlatformLinkV2 operation = opBuilder.Build(
                Namespace,
                PlatformId,
                UserId
            );
            ...
            var response = wrapper.AdminDeletePlatformLinkV2(operation);
