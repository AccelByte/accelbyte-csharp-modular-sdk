...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicPlatformLinkV3Command: ISdkConsoleCommand
    {
        ...
        public PublicPlatformLinkV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicPlatformLinkV3.Builder;
            ...
            PublicPlatformLinkV3 operation = opBuilder.Build(
                Ticket,
                Namespace,
                PlatformId
            );
            ...
            var response = wrapper.PublicPlatformLinkV3(operation);
