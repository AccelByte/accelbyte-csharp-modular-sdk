...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminGetBulkUserByEmailAddressV3Command: ISdkConsoleCommand
    {
        ...
        public AdminGetBulkUserByEmailAddressV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminGetBulkUserByEmailAddressV3.Builder;





            AdminGetBulkUserByEmailAddressV3 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.AdminGetBulkUserByEmailAddressV3(operation);
