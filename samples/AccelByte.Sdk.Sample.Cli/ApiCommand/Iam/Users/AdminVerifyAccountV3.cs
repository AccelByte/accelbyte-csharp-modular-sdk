...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminVerifyAccountV3Command: ISdkConsoleCommand
    {
        ...
        public AdminVerifyAccountV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminVerifyAccountV3.Builder;





            AdminVerifyAccountV3 operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.AdminVerifyAccountV3(operation);
