...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicSendVerificationLinkV3Command : ISdkConsoleCommand
    {
        ...
        public PublicSendVerificationLinkV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicSendVerificationLinkV3.Builder;





            PublicSendVerificationLinkV3 operation = opBuilder.Build(
                Body
            );


            var response = wrapper.PublicSendVerificationLinkV3(operation);
