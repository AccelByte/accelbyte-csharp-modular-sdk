...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminUpgradeHeadlessAccountV3Command : ISdkConsoleCommand
    {
        ...
        public AdminUpgradeHeadlessAccountV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminUpgradeHeadlessAccountV3.Builder;





            AdminUpgradeHeadlessAccountV3 operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.AdminUpgradeHeadlessAccountV3(operation);
