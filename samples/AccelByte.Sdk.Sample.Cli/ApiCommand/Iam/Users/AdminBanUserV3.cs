...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminBanUserV3Command: ISdkConsoleCommand
    {
        ...
        public AdminBanUserV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminBanUserV3.Builder;





            AdminBanUserV3 operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.AdminBanUserV3(operation);
