...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicUpdateUserV2Command: ISdkConsoleCommand
    {
        ...
        public PublicUpdateUserV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicUpdateUserV2.Builder;





            PublicUpdateUserV2 operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.PublicUpdateUserV2(operation);
