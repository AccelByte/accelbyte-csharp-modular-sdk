...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicLinkPlatformAccountCommand : ISdkConsoleCommand
    {
        ...
        public PublicLinkPlatformAccountCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicLinkPlatformAccount.Builder;





            PublicLinkPlatformAccount operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.PublicLinkPlatformAccount(operation);
