...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminUpdateCountryAgeRestrictionV3Command: ISdkConsoleCommand
    {
        ...
        public AdminUpdateCountryAgeRestrictionV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminUpdateCountryAgeRestrictionV3.Builder;





            AdminUpdateCountryAgeRestrictionV3 operation = opBuilder.Build(
                Body,
                CountryCode,
                Namespace
            );
            ...
            var response = wrapper.AdminUpdateCountryAgeRestrictionV3(operation);
