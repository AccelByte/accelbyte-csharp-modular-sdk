...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminUpdateUserDeletionStatusV3Command: ISdkConsoleCommand
    {
        ...
        public AdminUpdateUserDeletionStatusV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminUpdateUserDeletionStatusV3.Builder;





            AdminUpdateUserDeletionStatusV3 operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.AdminUpdateUserDeletionStatusV3(operation);
