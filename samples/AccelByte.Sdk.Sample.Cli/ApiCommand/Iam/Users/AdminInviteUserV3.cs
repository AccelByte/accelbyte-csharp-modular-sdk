...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminInviteUserV3Command: ISdkConsoleCommand
    {
        ...
        public AdminInviteUserV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminInviteUserV3.Builder;





            AdminInviteUserV3 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.AdminInviteUserV3(operation);
