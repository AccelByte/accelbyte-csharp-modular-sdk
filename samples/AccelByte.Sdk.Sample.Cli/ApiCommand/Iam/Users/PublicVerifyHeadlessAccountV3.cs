...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicVerifyHeadlessAccountV3Command : ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicVerifyHeadlessAccountV3.Builder;

            if (NeedVerificationCode != null)
                opBuilder.SetNeedVerificationCode((bool)NeedVerificationCode);




            PublicVerifyHeadlessAccountV3 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.PublicVerifyHeadlessAccountV3(operation);
