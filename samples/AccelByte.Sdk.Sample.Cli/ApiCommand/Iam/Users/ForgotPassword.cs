...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class ForgotPasswordCommand : ISdkConsoleCommand
    {
        ...
        public ForgotPasswordCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.ForgotPassword.Builder;





            ForgotPassword operation = opBuilder.Build(
                Body,
                Namespace
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.ForgotPassword(operation);
