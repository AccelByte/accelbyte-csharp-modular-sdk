...
{
    [SdkConsoleCommand("iam", "adminlinkplatformaccount")]
    public class AdminLinkPlatformAccountCommand : ISdkConsoleCommand
    {
        private IAccelByteSdk _SDK;

        public string ServiceName { get { return "Iam"; } }

        public string OperationName { get { return "AdminLinkPlatformAccount"; } }
        ...
        public AdminLinkPlatformAccountCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            AdminLinkPlatformAccount operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
