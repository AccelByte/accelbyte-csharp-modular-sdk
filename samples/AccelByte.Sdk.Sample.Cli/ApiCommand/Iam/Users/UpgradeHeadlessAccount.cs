...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class UpgradeHeadlessAccountCommand: ISdkConsoleCommand
    {
        ...
        public UpgradeHeadlessAccountCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.UpgradeHeadlessAccount.Builder;





            UpgradeHeadlessAccount operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.UpgradeHeadlessAccount(operation);
