...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class UpdateCountryAgeRestrictionCommand : ISdkConsoleCommand
    {
        ...
        public UpdateCountryAgeRestrictionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.UpdateCountryAgeRestriction.Builder;





            UpdateCountryAgeRestriction operation = opBuilder.Build(
                Body,
                CountryCode,
                Namespace
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.UpdateCountryAgeRestriction(operation);
