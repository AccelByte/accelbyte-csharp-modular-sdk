...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class UpdatePasswordCommand : ISdkConsoleCommand
    {
        ...
        public UpdatePasswordCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.UpdatePassword.Builder;





            UpdatePassword operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.UpdatePassword(operation);
