...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicPlatformUnlinkV3Command: ISdkConsoleCommand
    {
        ...
        public PublicPlatformUnlinkV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicPlatformUnlinkV3.Builder;





            PublicPlatformUnlinkV3 operation = opBuilder.Build(
                Body,
                Namespace,
                PlatformId
            );
            ...
            var response = wrapper.PublicPlatformUnlinkV3(operation);
