...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicUpgradeHeadlessAccountV3Command: ISdkConsoleCommand
    {
        ...
        public PublicUpgradeHeadlessAccountV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicUpgradeHeadlessAccountV3.Builder;





            PublicUpgradeHeadlessAccountV3 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.PublicUpgradeHeadlessAccountV3(operation);
