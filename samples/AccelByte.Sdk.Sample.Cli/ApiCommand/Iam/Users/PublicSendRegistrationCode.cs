...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicSendRegistrationCodeCommand : ISdkConsoleCommand
    {
        ...
        public PublicSendRegistrationCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicSendRegistrationCode.Builder;





            PublicSendRegistrationCode operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.PublicSendRegistrationCode(operation);
