...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class DeleteUserPermissionCommand: ISdkConsoleCommand
    {
        ...
        public DeleteUserPermissionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.DeleteUserPermission.Builder;





            DeleteUserPermission operation = opBuilder.Build(
                Action,
                Namespace,
                Resource,
                UserId
            ...
            var response = wrapper.DeleteUserPermission(operation);
