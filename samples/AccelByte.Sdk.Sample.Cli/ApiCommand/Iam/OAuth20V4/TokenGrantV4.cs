...
{
    [SdkConsoleCommand("iam", "tokengrantv4")]
    public class TokenGrantV4Command : ISdkConsoleCommand
    {
        private IAccelByteSdk _SDK;

        public string ServiceName { get { return "Iam"; } }

        public string OperationName { get { return "TokenGrantV4"; } }
        ...
        [SdkCommandArgument("login_queue_ticket")]
        public string LoginQueueTicket { get; set; } = String.Empty;
        ...
        public TokenGrantV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.TokenGrantV4.Builder;

            if (CodeChallenge != null)
                opBuilder.SetCodeChallenge((string)CodeChallenge);
            if (CodeChallengeMethod != null)
                opBuilder.SetCodeChallengeMethod(TokenGrantV4CodeChallengeMethod.NewValue(CodeChallengeMethod));
            ...
            if (LoginQueueTicket != null)
                opBuilder.SetLoginQueueTicket((string)LoginQueueTicket);
            if (Password != null)
            ...
            TokenGrantV4 operation = opBuilder.Build(
                GrantType
            );


            AccelByte.Sdk.Api.Iam.Model.OauthmodelTokenWithDeviceCookieResponseV3? response = wrapper.TokenGrantV4(operation);
            if (response == null)
