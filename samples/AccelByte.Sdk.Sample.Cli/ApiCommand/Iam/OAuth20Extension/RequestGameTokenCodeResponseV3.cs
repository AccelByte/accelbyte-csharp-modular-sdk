...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class RequestGameTokenCodeResponseV3Command : ISdkConsoleCommand
    {
        ...
        public RequestGameTokenCodeResponseV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.RequestGameTokenCodeResponseV3.Builder;





            RequestGameTokenCodeResponseV3 operation = opBuilder.Build(
                ClientId,
                Namespace
            );
