...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class UserAuthenticationV3Command : ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.UserAuthenticationV3.Builder;
            ...
            UserAuthenticationV3 operation = opBuilder.Build(
                Password,
                RequestId,
                UserName
            );
            ...
            var response = wrapper.UserAuthenticationV3(operation);
