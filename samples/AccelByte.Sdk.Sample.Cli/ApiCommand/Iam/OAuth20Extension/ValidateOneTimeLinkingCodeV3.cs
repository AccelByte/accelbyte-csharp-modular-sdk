...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class ValidateOneTimeLinkingCodeV3Command : ISdkConsoleCommand
    {
        ...
        public ValidateOneTimeLinkingCodeV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.ValidateOneTimeLinkingCodeV3.Builder;





            ValidateOneTimeLinkingCodeV3 operation = opBuilder.Build(
                OneTimeLinkCode
            );


            var response = wrapper.ValidateOneTimeLinkingCodeV3(operation);
