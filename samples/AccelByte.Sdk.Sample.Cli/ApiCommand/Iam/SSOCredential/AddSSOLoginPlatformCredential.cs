...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AddSSOLoginPlatformCredentialCommand : ISdkConsoleCommand
    {
        ...
        public AddSSOLoginPlatformCredentialCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AddSSOLoginPlatformCredential.Builder;





            AddSSOLoginPlatformCredential operation = opBuilder.Build(
                Body,
                Namespace,
                PlatformId
            );
            ...
            var response = wrapper.AddSSOLoginPlatformCredential(operation);
