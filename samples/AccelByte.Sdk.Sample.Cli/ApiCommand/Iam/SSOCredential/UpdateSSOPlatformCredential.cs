...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class UpdateSSOPlatformCredentialCommand : ISdkConsoleCommand
    {
        ...
        public UpdateSSOPlatformCredentialCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.UpdateSSOPlatformCredential.Builder;





            UpdateSSOPlatformCredential operation = opBuilder.Build(
                Body,
                Namespace,
                PlatformId
            );
            ...
            var response = wrapper.UpdateSSOPlatformCredential(operation);
