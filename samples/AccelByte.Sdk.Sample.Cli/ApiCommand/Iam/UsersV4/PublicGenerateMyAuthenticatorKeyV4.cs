...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicGenerateMyAuthenticatorKeyV4Command: ISdkConsoleCommand
    {
        ...
        public PublicGenerateMyAuthenticatorKeyV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicGenerateMyAuthenticatorKeyV4.Builder;





            PublicGenerateMyAuthenticatorKeyV4 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.PublicGenerateMyAuthenticatorKeyV4(operation);
