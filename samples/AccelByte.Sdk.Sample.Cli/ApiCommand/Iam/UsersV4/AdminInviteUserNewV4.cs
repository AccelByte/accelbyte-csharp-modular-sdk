...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminInviteUserNewV4Command: ISdkConsoleCommand
    {
        ...
        public AdminInviteUserNewV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminInviteUserNewV4.Builder;





            AdminInviteUserNewV4 operation = opBuilder.Build(
                Body
            );


            AccelByte.Sdk.Api.Iam.Model.ModelInviteUserResponseV3? response = wrapper.AdminInviteUserNewV4(operation);
            if (response == null)
