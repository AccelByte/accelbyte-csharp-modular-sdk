...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminGenerateMyAuthenticatorKeyV4Command : ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminGenerateMyAuthenticatorKeyV4.Builder;





            AdminGenerateMyAuthenticatorKeyV4 operation = opBuilder.Build(
            );


            var response = wrapper.AdminGenerateMyAuthenticatorKeyV4(operation);
