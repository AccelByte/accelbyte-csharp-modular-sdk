...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminCreateTestUsersV4Command : ISdkConsoleCommand
    {
        ...
        public AdminCreateTestUsersV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminCreateTestUsersV4.Builder;





            AdminCreateTestUsersV4 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.AdminCreateTestUsersV4(operation);
