...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminListUserRolesV4Command : ISdkConsoleCommand
    {
        ...
        public AdminListUserRolesV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminListUserRolesV4.Builder;





            AdminListUserRolesV4 operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.AdminListUserRolesV4(operation);
