...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminUpdateUserEmailAddressV4Command: ISdkConsoleCommand
    {
        ...
        public AdminUpdateUserEmailAddressV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminUpdateUserEmailAddressV4.Builder;





            AdminUpdateUserEmailAddressV4 operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.AdminUpdateUserEmailAddressV4(operation);
