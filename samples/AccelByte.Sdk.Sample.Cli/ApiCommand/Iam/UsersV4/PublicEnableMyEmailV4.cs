...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicEnableMyEmailV4Command : ISdkConsoleCommand
    {
        ...
        public PublicEnableMyEmailV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicEnableMyEmailV4.Builder;





            PublicEnableMyEmailV4 operation = opBuilder.Build(
                Code,
                Namespace
            );


            var response = wrapper.PublicEnableMyEmailV4(operation);
