...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminBulkCheckValidUserIDV4Command: ISdkConsoleCommand
    {
        ...
        public AdminBulkCheckValidUserIDV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminBulkCheckValidUserIDV4.Builder;





            AdminBulkCheckValidUserIDV4 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.AdminBulkCheckValidUserIDV4(operation);
