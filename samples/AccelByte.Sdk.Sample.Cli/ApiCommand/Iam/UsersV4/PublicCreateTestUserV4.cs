...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicCreateTestUserV4Command : ISdkConsoleCommand
    {
        ...
        public PublicCreateTestUserV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicCreateTestUserV4.Builder;





            PublicCreateTestUserV4 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.PublicCreateTestUserV4(operation);
