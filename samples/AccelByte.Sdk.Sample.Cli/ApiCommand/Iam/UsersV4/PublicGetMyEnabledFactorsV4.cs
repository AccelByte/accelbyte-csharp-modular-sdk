...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicGetMyEnabledFactorsV4Command : ISdkConsoleCommand
    {
        ...
        public PublicGetMyEnabledFactorsV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicGetMyEnabledFactorsV4.Builder;





            PublicGetMyEnabledFactorsV4 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.PublicGetMyEnabledFactorsV4(operation);
