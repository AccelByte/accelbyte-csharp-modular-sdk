...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicRemoveTrustedDeviceV4Command : ISdkConsoleCommand
    {
        ...
        public PublicRemoveTrustedDeviceV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicRemoveTrustedDeviceV4.Builder;





            PublicRemoveTrustedDeviceV4 operation = opBuilder.Build(
                Namespace,
                DeviceToken
            );


            var response = wrapper.PublicRemoveTrustedDeviceV4(operation);
