...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class CreateUserFromInvitationV4Command: ISdkConsoleCommand
    {
        ...
        public CreateUserFromInvitationV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.CreateUserFromInvitationV4.Builder;





            CreateUserFromInvitationV4 operation = opBuilder.Build(
                Body,
                InvitationId,
                Namespace
            );
            ...
            var response = wrapper.CreateUserFromInvitationV4(operation);
