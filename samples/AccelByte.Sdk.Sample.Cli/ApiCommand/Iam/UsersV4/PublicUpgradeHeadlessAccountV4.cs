...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class PublicUpgradeHeadlessAccountV4Command: ISdkConsoleCommand
    {
        ...
        public PublicUpgradeHeadlessAccountV4Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.PublicUpgradeHeadlessAccountV4.Builder;





            PublicUpgradeHeadlessAccountV4 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.PublicUpgradeHeadlessAccountV4(operation);
