...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminUnbanUserBulkV3Command: ISdkConsoleCommand
    {
        ...
        public AdminUnbanUserBulkV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminUnbanUserBulkV3.Builder;





            AdminUnbanUserBulkV3 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.AdminUnbanUserBulkV3(operation);
