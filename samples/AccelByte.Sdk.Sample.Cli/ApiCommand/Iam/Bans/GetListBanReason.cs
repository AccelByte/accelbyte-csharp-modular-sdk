...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class GetListBanReasonCommand: ISdkConsoleCommand
    {
        ...
        public GetListBanReasonCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.GetListBanReason.Builder;





            GetListBanReason operation = opBuilder.Build(
            );

            #pragma warning restore ab_deprecated_operation

            #pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.GetListBanReason(operation);
