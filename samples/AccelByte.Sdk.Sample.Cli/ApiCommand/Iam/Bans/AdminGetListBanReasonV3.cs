...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Iam
{
    ...
    public class AdminGetListBanReasonV3Command : ISdkConsoleCommand
    {
        ...
        public AdminGetListBanReasonV3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Iam.Operation.AdminGetListBanReasonV3.Builder;





            AdminGetListBanReasonV3 operation = opBuilder.Build(
            );


            var response = wrapper.AdminGetListBanReasonV3(operation);
