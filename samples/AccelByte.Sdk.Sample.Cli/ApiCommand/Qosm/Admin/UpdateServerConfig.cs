...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Qosm
{
    ...
    public class UpdateServerConfigCommand: ISdkConsoleCommand
    {
        ...
        public UpdateServerConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Qosm.Operation.UpdateServerConfig.Builder;





            UpdateServerConfig operation = opBuilder.Build(
                Body,
                Namespace,
                Region
            );
