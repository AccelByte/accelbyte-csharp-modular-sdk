...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class PublicGetTimeCommand : ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.PublicGetTime.Builder;





            PublicGetTime operation = opBuilder.Build(
            );


            var response = wrapper.PublicGetTime(operation);
