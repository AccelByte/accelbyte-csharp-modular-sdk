...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class GetTimeZonesCommand: ISdkConsoleCommand
    {
        ...
        public GetTimeZonesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.GetTimeZones.Builder;





            GetTimeZones operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetTimeZones(operation);
