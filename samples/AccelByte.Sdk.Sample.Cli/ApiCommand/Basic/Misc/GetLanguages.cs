...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class GetLanguagesCommand : ISdkConsoleCommand
    {
        ...
        public GetLanguagesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.GetLanguages.Builder;





            GetLanguages operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetLanguages(operation);
