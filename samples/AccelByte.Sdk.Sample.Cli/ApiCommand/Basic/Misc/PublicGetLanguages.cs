...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class PublicGetLanguagesCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetLanguagesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.PublicGetLanguages.Builder;





            PublicGetLanguages operation = opBuilder.Build(
                Namespace
            );


            Dictionary<string, object>? response = wrapper.PublicGetLanguages(operation);
            if (response == null)
