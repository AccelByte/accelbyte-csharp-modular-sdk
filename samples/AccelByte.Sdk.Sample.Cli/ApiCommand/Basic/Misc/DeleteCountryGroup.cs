...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class DeleteCountryGroupCommand : ISdkConsoleCommand
    {
        ...
        public DeleteCountryGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.DeleteCountryGroup.Builder;





            DeleteCountryGroup operation = opBuilder.Build(
                CountryGroupCode,
                Namespace
            );


            var response = wrapper.DeleteCountryGroup(operation);
