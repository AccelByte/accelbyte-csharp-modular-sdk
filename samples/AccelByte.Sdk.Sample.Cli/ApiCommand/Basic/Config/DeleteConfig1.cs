...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class DeleteConfig1Command : ISdkConsoleCommand
    {
        ...
        public DeleteConfig1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.DeleteConfig1.Builder;





            DeleteConfig1 operation = opBuilder.Build(
                ConfigKey,
                Namespace
            );
