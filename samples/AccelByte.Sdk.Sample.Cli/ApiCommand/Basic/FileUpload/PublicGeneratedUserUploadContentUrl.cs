...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class PublicGeneratedUserUploadContentUrlCommand: ISdkConsoleCommand
    {
        ...
        public PublicGeneratedUserUploadContentUrlCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.PublicGeneratedUserUploadContentUrl.Builder;
            ...
            PublicGeneratedUserUploadContentUrl operation = opBuilder.Build(
                Namespace,
                UserId,
                FileType
            );
            ...
            var response = wrapper.PublicGeneratedUserUploadContentUrl(operation);
