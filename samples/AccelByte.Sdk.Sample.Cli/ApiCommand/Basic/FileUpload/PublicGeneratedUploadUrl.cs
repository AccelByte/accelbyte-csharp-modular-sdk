...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class PublicGeneratedUploadUrlCommand: ISdkConsoleCommand
    {
        ...
        public PublicGeneratedUploadUrlCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.PublicGeneratedUploadUrl.Builder;





            PublicGeneratedUploadUrl operation = opBuilder.Build(
                Folder,
                Namespace,
                FileType
            );
            ...
            var response = wrapper.PublicGeneratedUploadUrl(operation);
