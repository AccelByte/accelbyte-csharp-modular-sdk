...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class PublicUpdateCustomAttributesPartiallyCommand: ISdkConsoleCommand
    {
        ...
        public PublicUpdateCustomAttributesPartiallyCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.PublicUpdateCustomAttributesPartially.Builder;
            ...
            PublicUpdateCustomAttributesPartially operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.PublicUpdateCustomAttributesPartially(operation);
