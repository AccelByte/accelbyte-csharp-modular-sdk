...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class GetMyProfileInfoCommand: ISdkConsoleCommand
    {
        ...
        public GetMyProfileInfoCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.GetMyProfileInfo.Builder;





            GetMyProfileInfo operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetMyProfileInfo(operation);
