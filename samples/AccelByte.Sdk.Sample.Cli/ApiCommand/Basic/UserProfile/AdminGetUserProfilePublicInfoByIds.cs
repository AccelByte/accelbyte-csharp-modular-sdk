...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class AdminGetUserProfilePublicInfoByIdsCommand: ISdkConsoleCommand
    {
        ...
        public AdminGetUserProfilePublicInfoByIdsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.AdminGetUserProfilePublicInfoByIds.Builder;
            ...
            AdminGetUserProfilePublicInfoByIds operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.AdminGetUserProfilePublicInfoByIds(operation);
