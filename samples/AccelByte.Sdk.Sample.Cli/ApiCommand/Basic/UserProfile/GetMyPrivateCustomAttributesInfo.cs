...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class GetMyPrivateCustomAttributesInfoCommand: ISdkConsoleCommand
    {
        ...
        public GetMyPrivateCustomAttributesInfoCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.GetMyPrivateCustomAttributesInfo.Builder;





            GetMyPrivateCustomAttributesInfo operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetMyPrivateCustomAttributesInfo(operation);
