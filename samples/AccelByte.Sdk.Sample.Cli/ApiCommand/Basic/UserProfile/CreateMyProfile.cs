...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class CreateMyProfileCommand : ISdkConsoleCommand
    {
        ...
        public CreateMyProfileCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.CreateMyProfile.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Basic.Model.UserProfilePrivateCreate)Body);



            CreateMyProfile operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.CreateMyProfile(operation);
