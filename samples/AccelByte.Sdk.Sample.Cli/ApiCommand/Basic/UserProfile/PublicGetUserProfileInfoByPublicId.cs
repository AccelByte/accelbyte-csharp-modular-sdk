...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class PublicGetUserProfileInfoByPublicIdCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetUserProfileInfoByPublicIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.PublicGetUserProfileInfoByPublicId.Builder;





            PublicGetUserProfileInfoByPublicId operation = opBuilder.Build(
                Namespace,
                PublicId
            );


            var response = wrapper.PublicGetUserProfileInfoByPublicId(operation);
