...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class PublicUpdateUserProfileStatusCommand: ISdkConsoleCommand
    {
        ...
        public PublicUpdateUserProfileStatusCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.PublicUpdateUserProfileStatus.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Basic.Model.UserProfileStatusUpdate)Body);



            PublicUpdateUserProfileStatus operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.PublicUpdateUserProfileStatus(operation);
