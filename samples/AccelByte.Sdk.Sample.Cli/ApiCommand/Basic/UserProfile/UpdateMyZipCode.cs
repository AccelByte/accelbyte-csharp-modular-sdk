...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class UpdateMyZipCodeCommand : ISdkConsoleCommand
    {
        ...
        public UpdateMyZipCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.UpdateMyZipCode.Builder;





            UpdateMyZipCode operation = opBuilder.Build(
                UserZipCodeUpdate,
                Namespace
            );


            var response = wrapper.UpdateMyZipCode(operation);
