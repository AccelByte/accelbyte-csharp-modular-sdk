...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class UpdateUserProfileCommand: ISdkConsoleCommand
    {
        ...
        public UpdateUserProfileCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Basic.Model.UserProfileAdmin)Body);
            ...
            var response = wrapper.UpdateUserProfile(operation);
