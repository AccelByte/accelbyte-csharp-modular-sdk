...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class UpdateUserProfileStatusCommand : ISdkConsoleCommand
    {
        ...
        public UpdateUserProfileStatusCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.UpdateUserProfileStatus.Builder;
            ...
            UpdateUserProfileStatus operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.UpdateUserProfileStatus(operation);
