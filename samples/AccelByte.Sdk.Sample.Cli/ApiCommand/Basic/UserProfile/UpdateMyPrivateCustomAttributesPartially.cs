...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class UpdateMyPrivateCustomAttributesPartiallyCommand : ISdkConsoleCommand
    {
        ...
        public UpdateMyPrivateCustomAttributesPartiallyCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.UpdateMyPrivateCustomAttributesPartially.Builder;
            ...
            UpdateMyPrivateCustomAttributesPartially operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.UpdateMyPrivateCustomAttributesPartially(operation);
