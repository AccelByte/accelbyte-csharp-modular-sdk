...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class GetBannedUsersCommand: ISdkConsoleCommand
    {
        ...
        public GetBannedUsersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.GetBannedUsers.Builder;





            GetBannedUsers operation = opBuilder.Build(
                Namespace,
                UserIds
            );
