...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class BanUsersCommand: ISdkConsoleCommand
    {
        ...
        public BanUsersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.BanUsers.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Basic.Model.UserBanRequest)Body);



            BanUsers operation = opBuilder.Build(
                Namespace
            );
