...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class UnBanUsersCommand: ISdkConsoleCommand
    {
        ...
        public UnBanUsersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.UnBanUsers.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Basic.Model.ADTOForUnbanUserAPICall)Body);



            UnBanUsers operation = opBuilder.Build(
                Namespace
            );
