...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class GetUserStatusCommand : ISdkConsoleCommand
    {
        ...
        public GetUserStatusCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.GetUserStatus.Builder;





            GetUserStatus operation = opBuilder.Build(
                Namespace,
                UserId
            );
