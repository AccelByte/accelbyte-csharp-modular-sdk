...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class CreateNamespaceCommand : ISdkConsoleCommand
    {
        ...
        public CreateNamespaceCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Basic.Model.NamespaceCreate)Body);
            ...
            var response = wrapper.CreateNamespace(operation);
