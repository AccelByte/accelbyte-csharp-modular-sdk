...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class GetNamespacePublisherCommand : ISdkConsoleCommand
    {
        ...
        public GetNamespacePublisherCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.GetNamespacePublisher.Builder;





            GetNamespacePublisher operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetNamespacePublisher(operation);
