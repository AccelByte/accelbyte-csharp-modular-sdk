...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class DeleteNamespaceCommand : ISdkConsoleCommand
    {
        ...
        public DeleteNamespaceCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.DeleteNamespace.Builder;





            DeleteNamespace operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.DeleteNamespace(operation);
