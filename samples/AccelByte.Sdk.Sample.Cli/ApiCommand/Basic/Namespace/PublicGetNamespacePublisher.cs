...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class PublicGetNamespacePublisherCommand : ISdkConsoleCommand
    {
        ...
        public PublicGetNamespacePublisherCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.PublicGetNamespacePublisher.Builder;





            PublicGetNamespacePublisher operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.PublicGetNamespacePublisher(operation);
