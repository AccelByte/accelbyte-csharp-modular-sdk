...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Basic
{
    ...
    public class GetGameNamespacesCommand : ISdkConsoleCommand
    {
        ...
        public GetGameNamespacesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Basic.Operation.GetGameNamespaces.Builder;
            ...
            GetGameNamespaces operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetGameNamespaces(operation);
