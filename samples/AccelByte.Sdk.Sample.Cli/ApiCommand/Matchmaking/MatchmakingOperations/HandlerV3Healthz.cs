...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Matchmaking
{
    ...
    public class HandlerV3HealthzCommand: ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Matchmaking.Operation.HandlerV3Healthz.Builder;





            HandlerV3Healthz operation = opBuilder.Build(
            );


            var response = wrapper.HandlerV3Healthz(operation);
