...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Matchmaking
{
    ...
    public class GetAllPartyInChannelCommand: ISdkConsoleCommand
    {
        ...
        public GetAllPartyInChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Matchmaking.Operation.GetAllPartyInChannel.Builder;





            GetAllPartyInChannel operation = opBuilder.Build(
                ChannelName,
                Namespace
            );


            var response = wrapper.GetAllPartyInChannel(operation);
