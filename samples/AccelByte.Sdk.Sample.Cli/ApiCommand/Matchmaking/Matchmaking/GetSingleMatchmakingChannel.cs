...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Matchmaking
{
    ...
    public class GetSingleMatchmakingChannelCommand : ISdkConsoleCommand
    {
        ...
        public GetSingleMatchmakingChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Matchmaking.Operation.GetSingleMatchmakingChannel.Builder;





            GetSingleMatchmakingChannel operation = opBuilder.Build(
                ChannelName,
                Namespace
            );


            var response = wrapper.GetSingleMatchmakingChannel(operation);
