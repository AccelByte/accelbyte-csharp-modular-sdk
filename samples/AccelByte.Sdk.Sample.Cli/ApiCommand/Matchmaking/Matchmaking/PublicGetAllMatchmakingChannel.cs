...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Matchmaking
{
    ...
    public class PublicGetAllMatchmakingChannelCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetAllMatchmakingChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            PublicGetAllMatchmakingChannel operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.PublicGetAllMatchmakingChannel(operation);
