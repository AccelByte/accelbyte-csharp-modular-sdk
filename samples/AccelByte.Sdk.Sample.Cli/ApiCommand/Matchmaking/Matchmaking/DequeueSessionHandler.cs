...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Matchmaking
{
    ...
    public class DequeueSessionHandlerCommand : ISdkConsoleCommand
    {
        ...
        public DequeueSessionHandlerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Matchmaking.Operation.DequeueSessionHandler.Builder;





            DequeueSessionHandler operation = opBuilder.Build(
                Body,
                Namespace
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.DequeueSessionHandler(operation);
