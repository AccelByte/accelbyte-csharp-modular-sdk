...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Matchmaking
{
    ...
    public class DeleteUserFromSessionInChannelCommand: ISdkConsoleCommand
    {
        ...
        public DeleteUserFromSessionInChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            DeleteUserFromSessionInChannel operation = opBuilder.Build(
                ChannelName,
                MatchID,
                Namespace,
                UserID
            ...
            var response = wrapper.DeleteUserFromSessionInChannel(operation);
