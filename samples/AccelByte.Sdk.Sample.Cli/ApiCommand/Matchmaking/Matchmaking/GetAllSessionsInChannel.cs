...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Matchmaking
{
    ...
    public class GetAllSessionsInChannelCommand: ISdkConsoleCommand
    {
        ...
        public GetAllSessionsInChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Matchmaking.Operation.GetAllSessionsInChannel.Builder;





            GetAllSessionsInChannel operation = opBuilder.Build(
                ChannelName,
                Namespace
            );


            var response = wrapper.GetAllSessionsInChannel(operation);
