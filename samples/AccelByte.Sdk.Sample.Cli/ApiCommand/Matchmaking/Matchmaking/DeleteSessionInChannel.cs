...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Matchmaking
{
    ...
    public class DeleteSessionInChannelCommand : ISdkConsoleCommand
    {
        ...
        public DeleteSessionInChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Matchmaking.Operation.DeleteSessionInChannel.Builder;





            DeleteSessionInChannel operation = opBuilder.Build(
                ChannelName,
                MatchID,
                Namespace
            );
