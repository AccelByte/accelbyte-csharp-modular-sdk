...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsartifact
{
    ...
    public class ReportFailedUploadCommand: ISdkConsoleCommand
    {
        ...
        public ReportFailedUploadCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsartifact.Operation.ReportFailedUpload.Builder;





            ReportFailedUpload operation = opBuilder.Build(
                NodeIP,
                PodName
            );


            var response = wrapper.ReportFailedUpload(operation);
