...
{
    [SdkConsoleCommand("match2", "admingetconfigv1")]
    public class AdminGetConfigV1Command : ISdkConsoleCommand
    {
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Match2.Operation.AdminGetConfigV1.Builder;
            ...
            AccelByte.Sdk.Api.Match2.Model.ConfigmodelsNamespaceConfig? response = wrapper.AdminGetConfigV1(operation);
            if (response == null)
