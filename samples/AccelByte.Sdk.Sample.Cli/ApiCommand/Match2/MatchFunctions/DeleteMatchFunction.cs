...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Match2
{
    ...
    public class DeleteMatchFunctionCommand : ISdkConsoleCommand
    {
        ...
        public DeleteMatchFunctionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Match2.Operation.DeleteMatchFunction.Builder;





            DeleteMatchFunction operation = opBuilder.Build(
                Name,
                Namespace
            );


            var response = wrapper.DeleteMatchFunction(operation);
