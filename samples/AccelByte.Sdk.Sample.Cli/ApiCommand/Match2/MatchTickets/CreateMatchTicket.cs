...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Match2
{
    ...
    public class CreateMatchTicketCommand: ISdkConsoleCommand
    {
        ...
        public CreateMatchTicketCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Match2.Operation.CreateMatchTicket.Builder;





            CreateMatchTicket operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.CreateMatchTicket(operation);
