...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Match2
{
    ...
    public class DeleteMatchTicketCommand: ISdkConsoleCommand
    {
        ...
        public DeleteMatchTicketCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Match2.Operation.DeleteMatchTicket.Builder;





            DeleteMatchTicket operation = opBuilder.Build(
                Namespace,
                Ticketid
            );


            var response = wrapper.DeleteMatchTicket(operation);
