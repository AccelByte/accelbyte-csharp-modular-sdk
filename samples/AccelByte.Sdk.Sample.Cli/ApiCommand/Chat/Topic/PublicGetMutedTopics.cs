...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Chat
{
    ...
    public class PublicGetMutedTopicsCommand : ISdkConsoleCommand
    {
        ...
        public PublicGetMutedTopicsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Chat.Operation.PublicGetMutedTopics.Builder;





            PublicGetMutedTopics operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.PublicGetMutedTopics(operation);
