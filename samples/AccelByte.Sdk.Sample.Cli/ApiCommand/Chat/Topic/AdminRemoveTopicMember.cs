...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Chat
{
    ...
    public class AdminRemoveTopicMemberCommand: ISdkConsoleCommand
    {
        ...
        public AdminRemoveTopicMemberCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Chat.Operation.AdminRemoveTopicMember.Builder;





            AdminRemoveTopicMember operation = opBuilder.Build(
                Namespace,
                Topic,
                UserId
            );
            ...
            var response = wrapper.AdminRemoveTopicMember(operation);
