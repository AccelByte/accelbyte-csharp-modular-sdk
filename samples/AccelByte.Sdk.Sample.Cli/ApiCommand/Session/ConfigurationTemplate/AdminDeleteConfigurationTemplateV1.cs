...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class AdminDeleteConfigurationTemplateV1Command : ISdkConsoleCommand
    {
        ...
        public AdminDeleteConfigurationTemplateV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.AdminDeleteConfigurationTemplateV1.Builder;





            AdminDeleteConfigurationTemplateV1 operation = opBuilder.Build(
                Name,
                Namespace
            );


            var response = wrapper.AdminDeleteConfigurationTemplateV1(operation);
