...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class AdminGetDSMCConfigurationCommand: ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.AdminGetDSMCConfiguration.Builder;





            AdminGetDSMCConfiguration operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.AdminGetDSMCConfiguration(operation);
