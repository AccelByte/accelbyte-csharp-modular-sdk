...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class AdminUpdateConfigurationTemplateV1Command : ISdkConsoleCommand
    {
        ...
        public AdminUpdateConfigurationTemplateV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.AdminUpdateConfigurationTemplateV1.Builder;





            AdminUpdateConfigurationTemplateV1 operation = opBuilder.Build(
                Body,
                Name,
                Namespace
            );
            ...
            var response = wrapper.AdminUpdateConfigurationTemplateV1(operation);
