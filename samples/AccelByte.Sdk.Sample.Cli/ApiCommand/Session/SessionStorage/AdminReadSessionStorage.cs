...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class AdminReadSessionStorageCommand: ISdkConsoleCommand
    {
        ...
        public AdminReadSessionStorageCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.AdminReadSessionStorage.Builder;





            AdminReadSessionStorage operation = opBuilder.Build(
                Namespace,
                SessionId
            );


            Dictionary<string, object>? response = wrapper.AdminReadSessionStorage(operation);
            if (response == null)
