...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class AdminDeleteBulkGameSessionsCommand: ISdkConsoleCommand
    {
        ...
        public AdminDeleteBulkGameSessionsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.AdminDeleteBulkGameSessions.Builder;





            AdminDeleteBulkGameSessions operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.AdminDeleteBulkGameSessions(operation);
