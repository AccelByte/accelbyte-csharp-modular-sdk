...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class UpdateGameSessionBackfillTicketIDCommand: ISdkConsoleCommand
    {
        ...
        public UpdateGameSessionBackfillTicketIDCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.UpdateGameSessionBackfillTicketID.Builder;





            UpdateGameSessionBackfillTicketID operation = opBuilder.Build(
                Body,
                Namespace,
                SessionId
            );
            ...
            var response = wrapper.UpdateGameSessionBackfillTicketID(operation);
