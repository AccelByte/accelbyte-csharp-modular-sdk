...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class PublicSessionJoinCodeCommand: ISdkConsoleCommand
    {
        ...
        public PublicSessionJoinCodeCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            AccelByte.Sdk.Api.Session.Model.ApimodelsGameSessionResponse? response = wrapper.PublicSessionJoinCode(operation);
            if (response == null)
