...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class PublicGameSessionInviteCommand: ISdkConsoleCommand
    {
        ...
        public PublicGameSessionInviteCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.PublicGameSessionInvite.Builder;





            PublicGameSessionInvite operation = opBuilder.Build(
                Body,
                Namespace,
                SessionId
            );
            ...
            var response = wrapper.PublicGameSessionInvite(operation);
