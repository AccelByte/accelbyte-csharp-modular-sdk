...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class LeaveGameSessionCommand : ISdkConsoleCommand
    {
        ...
        public LeaveGameSessionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.LeaveGameSession.Builder;





            LeaveGameSession operation = opBuilder.Build(
                Namespace,
                SessionId
            );


            var response = wrapper.LeaveGameSession(operation);
