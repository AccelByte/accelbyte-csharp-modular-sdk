...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class PublicPartyRejectCommand : ISdkConsoleCommand
    {
        ...
        public PublicPartyRejectCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.PublicPartyReject.Builder;





            PublicPartyReject operation = opBuilder.Build(
                Namespace,
                PartyId
            );


            var response = wrapper.PublicPartyReject(operation);
