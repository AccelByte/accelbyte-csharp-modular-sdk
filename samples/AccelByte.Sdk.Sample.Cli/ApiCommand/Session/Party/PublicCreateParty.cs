...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class PublicCreatePartyCommand : ISdkConsoleCommand
    {
        ...
        public PublicCreatePartyCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.PublicCreateParty.Builder;





            PublicCreateParty operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.PublicCreateParty(operation);
