...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Session
{
    ...
    public class PublicStorePlayerAttributesCommand : ISdkConsoleCommand
    {
        ...
        public PublicStorePlayerAttributesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Session.Operation.PublicStorePlayerAttributes.Builder;





            PublicStorePlayerAttributes operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.PublicStorePlayerAttributes(operation);
