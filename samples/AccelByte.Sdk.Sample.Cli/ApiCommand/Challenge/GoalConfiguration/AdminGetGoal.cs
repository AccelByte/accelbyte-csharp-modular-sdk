...
{
    [SdkConsoleCommand("challenge", "admingetgoal")]
    public class AdminGetGoalCommand : ISdkConsoleCommand
    {
        private IAccelByteSdk _SDK;

        public string ServiceName { get { return "Challenge"; } }

        public string OperationName { get { return "AdminGetGoal"; } }
        ...
        public AdminGetGoalCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Challenge.Operation.AdminGetGoal.Builder;





            AdminGetGoal operation = opBuilder.Build(
                ChallengeCode,
                Code,
                Namespace
            );
            ...
            AccelByte.Sdk.Api.Challenge.Model.ModelGoalResponse? response = wrapper.AdminGetGoal(operation);
            if (response == null)
