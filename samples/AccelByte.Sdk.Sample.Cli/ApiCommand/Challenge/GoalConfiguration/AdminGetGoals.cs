...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Challenge
{
    ...
    public class AdminGetGoalsCommand: ISdkConsoleCommand
    {
        ...
        public AdminGetGoalsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Challenge.Operation.AdminGetGoals.Builder;
            ...
            AdminGetGoals operation = opBuilder.Build(
                ChallengeCode,
                Namespace
            );
