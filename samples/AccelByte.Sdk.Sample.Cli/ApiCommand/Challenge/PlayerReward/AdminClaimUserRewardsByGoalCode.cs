...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Challenge
{
    ...
    public class AdminClaimUserRewardsByGoalCodeCommand : ISdkConsoleCommand
    {
        ...
        public AdminClaimUserRewardsByGoalCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Challenge.Operation.AdminClaimUserRewardsByGoalCode.Builder;





            AdminClaimUserRewardsByGoalCode operation = opBuilder.Build(
                Body,
                ChallengeCode,
                Namespace,
                UserId
