...
{
    [SdkConsoleCommand("challenge","publiclistschedules")]
    public class PublicListSchedulesCommand: ISdkConsoleCommand
    {
        private IAccelByteSdk _SDK;

        public string ServiceName{ get { return "Challenge"; } }

        public string OperationName{ get { return "PublicListSchedules"; } }
        ...
        public PublicListSchedulesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Challenge.Operation.PublicListSchedules.Builder;
            ...
            PublicListSchedules operation = opBuilder.Build(
                ChallengeCode,
                Namespace
            );


            var response = wrapper.PublicListSchedules(operation);
