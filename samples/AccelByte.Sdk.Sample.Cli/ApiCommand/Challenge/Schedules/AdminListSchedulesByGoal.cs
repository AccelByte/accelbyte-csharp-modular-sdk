...
{
    [SdkConsoleCommand("challenge", "adminlistschedulesbygoal")]
    public class AdminListSchedulesByGoalCommand : ISdkConsoleCommand
    {
        private IAccelByteSdk _SDK;

        public string ServiceName { get { return "Challenge"; } }

        public string OperationName { get { return "AdminListSchedulesByGoal"; } }
        ...
        public AdminListSchedulesByGoalCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Challenge.Operation.AdminListSchedulesByGoal.Builder;
            ...
            AdminListSchedulesByGoal operation = opBuilder.Build(
                ChallengeCode,
                Code,
                Namespace
            );
            ...
            var response = wrapper.AdminListSchedulesByGoal(operation);
