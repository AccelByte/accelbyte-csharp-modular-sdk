...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class UpdateGroupCustomAttributesPublicV1Command : ISdkConsoleCommand
    {
        ...
        public UpdateGroupCustomAttributesPublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.UpdateGroupCustomAttributesPublicV1.Builder;





            UpdateGroupCustomAttributesPublicV1 operation = opBuilder.Build(
                Body,
                GroupId,
                Namespace
            );
            ...
            var response = wrapper.UpdateGroupCustomAttributesPublicV1(operation);
