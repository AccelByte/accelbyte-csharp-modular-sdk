...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class UpdateGroupCustomRulePublicV1Command : ISdkConsoleCommand
    {
        ...
        public UpdateGroupCustomRulePublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.UpdateGroupCustomRulePublicV1.Builder;





            UpdateGroupCustomRulePublicV1 operation = opBuilder.Build(
                Body,
                GroupId,
                Namespace
            );
            ...
            var response = wrapper.UpdateGroupCustomRulePublicV1(operation);
