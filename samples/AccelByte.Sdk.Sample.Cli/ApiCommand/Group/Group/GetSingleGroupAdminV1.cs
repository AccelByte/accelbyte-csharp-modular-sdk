...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class GetSingleGroupAdminV1Command: ISdkConsoleCommand
    {
        ...
        public GetSingleGroupAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.GetSingleGroupAdminV1.Builder;





            GetSingleGroupAdminV1 operation = opBuilder.Build(
                GroupId,
                Namespace
            );


            var response = wrapper.GetSingleGroupAdminV1(operation);
