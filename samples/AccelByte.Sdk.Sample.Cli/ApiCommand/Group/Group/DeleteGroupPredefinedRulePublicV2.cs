...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class DeleteGroupPredefinedRulePublicV2Command : ISdkConsoleCommand
    {
        ...
        public DeleteGroupPredefinedRulePublicV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.DeleteGroupPredefinedRulePublicV2.Builder;





            DeleteGroupPredefinedRulePublicV2 operation = opBuilder.Build(
                AllowedAction,
                GroupId,
                Namespace
            );
            ...
            var response = wrapper.DeleteGroupPredefinedRulePublicV2(operation);
