...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class UpdateGroupPredefinedRulePublicV1Command : ISdkConsoleCommand
    {
        ...
        public UpdateGroupPredefinedRulePublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.UpdateGroupPredefinedRulePublicV1.Builder;





            UpdateGroupPredefinedRulePublicV1 operation = opBuilder.Build(
                Body,
                AllowedAction,
                GroupId,
                Namespace
            ...
            var response = wrapper.UpdateGroupPredefinedRulePublicV1(operation);
