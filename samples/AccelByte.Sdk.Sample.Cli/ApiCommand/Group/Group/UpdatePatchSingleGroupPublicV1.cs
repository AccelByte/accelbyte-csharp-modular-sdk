...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class UpdatePatchSingleGroupPublicV1Command: ISdkConsoleCommand
    {
        ...
        public UpdatePatchSingleGroupPublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.UpdatePatchSingleGroupPublicV1.Builder;





            UpdatePatchSingleGroupPublicV1 operation = opBuilder.Build(
                Body,
                GroupId,
                Namespace
            );
            ...
            var response = wrapper.UpdatePatchSingleGroupPublicV1(operation);
