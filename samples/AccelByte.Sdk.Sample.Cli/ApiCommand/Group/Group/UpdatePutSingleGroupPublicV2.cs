...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class UpdatePutSingleGroupPublicV2Command: ISdkConsoleCommand
    {
        ...
        public UpdatePutSingleGroupPublicV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.UpdatePutSingleGroupPublicV2.Builder;





            UpdatePutSingleGroupPublicV2 operation = opBuilder.Build(
                Body,
                GroupId,
                Namespace
            );
            ...
            var response = wrapper.UpdatePutSingleGroupPublicV2(operation);
