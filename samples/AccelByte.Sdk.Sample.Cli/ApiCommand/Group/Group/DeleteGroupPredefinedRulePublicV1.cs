...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class DeleteGroupPredefinedRulePublicV1Command : ISdkConsoleCommand
    {
        ...
        public DeleteGroupPredefinedRulePublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.DeleteGroupPredefinedRulePublicV1.Builder;





            DeleteGroupPredefinedRulePublicV1 operation = opBuilder.Build(
                AllowedAction,
                GroupId,
                Namespace
            );
            ...
            var response = wrapper.DeleteGroupPredefinedRulePublicV1(operation);
