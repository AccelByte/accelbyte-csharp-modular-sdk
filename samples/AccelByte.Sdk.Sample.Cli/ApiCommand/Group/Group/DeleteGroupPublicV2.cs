...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class DeleteGroupPublicV2Command : ISdkConsoleCommand
    {
        ...
        public DeleteGroupPublicV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.DeleteGroupPublicV2.Builder;





            DeleteGroupPublicV2 operation = opBuilder.Build(
                GroupId,
                Namespace
            );


            var response = wrapper.DeleteGroupPublicV2(operation);
