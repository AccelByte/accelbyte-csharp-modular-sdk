...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class DeleteGroupAdminV1Command: ISdkConsoleCommand
    {
        ...
        public DeleteGroupAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.DeleteGroupAdminV1.Builder;





            DeleteGroupAdminV1 operation = opBuilder.Build(
                GroupId,
                Namespace
            );


            var response = wrapper.DeleteGroupAdminV1(operation);
