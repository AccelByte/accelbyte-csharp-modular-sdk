...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class UpdateSingleGroupV1Command : ISdkConsoleCommand
    {
        ...
        public UpdateSingleGroupV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.UpdateSingleGroupV1.Builder;





            UpdateSingleGroupV1 operation = opBuilder.Build(
                Body,
                GroupId,
                Namespace
            );
            ...
            var response = wrapper.UpdateSingleGroupV1(operation);
