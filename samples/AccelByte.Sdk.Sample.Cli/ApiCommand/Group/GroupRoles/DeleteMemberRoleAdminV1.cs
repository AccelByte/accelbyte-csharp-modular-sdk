...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class DeleteMemberRoleAdminV1Command: ISdkConsoleCommand
    {
        ...
        public DeleteMemberRoleAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.DeleteMemberRoleAdminV1.Builder;





            DeleteMemberRoleAdminV1 operation = opBuilder.Build(
                MemberRoleId,
                Namespace
            );


            var response = wrapper.DeleteMemberRoleAdminV1(operation);
