...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class GetMemberRolesListAdminV1Command: ISdkConsoleCommand
    {
        ...
        public GetMemberRolesListAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.GetMemberRolesListAdminV1.Builder;
            ...
            GetMemberRolesListAdminV1 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetMemberRolesListAdminV1(operation);
