...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class CreateGroupConfigurationAdminV1Command: ISdkConsoleCommand
    {
        ...
        public CreateGroupConfigurationAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.CreateGroupConfigurationAdminV1.Builder;





            CreateGroupConfigurationAdminV1 operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.CreateGroupConfigurationAdminV1(operation);
