...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class UpdateGroupConfigurationAdminV1Command : ISdkConsoleCommand
    {
        ...
        public UpdateGroupConfigurationAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.UpdateGroupConfigurationAdminV1.Builder;





            UpdateGroupConfigurationAdminV1 operation = opBuilder.Build(
                Body,
                ConfigurationCode,
                Namespace
            );
            ...
            var response = wrapper.UpdateGroupConfigurationAdminV1(operation);
