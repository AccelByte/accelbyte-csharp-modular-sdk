...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class RejectGroupInvitationPublicV1Command: ISdkConsoleCommand
    {
        ...
        public RejectGroupInvitationPublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.RejectGroupInvitationPublicV1.Builder;





            RejectGroupInvitationPublicV1 operation = opBuilder.Build(
                GroupId,
                Namespace
            );


            var response = wrapper.RejectGroupInvitationPublicV1(operation);
