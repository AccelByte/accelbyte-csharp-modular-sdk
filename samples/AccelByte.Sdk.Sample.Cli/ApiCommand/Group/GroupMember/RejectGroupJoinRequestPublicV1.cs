...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class RejectGroupJoinRequestPublicV1Command: ISdkConsoleCommand
    {
        ...
        public RejectGroupJoinRequestPublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.RejectGroupJoinRequestPublicV1.Builder;





            RejectGroupJoinRequestPublicV1 operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.RejectGroupJoinRequestPublicV1(operation);
