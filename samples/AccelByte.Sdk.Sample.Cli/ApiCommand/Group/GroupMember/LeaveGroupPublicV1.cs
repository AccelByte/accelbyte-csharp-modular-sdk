...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class LeaveGroupPublicV1Command : ISdkConsoleCommand
    {
        ...
        public LeaveGroupPublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.LeaveGroupPublicV1.Builder;





            LeaveGroupPublicV1 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.LeaveGroupPublicV1(operation);
