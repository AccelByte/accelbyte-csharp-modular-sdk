...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class CancelGroupJoinRequestV1Command: ISdkConsoleCommand
    {
        ...
        public CancelGroupJoinRequestV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.CancelGroupJoinRequestV1.Builder;





            CancelGroupJoinRequestV1 operation = opBuilder.Build(
                GroupId,
                Namespace
            );


            var response = wrapper.CancelGroupJoinRequestV1(operation);
