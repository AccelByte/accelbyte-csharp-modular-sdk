...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class LeaveGroupPublicV2Command : ISdkConsoleCommand
    {
        ...
        public LeaveGroupPublicV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.LeaveGroupPublicV2.Builder;





            LeaveGroupPublicV2 operation = opBuilder.Build(
                GroupId,
                Namespace
            );


            AccelByte.Sdk.Api.Group.Model.ModelsLeaveGroupResponseV1? response = wrapper.LeaveGroupPublicV2(operation);
            if (response == null)
