...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class KickGroupMemberPublicV1Command : ISdkConsoleCommand
    {
        ...
        public KickGroupMemberPublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.KickGroupMemberPublicV1.Builder;





            KickGroupMemberPublicV1 operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.KickGroupMemberPublicV1(operation);
