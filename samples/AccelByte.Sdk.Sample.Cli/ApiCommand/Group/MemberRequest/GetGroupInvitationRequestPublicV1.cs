...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Group
{
    ...
    public class GetGroupInvitationRequestPublicV1Command: ISdkConsoleCommand
    {
        ...
        public GetGroupInvitationRequestPublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Group.Operation.GetGroupInvitationRequestPublicV1.Builder;
            ...
            GetGroupInvitationRequestPublicV1 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetGroupInvitationRequestPublicV1(operation);
