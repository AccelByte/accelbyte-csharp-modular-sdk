...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class GetImageDetailCommand : ISdkConsoleCommand
    {
        ...
        public GetImageDetailCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.GetImageDetail.Builder;





            GetImageDetail operation = opBuilder.Build(
                Namespace,
                Version
            );


            var response = wrapper.GetImageDetail(operation);
