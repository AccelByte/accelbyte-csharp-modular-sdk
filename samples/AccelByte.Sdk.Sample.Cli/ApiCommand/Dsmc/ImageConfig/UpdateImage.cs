...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class UpdateImageCommand: ISdkConsoleCommand
    {
        ...
        public UpdateImageCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.UpdateImage.Builder;





            UpdateImage operation = opBuilder.Build(
                Body
            );


            var response = wrapper.UpdateImage(operation);
