...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class GetImageLimitCommand : ISdkConsoleCommand
    {
        ...
        public GetImageLimitCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.GetImageLimit.Builder;





            GetImageLimit operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetImageLimit(operation);
