...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class DeleteImageCommand : ISdkConsoleCommand
    {
        ...
        public DeleteImageCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.DeleteImage.Builder;





            DeleteImage operation = opBuilder.Build(
                Namespace,
                ImageURI,
                Version
            );
            ...
            var response = wrapper.DeleteImage(operation);
