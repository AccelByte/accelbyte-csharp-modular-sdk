...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class DeleteImagePatchCommand: ISdkConsoleCommand
    {
        ...
        public DeleteImagePatchCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.DeleteImagePatch.Builder;





            DeleteImagePatch operation = opBuilder.Build(
                Namespace,
                ImageURI,
                Version,
                VersionPatch
            ...
            var response = wrapper.DeleteImagePatch(operation);
