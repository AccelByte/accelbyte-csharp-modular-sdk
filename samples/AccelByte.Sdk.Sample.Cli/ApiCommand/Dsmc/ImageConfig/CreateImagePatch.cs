...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class CreateImagePatchCommand: ISdkConsoleCommand
    {
        ...
        public CreateImagePatchCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.CreateImagePatch.Builder;





            CreateImagePatch operation = opBuilder.Build(
                Body
            );


            var response = wrapper.CreateImagePatch(operation);
