...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class ListProvidersByRegionCommand: ISdkConsoleCommand
    {
        ...
        public ListProvidersByRegionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.ListProvidersByRegion.Builder;





            ListProvidersByRegion operation = opBuilder.Build(
                Region
            );


            var response = wrapper.ListProvidersByRegion(operation);
