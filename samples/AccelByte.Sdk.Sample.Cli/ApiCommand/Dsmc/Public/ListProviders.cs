...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class ListProvidersCommand: ISdkConsoleCommand
    {
        ...
        public ListProvidersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.ListProviders.Builder;





            ListProviders operation = opBuilder.Build(
            );


            var response = wrapper.ListProviders(operation);
