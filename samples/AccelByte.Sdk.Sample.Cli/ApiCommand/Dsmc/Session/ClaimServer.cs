...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class ClaimServerCommand : ISdkConsoleCommand
    {
        ...
        public ClaimServerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.ClaimServer.Builder;





            ClaimServer operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.ClaimServer(operation);
