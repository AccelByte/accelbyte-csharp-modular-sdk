...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class CountServerDetailedCommand: ISdkConsoleCommand
    {
        ...
        public CountServerDetailedCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.CountServerDetailed.Builder;
            ...
            CountServerDetailed operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.CountServerDetailed(operation);
