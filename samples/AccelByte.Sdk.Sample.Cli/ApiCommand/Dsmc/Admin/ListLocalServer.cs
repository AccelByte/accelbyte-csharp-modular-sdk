...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class ListLocalServerCommand: ISdkConsoleCommand
    {
        ...
        public ListLocalServerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.ListLocalServer.Builder;





            ListLocalServer operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.ListLocalServer(operation);
