...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class UpdatePodConfigCommand: ISdkConsoleCommand
    {
        ...
        public UpdatePodConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.UpdatePodConfig.Builder;





            UpdatePodConfig operation = opBuilder.Build(
                Body,
                Name,
                Namespace
            );
            ...
            var response = wrapper.UpdatePodConfig(operation);
