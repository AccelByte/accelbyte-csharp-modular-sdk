...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class DeletePodConfigCommand: ISdkConsoleCommand
    {
        ...
        public DeletePodConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.DeletePodConfig.Builder;





            DeletePodConfig operation = opBuilder.Build(
                Name,
                Namespace
            );


            var response = wrapper.DeletePodConfig(operation);
