...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class RegisterServerCommand : ISdkConsoleCommand
    {
        ...
        public RegisterServerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.RegisterServer.Builder;





            RegisterServer operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.RegisterServer(operation);
