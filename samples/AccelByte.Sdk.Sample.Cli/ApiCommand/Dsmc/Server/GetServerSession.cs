...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class GetServerSessionCommand : ISdkConsoleCommand
    {
        ...
        public GetServerSessionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.GetServerSession.Builder;





            GetServerSession operation = opBuilder.Build(
                Namespace,
                PodName
            );


            var response = wrapper.GetServerSession(operation);
