...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class DeregisterLocalServerCommand : ISdkConsoleCommand
    {
        ...
        public DeregisterLocalServerCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.DeregisterLocalServer.Builder;





            DeregisterLocalServer operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.DeregisterLocalServer(operation);
