...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class ListConfigCommand: ISdkConsoleCommand
    {
        ...
        public ListConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.ListConfig.Builder;





            ListConfig operation = opBuilder.Build(
            );


            var response = wrapper.ListConfig(operation);
