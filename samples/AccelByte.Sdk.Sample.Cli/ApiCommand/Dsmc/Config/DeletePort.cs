...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class DeletePortCommand : ISdkConsoleCommand
    {
        ...
        public DeletePortCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.DeletePort.Builder;





            DeletePort operation = opBuilder.Build(
                Name,
                Namespace
            );


            var response = wrapper.DeletePort(operation);
