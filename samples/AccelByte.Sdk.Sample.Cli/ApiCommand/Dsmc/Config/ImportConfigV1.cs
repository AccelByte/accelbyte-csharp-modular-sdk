...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class ImportConfigV1Command: ISdkConsoleCommand
    {
        ...
        public ImportConfigV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.ImportConfigV1.Builder;
            ...
            ImportConfigV1 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.ImportConfigV1(operation);
