...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class DeleteDeploymentCommand: ISdkConsoleCommand
    {
        ...
        public DeleteDeploymentCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.DeleteDeployment.Builder;





            DeleteDeployment operation = opBuilder.Build(
                Deployment,
                Namespace
            );


            var response = wrapper.DeleteDeployment(operation);
