...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class DeleteDeploymentOverrideCommand: ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.DeleteDeploymentOverride.Builder;





            DeleteDeploymentOverride operation = opBuilder.Build(
                Deployment,
                Namespace,
                Version
            );
            ...
            var response = wrapper.DeleteDeploymentOverride(operation);
