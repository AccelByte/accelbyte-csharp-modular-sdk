...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class CreateOverrideRegionOverrideCommand: ISdkConsoleCommand
    {
        ...
        public CreateOverrideRegionOverrideCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.CreateOverrideRegionOverride.Builder;





            CreateOverrideRegionOverride operation = opBuilder.Build(
                Body,
                Deployment,
                Namespace,
                Region,
            ...
            var response = wrapper.CreateOverrideRegionOverride(operation);
