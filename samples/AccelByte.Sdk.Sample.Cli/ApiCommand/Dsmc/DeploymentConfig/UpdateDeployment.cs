...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class UpdateDeploymentCommand: ISdkConsoleCommand
    {
        ...
        public UpdateDeploymentCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.UpdateDeployment.Builder;





            UpdateDeployment operation = opBuilder.Build(
                Body,
                Deployment,
                Namespace
            );
            ...
            var response = wrapper.UpdateDeployment(operation);
