...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class GetDeploymentCommand : ISdkConsoleCommand
    {
        ...
        public GetDeploymentCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.GetDeployment.Builder;





            GetDeployment operation = opBuilder.Build(
                Deployment,
                Namespace
            );


            var response = wrapper.GetDeployment(operation);
