...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class UpdateDeploymentOverrideCommand: ISdkConsoleCommand
    {
        ...
        public UpdateDeploymentOverrideCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.UpdateDeploymentOverride.Builder;





            UpdateDeploymentOverride operation = opBuilder.Build(
                Body,
                Deployment,
                Namespace,
                Version
            ...
            var response = wrapper.UpdateDeploymentOverride(operation);
