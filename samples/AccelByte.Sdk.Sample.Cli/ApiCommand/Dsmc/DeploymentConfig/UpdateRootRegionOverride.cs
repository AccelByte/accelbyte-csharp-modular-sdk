...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Dsmc
{
    ...
    public class UpdateRootRegionOverrideCommand: ISdkConsoleCommand
    {
        ...
        public UpdateRootRegionOverrideCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Dsmc.Operation.UpdateRootRegionOverride.Builder;





            UpdateRootRegionOverride operation = opBuilder.Build(
                Body,
                Deployment,
                Namespace,
                Region
            ...
            var response = wrapper.UpdateRootRegionOverride(operation);
