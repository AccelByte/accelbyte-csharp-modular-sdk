...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Gdpr
{
    ...
    public class S2SGetListFinishedPersonalDataRequestCommand : ISdkConsoleCommand
    {
        ...
        public S2SGetListFinishedPersonalDataRequestCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Gdpr.Operation.S2SGetListFinishedPersonalDataRequest.Builder;





            S2SGetListFinishedPersonalDataRequest operation = opBuilder.Build(
                Namespace,
                End,
                Start
            );
            ...
            AccelByte.Sdk.Api.Gdpr.Model.DtoListFinishedDataRequests? response = wrapper.S2SGetListFinishedPersonalDataRequest(operation);
            if (response == null)
