...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Gdpr
{
    ...
    public class PublicGetUserAccountDeletionStatusCommand : ISdkConsoleCommand
    {
        ...
        public PublicGetUserAccountDeletionStatusCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Gdpr.Operation.PublicGetUserAccountDeletionStatus.Builder;





            PublicGetUserAccountDeletionStatus operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.PublicGetUserAccountDeletionStatus(operation);
