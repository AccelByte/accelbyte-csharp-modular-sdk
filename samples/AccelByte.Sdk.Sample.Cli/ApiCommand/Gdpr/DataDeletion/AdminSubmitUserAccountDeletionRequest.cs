...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Gdpr
{
    ...
    public class AdminSubmitUserAccountDeletionRequestCommand : ISdkConsoleCommand
    {
        ...
        public AdminSubmitUserAccountDeletionRequestCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Gdpr.Operation.AdminSubmitUserAccountDeletionRequest.Builder;





            AdminSubmitUserAccountDeletionRequest operation = opBuilder.Build(
                Namespace,
                UserId
            );
