...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Gdpr
{
    ...
    public class PublicSubmitUserAccountDeletionRequestCommand: ISdkConsoleCommand
    {
        ...
        public PublicSubmitUserAccountDeletionRequestCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Gdpr.Operation.PublicSubmitUserAccountDeletionRequest.Builder;
            ...
            var response = wrapper.PublicSubmitUserAccountDeletionRequest(operation);
