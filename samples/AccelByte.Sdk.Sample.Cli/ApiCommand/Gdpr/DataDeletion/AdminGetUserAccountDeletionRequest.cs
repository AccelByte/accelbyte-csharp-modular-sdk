...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Gdpr
{
    ...
    public class AdminGetUserAccountDeletionRequestCommand : ISdkConsoleCommand
    {
        ...
        public AdminGetUserAccountDeletionRequestCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Gdpr.Operation.AdminGetUserAccountDeletionRequest.Builder;





            AdminGetUserAccountDeletionRequest operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.AdminGetUserAccountDeletionRequest(operation);
