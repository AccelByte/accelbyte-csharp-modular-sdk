...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Gdpr
{
    ...
    public class AdminGetUserPersonalDataRequestsCommand: ISdkConsoleCommand
    {
        ...
        public AdminGetUserPersonalDataRequestsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Gdpr.Operation.AdminGetUserPersonalDataRequests.Builder;
            ...
            AdminGetUserPersonalDataRequests operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.AdminGetUserPersonalDataRequests(operation);
