...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Gdpr
{
    ...
    public class PublicGeneratePersonalDataURLCommand : ISdkConsoleCommand
    {
        ...
        public PublicGeneratePersonalDataURLCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Gdpr.Operation.PublicGeneratePersonalDataURL.Builder;





            PublicGeneratePersonalDataURL operation = opBuilder.Build(
                Password,
                Namespace,
                RequestDate,
                UserId
            ...
            var response = wrapper.PublicGeneratePersonalDataURL(operation);
