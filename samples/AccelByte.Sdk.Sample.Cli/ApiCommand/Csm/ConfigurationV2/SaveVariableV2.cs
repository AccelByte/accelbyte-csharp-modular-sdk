...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Csm
{
    ...
    public class SaveVariableV2Command: ISdkConsoleCommand
    {
        ...
        public SaveVariableV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Csm.Operation.SaveVariableV2.Builder;





            SaveVariableV2 operation = opBuilder.Build(
                Body,
                App,
                Namespace
            );
            ...
            var response = wrapper.SaveVariableV2(operation);
