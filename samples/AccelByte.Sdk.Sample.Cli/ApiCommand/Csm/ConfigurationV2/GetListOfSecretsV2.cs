...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Csm
{
    ...
    public class GetListOfSecretsV2Command: ISdkConsoleCommand
    {
        ...
        public GetListOfSecretsV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Csm.Operation.GetListOfSecretsV2.Builder;
            ...
            GetListOfSecretsV2 operation = opBuilder.Build(
                App,
                Namespace
            );


            var response = wrapper.GetListOfSecretsV2(operation);
