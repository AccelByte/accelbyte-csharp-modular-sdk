...
{
    [SdkConsoleCommand("csm", "updatesecretv1")]
    public class UpdateSecretV1Command : ISdkConsoleCommand
    {
        private IAccelByteSdk _SDK;

        public string ServiceName { get { return "Csm"; } }

        public string OperationName { get { return "UpdateSecretV1"; } }
        ...
        public UpdateSecretV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Csm.Operation.UpdateSecretV1.Builder;





            UpdateSecretV1 operation = opBuilder.Build(
                Body,
                App,
                ConfigId,
                Namespace
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.UpdateSecretV1(operation);
