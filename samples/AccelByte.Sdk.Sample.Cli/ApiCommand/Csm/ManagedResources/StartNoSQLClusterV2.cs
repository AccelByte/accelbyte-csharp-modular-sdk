...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Csm
{
    ...
    public class StartNoSQLClusterV2Command: ISdkConsoleCommand
    {
        ...
        public StartNoSQLClusterV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Csm.Operation.StartNoSQLClusterV2.Builder;





            StartNoSQLClusterV2 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.StartNoSQLClusterV2(operation);
