...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Csm
{
    ...
    public class DeleteAppImagesV2Command: ISdkConsoleCommand
    {
        ...
        public DeleteAppImagesV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Csm.Operation.DeleteAppImagesV2.Builder;





            DeleteAppImagesV2 operation = opBuilder.Build(
                Body,
                App,
                Namespace
            );
            ...
            var response = wrapper.DeleteAppImagesV2(operation);
