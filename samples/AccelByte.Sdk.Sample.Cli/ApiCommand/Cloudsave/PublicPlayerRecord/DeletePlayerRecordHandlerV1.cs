...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Cloudsave
{
    ...
    public class DeletePlayerRecordHandlerV1Command: ISdkConsoleCommand
    {
        ...
        public DeletePlayerRecordHandlerV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Cloudsave.Operation.DeletePlayerRecordHandlerV1.Builder;





            DeletePlayerRecordHandlerV1 operation = opBuilder.Build(
                Key,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.DeletePlayerRecordHandlerV1(operation);
