...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Cloudsave
{
    ...
    public class GetPlayerRecordHandlerV1Command: ISdkConsoleCommand
    {
        ...
        public GetPlayerRecordHandlerV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Cloudsave.Operation.GetPlayerRecordHandlerV1.Builder;





            GetPlayerRecordHandlerV1 operation = opBuilder.Build(
                Key,
                Namespace,
                UserId
            );
            ...
            AccelByte.Sdk.Api.Cloudsave.Model.ModelsPlayerRecordResponse? response = wrapper.GetPlayerRecordHandlerV1(operation);
            if (response == null)
