...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Cloudsave
{
    ...
    public class PostGameRecordHandlerV1Command: ISdkConsoleCommand
    {
        ...
        public PostGameRecordHandlerV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Cloudsave.Operation.PostGameRecordHandlerV1.Builder;





            PostGameRecordHandlerV1 operation = opBuilder.Build(
                Body,
                Key,
                Namespace
            );
            ...
            var response = wrapper.PostGameRecordHandlerV1(operation);
