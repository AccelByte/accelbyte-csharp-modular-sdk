...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Cloudsave
{
    ...
    public class AdminGetGameRecordHandlerV1Command : ISdkConsoleCommand
    {
        ...
        public AdminGetGameRecordHandlerV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Cloudsave.Operation.AdminGetGameRecordHandlerV1.Builder;





            AdminGetGameRecordHandlerV1 operation = opBuilder.Build(
                Key,
                Namespace
            );


            var response = wrapper.AdminGetGameRecordHandlerV1(operation);
