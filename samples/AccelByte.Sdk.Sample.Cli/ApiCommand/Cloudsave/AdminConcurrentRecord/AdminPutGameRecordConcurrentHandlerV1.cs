...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Cloudsave
{
    ...
    public class AdminPutGameRecordConcurrentHandlerV1Command: ISdkConsoleCommand
    {
        ...
        public AdminPutGameRecordConcurrentHandlerV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Cloudsave.Operation.AdminPutGameRecordConcurrentHandlerV1.Builder;





            AdminPutGameRecordConcurrentHandlerV1 operation = opBuilder.Build(
                Body,
                Key,
                Namespace
            );
            ...
            var response = wrapper.AdminPutGameRecordConcurrentHandlerV1(operation);
