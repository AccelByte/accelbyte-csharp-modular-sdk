...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Cloudsave
{
    ...
    public class AdminPutPlayerPublicRecordConcurrentHandlerV1Command : ISdkConsoleCommand
    {
        ...
        public AdminPutPlayerPublicRecordConcurrentHandlerV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Cloudsave.Operation.AdminPutPlayerPublicRecordConcurrentHandlerV1.Builder;
            ...
            AdminPutPlayerPublicRecordConcurrentHandlerV1 operation = opBuilder.Build(
                Body,
                Key,
                Namespace,
                UserId
            ...
            AccelByte.Sdk.Api.Cloudsave.Model.ModelsPlayerRecordConcurrentUpdateResponse? response = wrapper.AdminPutPlayerPublicRecordConcurrentHandlerV1(operation);
            if (response == null)
