...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Cloudsave
{
    ...
    public class AdminGetPlayerPublicRecordHandlerV1Command : ISdkConsoleCommand
    {
        ...
        public AdminGetPlayerPublicRecordHandlerV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Cloudsave.Operation.AdminGetPlayerPublicRecordHandlerV1.Builder;





            AdminGetPlayerPublicRecordHandlerV1 operation = opBuilder.Build(
                Key,
                Namespace,
                UserId
            );
            ...
            AccelByte.Sdk.Api.Cloudsave.Model.ModelsPlayerRecordResponse? response = wrapper.AdminGetPlayerPublicRecordHandlerV1(operation);
            if (response == null)
