...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Cloudsave
{
    ...
    public class PostPlayerBinaryPresignedURLV1Command: ISdkConsoleCommand
    {
        ...
        public string OperationName{ get { return "PostPlayerBinaryPresignedURLV1"; } }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Cloudsave.Operation.PostPlayerBinaryPresignedURLV1.Builder;





            PostPlayerBinaryPresignedURLV1 operation = opBuilder.Build(
                Body,
                Key,
                Namespace,
                UserId
            ...
            var response = wrapper.PostPlayerBinaryPresignedURLV1(operation);
