...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Cloudsave
{
    ...
    public class AdminPostGameBinaryPresignedURLV1Command: ISdkConsoleCommand
    {
        ...
        public AdminPostGameBinaryPresignedURLV1Command(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            AccelByte.Sdk.Api.Cloudsave.Model.ModelsUploadBinaryRecordResponse? response = wrapper.AdminPostGameBinaryPresignedURLV1(operation);
            if (response == null)
