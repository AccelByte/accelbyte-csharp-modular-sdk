...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Achievement
{
    ...
    public class AdminCreateNewAchievementCommand: ISdkConsoleCommand
    {
        ...
        public AdminCreateNewAchievementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Achievement.Operation.AdminCreateNewAchievement.Builder;





            AdminCreateNewAchievement operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.AdminCreateNewAchievement(operation);
