...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Achievement
{
    ...
    public class AdminGetAchievementCommand : ISdkConsoleCommand
    {
        ...
        public AdminGetAchievementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Achievement.Operation.AdminGetAchievement.Builder;





            AdminGetAchievement operation = opBuilder.Build(
                AchievementCode,
                Namespace
            );


            var response = wrapper.AdminGetAchievement(operation);
