...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Achievement
{
    ...
    public class AdminUpdateAchievementCommand : ISdkConsoleCommand
    {
        ...
        public AdminUpdateAchievementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Achievement.Operation.AdminUpdateAchievement.Builder;





            AdminUpdateAchievement operation = opBuilder.Build(
                Body,
                AchievementCode,
                Namespace
            );
            ...
            var response = wrapper.AdminUpdateAchievement(operation);
