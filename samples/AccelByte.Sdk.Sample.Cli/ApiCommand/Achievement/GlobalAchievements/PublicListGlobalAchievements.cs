...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Achievement
{
    ...
    public class PublicListGlobalAchievementsCommand : ISdkConsoleCommand
    {
        ...
        public PublicListGlobalAchievementsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Achievement.Operation.PublicListGlobalAchievements.Builder;
            ...
            PublicListGlobalAchievements operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.PublicListGlobalAchievements(operation);
