...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class PublicGetPlayerBlockedPlayersV1Command : ISdkConsoleCommand
    {
        ...
        public PublicGetPlayerBlockedPlayersV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.PublicGetPlayerBlockedPlayersV1.Builder;





            PublicGetPlayerBlockedPlayersV1 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.PublicGetPlayerBlockedPlayersV1(operation);
