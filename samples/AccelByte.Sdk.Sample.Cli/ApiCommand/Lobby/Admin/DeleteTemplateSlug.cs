...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class DeleteTemplateSlugCommand: ISdkConsoleCommand
    {
        ...
        public DeleteTemplateSlugCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.DeleteTemplateSlug.Builder;





            DeleteTemplateSlug operation = opBuilder.Build(
                Namespace,
                TemplateSlug
            );


            var response = wrapper.DeleteTemplateSlug(operation);
