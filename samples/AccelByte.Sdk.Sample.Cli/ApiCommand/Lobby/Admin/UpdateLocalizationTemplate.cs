...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class UpdateLocalizationTemplateCommand : ISdkConsoleCommand
    {
        ...
        public UpdateLocalizationTemplateCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.UpdateLocalizationTemplate.Builder;





            UpdateLocalizationTemplate operation = opBuilder.Build(
                Body,
                Namespace,
                TemplateLanguage,
                TemplateSlug
            ...
            var response = wrapper.UpdateLocalizationTemplate(operation);
