...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class FreeFormNotificationCommand : ISdkConsoleCommand
    {
        ...
        public FreeFormNotificationCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.FreeFormNotification.Builder;





            FreeFormNotification operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.FreeFormNotification(operation);
