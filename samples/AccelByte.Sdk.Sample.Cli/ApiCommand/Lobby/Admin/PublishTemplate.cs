...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class PublishTemplateCommand : ISdkConsoleCommand
    {
        ...
        public PublishTemplateCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.PublishTemplate.Builder;





            PublishTemplate operation = opBuilder.Build(
                Namespace,
                TemplateLanguage,
                TemplateSlug
            );
            ...
            var response = wrapper.PublishTemplate(operation);
