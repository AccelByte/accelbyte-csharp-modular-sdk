...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class UserCancelFriendRequestCommand: ISdkConsoleCommand
    {
        ...
        public UserCancelFriendRequestCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.UserCancelFriendRequest.Builder;





            UserCancelFriendRequest operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.UserCancelFriendRequest(operation);
