...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class GetListOfFriendsCommand: ISdkConsoleCommand
    {
        ...
        public GetListOfFriendsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.GetListOfFriends.Builder;

            if (FriendId != null)
                opBuilder.SetFriendId((string)FriendId);
            if (FriendIds != null)
                opBuilder.SetFriendIds((List<string>)FriendIds);
            if (Limit != null)
            ...
            GetListOfFriends operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.GetListOfFriends(operation);
