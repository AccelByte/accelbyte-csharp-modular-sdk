...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class FreeFormNotificationByUserIDCommand: ISdkConsoleCommand
    {
        ...
        public FreeFormNotificationByUserIDCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.FreeFormNotificationByUserID.Builder;





            FreeFormNotificationByUserID operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.FreeFormNotificationByUserID(operation);
