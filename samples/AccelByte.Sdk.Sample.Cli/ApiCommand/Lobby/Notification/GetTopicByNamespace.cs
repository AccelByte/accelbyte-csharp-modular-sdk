...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class GetTopicByNamespaceCommand: ISdkConsoleCommand
    {
        ...
        public GetTopicByNamespaceCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.GetTopicByNamespace.Builder;
            ...
            GetTopicByNamespace operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetTopicByNamespace(operation);
