...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class NotificationWithTemplateByUserIDCommand : ISdkConsoleCommand
    {
        ...
        public NotificationWithTemplateByUserIDCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.NotificationWithTemplateByUserID.Builder;





            NotificationWithTemplateByUserID operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.NotificationWithTemplateByUserID(operation);
