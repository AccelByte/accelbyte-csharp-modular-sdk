...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Lobby
{
    ...
    public class UpdateNotificationTopicV1AdminCommand: ISdkConsoleCommand
    {
        ...
        public UpdateNotificationTopicV1AdminCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Lobby.Operation.UpdateNotificationTopicV1Admin.Builder;





            UpdateNotificationTopicV1Admin operation = opBuilder.Build(
                Body,
                Namespace,
                TopicName
            );
