...
{
    [SdkConsoleCommand("ams","fleetget")]
    public class FleetGetCommand: ISdkConsoleCommand
    {
        private IAccelByteSdk _SDK;

        public string ServiceName{ get { return "Ams"; } }

        public string OperationName{ get { return "FleetGet"; } }
        ...
        public FleetGetCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            FleetGet operation = opBuilder.Build(
                FleetID,
                Namespace
            );


            AccelByte.Sdk.Api.Ams.Model.ApiFleetGetResponse? response = wrapper.FleetGet(operation);
            if (response == null)
