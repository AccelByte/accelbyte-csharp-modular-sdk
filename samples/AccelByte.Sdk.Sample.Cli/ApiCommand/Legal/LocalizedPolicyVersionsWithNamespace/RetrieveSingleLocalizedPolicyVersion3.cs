...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class RetrieveSingleLocalizedPolicyVersion3Command: ISdkConsoleCommand
    {
        ...
        public RetrieveSingleLocalizedPolicyVersion3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.RetrieveSingleLocalizedPolicyVersion3.Builder;





            RetrieveSingleLocalizedPolicyVersion3 operation = opBuilder.Build(
                LocalizedPolicyVersionId,
                Namespace
            );


            var response = wrapper.RetrieveSingleLocalizedPolicyVersion3(operation);
