...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class IndirectBulkAcceptVersionedPolicyCommand: ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.IndirectBulkAcceptVersionedPolicy.Builder;

            if (PublisherUserId != null)
                opBuilder.SetPublisherUserId((string)PublisherUserId);
            ...
            IndirectBulkAcceptVersionedPolicy operation = opBuilder.Build(
                Namespace,
                UserId,
                ClientId,
                CountryCode
            ...
            var response = wrapper.IndirectBulkAcceptVersionedPolicy(operation);
