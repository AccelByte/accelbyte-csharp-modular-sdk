...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class RetrieveSinglePolicyCommand: ISdkConsoleCommand
    {
        ...
        public RetrieveSinglePolicyCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.RetrieveSinglePolicy.Builder;





            RetrieveSinglePolicy operation = opBuilder.Build(
                BasePolicyId
            );


            var response = wrapper.RetrieveSinglePolicy(operation);
