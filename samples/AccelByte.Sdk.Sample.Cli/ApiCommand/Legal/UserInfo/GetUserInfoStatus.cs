...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class GetUserInfoStatusCommand : ISdkConsoleCommand
    {
        ...
        public GetUserInfoStatusCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.GetUserInfoStatus.Builder;

            if (Namespaces != null)
                opBuilder.SetNamespaces((string)Namespaces);




            GetUserInfoStatus operation = opBuilder.Build(
            );


            var response = wrapper.GetUserInfoStatus(operation);
