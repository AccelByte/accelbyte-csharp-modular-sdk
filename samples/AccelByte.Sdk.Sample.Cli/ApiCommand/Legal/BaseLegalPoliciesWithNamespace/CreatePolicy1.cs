...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class CreatePolicy1Command: ISdkConsoleCommand
    {
        ...
        public CreatePolicy1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Legal.Model.CreateBasePolicyRequestV2)Body);
            ...
            var response = wrapper.CreatePolicy1(operation);
