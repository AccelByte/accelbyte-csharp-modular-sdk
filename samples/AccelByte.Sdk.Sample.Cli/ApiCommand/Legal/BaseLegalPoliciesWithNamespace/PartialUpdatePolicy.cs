...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class PartialUpdatePolicyCommand: ISdkConsoleCommand
    {
        ...
        public PartialUpdatePolicyCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.PartialUpdatePolicy.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Legal.Model.UpdateBasePolicyRequestV2)Body);



            PartialUpdatePolicy operation = opBuilder.Build(
                BasePolicyId,
                Namespace
            );


            var response = wrapper.PartialUpdatePolicy(operation);
