...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class RetrieveAllUsersByPolicyVersionCommand : ISdkConsoleCommand
    {
        ...
        public RetrieveAllUsersByPolicyVersionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.RetrieveAllUsersByPolicyVersion.Builder;
            ...
            RetrieveAllUsersByPolicyVersion operation = opBuilder.Build(
                PolicyVersionId
            );
