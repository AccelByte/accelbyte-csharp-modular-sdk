...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class AcceptVersionedPolicyCommand : ISdkConsoleCommand
    {
        ...
        public AcceptVersionedPolicyCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.AcceptVersionedPolicy.Builder;





            AcceptVersionedPolicy operation = opBuilder.Build(
                LocalizedPolicyVersionId
            );


            var response = wrapper.AcceptVersionedPolicy(operation);
