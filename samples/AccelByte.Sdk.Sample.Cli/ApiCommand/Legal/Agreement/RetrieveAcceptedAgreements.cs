...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class RetrieveAcceptedAgreementsCommand: ISdkConsoleCommand
    {
        ...
        public RetrieveAcceptedAgreementsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.RetrieveAcceptedAgreements.Builder;





            RetrieveAcceptedAgreements operation = opBuilder.Build(
                UserId
            );


            var response = wrapper.RetrieveAcceptedAgreements(operation);
