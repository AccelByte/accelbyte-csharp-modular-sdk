...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class RetrieveLatestPoliciesByNamespaceAndCountryPublic1Command : ISdkConsoleCommand
    {
        ...
        public RetrieveLatestPoliciesByNamespaceAndCountryPublic1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var response = wrapper.RetrieveLatestPoliciesByNamespaceAndCountryPublic1(operation);
