...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class UnpublishPolicyVersionCommand : ISdkConsoleCommand
    {
        ...
        public UnpublishPolicyVersionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.UnpublishPolicyVersion.Builder;





            UnpublishPolicyVersion operation = opBuilder.Build(
                Namespace,
                PolicyVersionId
            );


            var response = wrapper.UnpublishPolicyVersion(operation);
