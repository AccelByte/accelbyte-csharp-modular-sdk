...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class CreatePolicyVersion1Command : ISdkConsoleCommand
    {
        ...
        public CreatePolicyVersion1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.CreatePolicyVersion1.Builder;
            ...
            CreatePolicyVersion1 operation = opBuilder.Build(
                Namespace,
                PolicyId
            );


            var response = wrapper.CreatePolicyVersion1(operation);
