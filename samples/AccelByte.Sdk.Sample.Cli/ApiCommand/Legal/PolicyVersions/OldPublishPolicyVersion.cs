...
{
    [SdkConsoleCommand("legal","oldpublishpolicyversion")]
    public class OldPublishPolicyVersionCommand: ISdkConsoleCommand
    {
        private IAccelByteSdk _SDK;

        public string ServiceName{ get { return "Legal"; } }

        public string OperationName{ get { return "OldPublishPolicyVersion"; } }
        ...
        public OldPublishPolicyVersionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            OldPublishPolicyVersion operation = opBuilder.Build(
                PolicyVersionId
            );


            var response = wrapper.OldPublishPolicyVersion(operation);
