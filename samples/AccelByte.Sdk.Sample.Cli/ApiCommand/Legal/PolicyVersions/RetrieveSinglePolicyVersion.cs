...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class RetrieveSinglePolicyVersionCommand : ISdkConsoleCommand
    {
        ...
        public RetrieveSinglePolicyVersionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.RetrieveSinglePolicyVersion.Builder;
            ...
            RetrieveSinglePolicyVersion operation = opBuilder.Build(
                PolicyId
            );


            var response = wrapper.RetrieveSinglePolicyVersion(operation);
