...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Legal
{
    ...
    public class AdminRetrieveEligibilitiesCommand : ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Legal.Operation.AdminRetrieveEligibilities.Builder;
            ...
            AdminRetrieveEligibilities operation = opBuilder.Build(
                Namespace,
                UserId,
                ClientId,
                CountryCode
            ...
            var response = wrapper.AdminRetrieveEligibilities(operation);
