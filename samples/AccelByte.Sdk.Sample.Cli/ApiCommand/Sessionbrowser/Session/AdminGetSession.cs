...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Sessionbrowser
{
    ...
    public class AdminGetSessionCommand : ISdkConsoleCommand
    {
        ...
        public AdminGetSessionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Sessionbrowser.Operation.AdminGetSession.Builder;





            AdminGetSession operation = opBuilder.Build(
                Namespace,
                SessionID
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.AdminGetSession(operation);
