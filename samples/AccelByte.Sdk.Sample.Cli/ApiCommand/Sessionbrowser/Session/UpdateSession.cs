...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Sessionbrowser
{
    ...
    public class UpdateSessionCommand : ISdkConsoleCommand
    {
        ...
        public UpdateSessionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Sessionbrowser.Operation.UpdateSession.Builder;





            UpdateSession operation = opBuilder.Build(
                Body,
                Namespace,
                SessionID
            );
            ...
            var response = wrapper.UpdateSession(operation);
