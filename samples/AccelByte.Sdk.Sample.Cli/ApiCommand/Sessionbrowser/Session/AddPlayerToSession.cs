...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Sessionbrowser
{
    ...
    public class AddPlayerToSessionCommand: ISdkConsoleCommand
    {
        ...
        public AddPlayerToSessionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Sessionbrowser.Operation.AddPlayerToSession.Builder;





            AddPlayerToSession operation = opBuilder.Build(
                Body,
                Namespace,
                SessionID
            );
            ...
            var response = wrapper.AddPlayerToSession(operation);
