...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Sessionbrowser
{
    ...
    public class AdminDeleteSessionCommand : ISdkConsoleCommand
    {
        ...
        public AdminDeleteSessionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Sessionbrowser.Operation.AdminDeleteSession.Builder;





            AdminDeleteSession operation = opBuilder.Build(
                Namespace,
                SessionID
            );


            var response = wrapper.AdminDeleteSession(operation);
