...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Sessionbrowser
{
    ...
    public class CreateSessionCommand: ISdkConsoleCommand
    {
        ...
        public CreateSessionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Sessionbrowser.Operation.CreateSession.Builder;





            CreateSession operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.CreateSession(operation);
