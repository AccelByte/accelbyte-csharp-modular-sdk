...
{
    [SdkConsoleCommand("sessionhistory", "querymatchlengthdurationpavg")]
    public class QueryMatchLengthDurationpAvgCommand : ISdkConsoleCommand
    {
        private IAccelByteSdk _SDK;

        public string ServiceName { get { return "Sessionhistory"; } }

        public string OperationName { get { return "QueryMatchLengthDurationpAvg"; } }
        ...
        public QueryMatchLengthDurationpAvgCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            QueryMatchLengthDurationpAvg operation = opBuilder.Build(
                Namespace,
                EndDate,
                StartDate
            );
            ...
            AccelByte.Sdk.Api.Sessionhistory.Model.ApimodelsXRayMatchLengthDurationQueryResponse? response = wrapper.QueryMatchLengthDurationpAvg(operation);
            if (response == null)
