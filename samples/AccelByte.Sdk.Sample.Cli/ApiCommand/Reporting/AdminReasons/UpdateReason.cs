...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Reporting
{
    ...
    public class UpdateReasonCommand: ISdkConsoleCommand
    {
        ...
        public UpdateReasonCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Reporting.Operation.UpdateReason.Builder;





            UpdateReason operation = opBuilder.Build(
                Body,
                Namespace,
                ReasonId
            );
            ...
            var response = wrapper.UpdateReason(operation);
