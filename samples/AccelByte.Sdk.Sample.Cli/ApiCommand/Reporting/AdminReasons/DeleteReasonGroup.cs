...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Reporting
{
    ...
    public class DeleteReasonGroupCommand : ISdkConsoleCommand
    {
        ...
        public DeleteReasonGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Reporting.Operation.DeleteReasonGroup.Builder;





            DeleteReasonGroup operation = opBuilder.Build(
                GroupId,
                Namespace
            );


            var response = wrapper.DeleteReasonGroup(operation);
