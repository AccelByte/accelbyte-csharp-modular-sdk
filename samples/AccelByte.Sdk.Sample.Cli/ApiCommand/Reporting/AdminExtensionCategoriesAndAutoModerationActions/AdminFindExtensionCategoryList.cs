...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Reporting
{
    ...
    public class AdminFindExtensionCategoryListCommand : ISdkConsoleCommand
    {
        ...
        public AdminFindExtensionCategoryListCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Reporting.Operation.AdminFindExtensionCategoryList.Builder;

            if (Order != null)
                opBuilder.SetOrder(AdminFindExtensionCategoryListOrder.NewValue(Order));
            if (SortBy != null)
                opBuilder.SetSortBy(AdminFindExtensionCategoryListSortBy.NewValue(SortBy));




            AdminFindExtensionCategoryList operation = opBuilder.Build(
            );
