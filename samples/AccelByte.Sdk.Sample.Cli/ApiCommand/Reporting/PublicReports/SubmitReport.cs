...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Reporting
{
    ...
    public class SubmitReportCommand: ISdkConsoleCommand
    {
        ...
        public SubmitReportCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Reporting.Operation.SubmitReport.Builder;





            SubmitReport operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.SubmitReport(operation);
