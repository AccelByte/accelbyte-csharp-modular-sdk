...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Reporting
{
    ...
    public class DeleteTicketCommand: ISdkConsoleCommand
    {
        ...
        public DeleteTicketCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Reporting.Operation.DeleteTicket.Builder;





            DeleteTicket operation = opBuilder.Build(
                Namespace,
                TicketId
            );


            var response = wrapper.DeleteTicket(operation);
