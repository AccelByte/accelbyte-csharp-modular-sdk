...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Reporting
{
    ...
    public class UpdateModerationRuleCommand: ISdkConsoleCommand
    {
        ...
        public UpdateModerationRuleCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Reporting.Operation.UpdateModerationRule.Builder;





            UpdateModerationRule operation = opBuilder.Build(
                Body,
                Namespace,
                RuleId
            );
            ...
            var response = wrapper.UpdateModerationRule(operation);
