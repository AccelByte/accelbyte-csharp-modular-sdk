...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class BulkDisableCodesCommand : ISdkConsoleCommand
    {
        ...
        public BulkDisableCodesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.BulkDisableCodes.Builder;
            ...
            BulkDisableCodes operation = opBuilder.Build(
                CampaignId,
                Namespace
            );


            var response = wrapper.BulkDisableCodes(operation);
