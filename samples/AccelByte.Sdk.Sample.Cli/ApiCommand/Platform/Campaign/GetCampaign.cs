...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetCampaignCommand : ISdkConsoleCommand
    {
        ...
        public GetCampaignCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetCampaign.Builder;





            GetCampaign operation = opBuilder.Build(
                CampaignId,
                Namespace
            );


            var response = wrapper.GetCampaign(operation);
