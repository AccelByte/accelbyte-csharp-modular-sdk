...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetCampaignDynamicCommand: ISdkConsoleCommand
    {
        ...
        public GetCampaignDynamicCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetCampaignDynamic.Builder;





            GetCampaignDynamic operation = opBuilder.Build(
                CampaignId,
                Namespace
            );


            var response = wrapper.GetCampaignDynamic(operation);
