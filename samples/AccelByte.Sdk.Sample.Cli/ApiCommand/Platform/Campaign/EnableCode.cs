...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class EnableCodeCommand : ISdkConsoleCommand
    {
        ...
        public EnableCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.EnableCode.Builder;





            EnableCode operation = opBuilder.Build(
                Code,
                Namespace
            );


            var response = wrapper.EnableCode(operation);
