...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetCodeCommand : ISdkConsoleCommand
    {
        ...
        public GetCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetCode.Builder;
            ...
            GetCode operation = opBuilder.Build(
                Code,
                Namespace
            );


            var response = wrapper.GetCode(operation);
