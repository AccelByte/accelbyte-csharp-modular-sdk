...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class CreateCodesCommand : ISdkConsoleCommand
    {
        ...
        public CreateCodesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.CreateCodes.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.CodeCreate)Body);



            CreateCodes operation = opBuilder.Build(
                CampaignId,
                Namespace
            );
