...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class DisableCodeCommand: ISdkConsoleCommand
    {
        ...
        public DisableCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.DisableCode.Builder;





            DisableCode operation = opBuilder.Build(
                Code,
                Namespace
            );


            var response = wrapper.DisableCode(operation);
