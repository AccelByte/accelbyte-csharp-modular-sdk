...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicListViewsCommand: ISdkConsoleCommand
    {
        ...
        public PublicListViewsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicListViews.Builder;
            ...
            PublicListViews operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.PublicListViews(operation);
