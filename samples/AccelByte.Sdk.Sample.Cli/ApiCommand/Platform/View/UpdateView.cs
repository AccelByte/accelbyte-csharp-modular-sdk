...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class UpdateViewCommand: ISdkConsoleCommand
    {
        ...
        public UpdateViewCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.UpdateView.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.ViewUpdate)Body);



            UpdateView operation = opBuilder.Build(
                Namespace,
                ViewId,
                StoreId
            );
