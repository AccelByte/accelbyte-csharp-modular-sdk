...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class QueryFulfillmentHistoriesCommand : ISdkConsoleCommand
    {
        ...
        public QueryFulfillmentHistoriesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.QueryFulfillmentHistories.Builder;
            ...
            var response = wrapper.QueryFulfillmentHistories(operation);
