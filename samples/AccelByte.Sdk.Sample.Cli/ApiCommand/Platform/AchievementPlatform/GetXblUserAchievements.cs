...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetXblUserAchievementsCommand: ISdkConsoleCommand
    {
        ...
        [SdkCommandArgument("xboxUserId")]
        public string XboxUserId { get; set; } = String.Empty;

        public GetXblUserAchievementsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetXblUserAchievements.Builder;





            GetXblUserAchievements operation = opBuilder.Build(
                Namespace,
                UserId,
                XboxUserId
            );
            ...
            var response = wrapper.GetXblUserAchievements(operation);
