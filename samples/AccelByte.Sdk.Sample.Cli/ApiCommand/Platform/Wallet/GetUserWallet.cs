...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserWalletCommand: ISdkConsoleCommand
    {
        ...
        public GetUserWalletCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserWallet.Builder;





            GetUserWallet operation = opBuilder.Build(
                Namespace,
                UserId,
                WalletId
            );
            ...
            var response = wrapper.GetUserWallet(operation);
