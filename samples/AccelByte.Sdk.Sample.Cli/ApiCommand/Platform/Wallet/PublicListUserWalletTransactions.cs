...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicListUserWalletTransactionsCommand: ISdkConsoleCommand
    {
        ...
        public PublicListUserWalletTransactionsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicListUserWalletTransactions.Builder;
            ...
            PublicListUserWalletTransactions operation = opBuilder.Build(
                CurrencyCode,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.PublicListUserWalletTransactions(operation);
