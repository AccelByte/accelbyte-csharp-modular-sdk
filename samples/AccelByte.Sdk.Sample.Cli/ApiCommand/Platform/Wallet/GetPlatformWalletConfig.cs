...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetPlatformWalletConfigCommand: ISdkConsoleCommand
    {
        ...
        public GetPlatformWalletConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetPlatformWalletConfig.Builder;





            GetPlatformWalletConfig operation = opBuilder.Build(
                Namespace,
                Platform
            );


            var response = wrapper.GetPlatformWalletConfig(operation);
