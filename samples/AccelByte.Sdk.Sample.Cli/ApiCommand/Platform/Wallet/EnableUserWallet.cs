...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class EnableUserWalletCommand : ISdkConsoleCommand
    {
        ...
        public EnableUserWalletCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.EnableUserWallet.Builder;





            EnableUserWallet operation = opBuilder.Build(
                Namespace,
                UserId,
                WalletId
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.EnableUserWallet(operation);
