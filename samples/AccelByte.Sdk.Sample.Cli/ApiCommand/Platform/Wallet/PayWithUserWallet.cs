...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PayWithUserWalletCommand : ISdkConsoleCommand
    {
        ...
        public PayWithUserWalletCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PayWithUserWallet.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.PaymentRequest)Body);



            PayWithUserWallet operation = opBuilder.Build(
                CurrencyCode,
                Namespace,
                UserId
            );
