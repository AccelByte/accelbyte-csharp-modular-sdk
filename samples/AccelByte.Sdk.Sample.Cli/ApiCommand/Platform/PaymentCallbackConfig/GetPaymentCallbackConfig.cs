...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetPaymentCallbackConfigCommand : ISdkConsoleCommand
    {
        ...
        public GetPaymentCallbackConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetPaymentCallbackConfig.Builder;





            GetPaymentCallbackConfig operation = opBuilder.Build(
                Namespace
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.GetPaymentCallbackConfig(operation);
