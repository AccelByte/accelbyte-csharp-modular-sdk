...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetLootBoxGrpcInfoCommand : ISdkConsoleCommand
    {
        ...
        public GetLootBoxGrpcInfoCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetLootBoxGrpcInfo.Builder;
            ...
            GetLootBoxGrpcInfo operation = opBuilder.Build(
                Namespace
            );


            AccelByte.Sdk.Api.Platform.Model.GrpcServerInfo? response = wrapper.GetLootBoxGrpcInfo(operation);
            if (response == null)
