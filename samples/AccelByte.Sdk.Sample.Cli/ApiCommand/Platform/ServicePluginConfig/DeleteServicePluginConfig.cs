...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class DeleteServicePluginConfigCommand : ISdkConsoleCommand
    {
        ...
        public DeleteServicePluginConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            ...
            DeleteServicePluginConfig operation = opBuilder.Build(
                Namespace
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.DeleteServicePluginConfig(operation);
