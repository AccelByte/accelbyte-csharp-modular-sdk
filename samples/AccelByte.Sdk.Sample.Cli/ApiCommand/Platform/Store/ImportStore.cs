...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ImportStoreCommand: ISdkConsoleCommand
    {
        ...
        public ImportStoreCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.ImportStore.Builder;
            ...
            ImportStore operation = opBuilder.Build(
                Namespace
            );
            ...
            var response = wrapper.ImportStore(operation);
