...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetPublishedStoreBackupCommand : ISdkConsoleCommand
    {
        ...
        public GetPublishedStoreBackupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetPublishedStoreBackup.Builder;





            GetPublishedStoreBackup operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetPublishedStoreBackup(operation);
