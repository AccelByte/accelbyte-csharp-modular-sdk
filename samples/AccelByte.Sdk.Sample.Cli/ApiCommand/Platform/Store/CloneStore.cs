...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class CloneStoreCommand : ISdkConsoleCommand
    {
        ...
        public CloneStoreCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.CloneStore.Builder;

            if (TargetStoreId != null)
                opBuilder.SetTargetStoreId((string)TargetStoreId);




            CloneStore operation = opBuilder.Build(
                Namespace,
                StoreId
            );


            var response = wrapper.CloneStore(operation);
