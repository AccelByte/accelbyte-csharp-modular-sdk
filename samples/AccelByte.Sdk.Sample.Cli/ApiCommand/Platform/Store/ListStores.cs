...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ListStoresCommand: ISdkConsoleCommand
    {
        ...
        public ListStoresCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.ListStores.Builder;





            ListStores operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.ListStores(operation);
