...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetStoreCommand : ISdkConsoleCommand
    {
        ...
        public GetStoreCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetStore.Builder;





            GetStore operation = opBuilder.Build(
                Namespace,
                StoreId
            );


            var response = wrapper.GetStore(operation);
