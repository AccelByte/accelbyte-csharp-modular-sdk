...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicListStoresCommand: ISdkConsoleCommand
    {
        ...
        public PublicListStoresCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicListStores.Builder;





            PublicListStores operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.PublicListStores(operation);
