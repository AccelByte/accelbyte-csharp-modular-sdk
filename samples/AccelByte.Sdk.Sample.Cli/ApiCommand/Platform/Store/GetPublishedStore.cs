...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetPublishedStoreCommand : ISdkConsoleCommand
    {
        ...
        public GetPublishedStoreCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetPublishedStore.Builder;





            GetPublishedStore operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetPublishedStore(operation);
