...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class DeletePublishedStoreCommand : ISdkConsoleCommand
    {
        ...
        public DeletePublishedStoreCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.DeletePublishedStore.Builder;





            DeletePublishedStore operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.DeletePublishedStore(operation);
