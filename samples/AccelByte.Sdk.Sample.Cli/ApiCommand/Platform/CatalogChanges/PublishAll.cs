...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublishAllCommand: ISdkConsoleCommand
    {
        ...
        public PublishAllCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublishAll.Builder;





            PublishAll operation = opBuilder.Build(
                Namespace,
                StoreId
            );


            var response = wrapper.PublishAll(operation);
