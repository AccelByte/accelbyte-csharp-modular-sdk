...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetQRCodeCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetQRCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetQRCode.Builder;





            PublicGetQRCode operation = opBuilder.Build(
                Namespace,
                Code
            );


            var response = wrapper.PublicGetQRCode(operation);
