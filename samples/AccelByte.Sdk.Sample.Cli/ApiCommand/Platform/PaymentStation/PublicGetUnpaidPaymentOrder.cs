...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetUnpaidPaymentOrderCommand : ISdkConsoleCommand
    {
        ...
        public PublicGetUnpaidPaymentOrderCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetUnpaidPaymentOrder.Builder;





            PublicGetUnpaidPaymentOrder operation = opBuilder.Build(
                Namespace,
                PaymentOrderNo
            );


            var response = wrapper.PublicGetUnpaidPaymentOrder(operation);
