...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetPaymentTaxValueCommand: ISdkConsoleCommand
    {
        ...
        public GetPaymentTaxValueCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetPaymentTaxValue.Builder;
            ...
            GetPaymentTaxValue operation = opBuilder.Build(
                Namespace,
                PaymentOrderNo,
                PaymentProvider
            );
            ...
            var response = wrapper.GetPaymentTaxValue(operation);
