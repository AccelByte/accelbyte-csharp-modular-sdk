...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetPaymentMethodsCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetPaymentMethodsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetPaymentMethods.Builder;





            PublicGetPaymentMethods operation = opBuilder.Build(
                Namespace,
                PaymentOrderNo
            );


            var response = wrapper.PublicGetPaymentMethods(operation);
