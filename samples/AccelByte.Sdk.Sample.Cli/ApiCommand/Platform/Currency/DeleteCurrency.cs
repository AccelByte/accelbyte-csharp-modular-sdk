...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class DeleteCurrencyCommand: ISdkConsoleCommand
    {
        ...
        public DeleteCurrencyCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.DeleteCurrency.Builder;





            DeleteCurrency operation = opBuilder.Build(
                CurrencyCode,
                Namespace
            );


            var response = wrapper.DeleteCurrency(operation);
