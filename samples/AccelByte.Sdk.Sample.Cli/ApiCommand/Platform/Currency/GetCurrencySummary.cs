...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetCurrencySummaryCommand: ISdkConsoleCommand
    {
        ...
        public GetCurrencySummaryCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetCurrencySummary.Builder;





            GetCurrencySummary operation = opBuilder.Build(
                CurrencyCode,
                Namespace
            );


            var response = wrapper.GetCurrencySummary(operation);
