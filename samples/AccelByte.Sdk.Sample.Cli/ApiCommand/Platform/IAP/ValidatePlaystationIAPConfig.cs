...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ValidatePlaystationIAPConfigCommand: ISdkConsoleCommand
    {
        ...
        public ValidatePlaystationIAPConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.ValidatePlaystationIAPConfig.Builder;
            ...
            ValidatePlaystationIAPConfig operation = opBuilder.Build(
                Namespace
            );


            AccelByte.Sdk.Api.Platform.Model.TestResult? response = wrapper.ValidatePlaystationIAPConfig(operation);
            if (response == null)
