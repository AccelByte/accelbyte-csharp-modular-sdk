...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class UpdateIAPItemConfigCommand : ISdkConsoleCommand
    {
        ...
        public UpdateIAPItemConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.UpdateIAPItemConfig.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.IAPItemConfigUpdate)Body);



            UpdateIAPItemConfig operation = opBuilder.Build(
                Namespace
            );
