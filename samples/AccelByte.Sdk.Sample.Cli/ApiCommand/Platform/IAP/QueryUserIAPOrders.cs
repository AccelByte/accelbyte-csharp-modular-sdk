...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class QueryUserIAPOrdersCommand: ISdkConsoleCommand
    {
        ...
        public QueryUserIAPOrdersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.QueryUserIAPOrders.Builder;
            ...
            if (Status != null)
                opBuilder.SetStatus(QueryUserIAPOrdersStatus.NewValue(Status));
            if (Type != null)
                opBuilder.SetType(QueryUserIAPOrdersType.NewValue(Type));




            QueryUserIAPOrders operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.QueryUserIAPOrders(operation);
