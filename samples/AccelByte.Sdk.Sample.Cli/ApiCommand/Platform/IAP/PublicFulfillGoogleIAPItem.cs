...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicFulfillGoogleIAPItemCommand: ISdkConsoleCommand
    {
        ...
        public PublicFulfillGoogleIAPItemCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicFulfillGoogleIAPItem.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.GoogleIAPReceipt)Body);



            PublicFulfillGoogleIAPItem operation = opBuilder.Build(
                Namespace,
                UserId
            );
