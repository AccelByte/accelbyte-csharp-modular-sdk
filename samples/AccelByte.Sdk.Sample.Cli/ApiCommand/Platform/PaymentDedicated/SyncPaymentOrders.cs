...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class SyncPaymentOrdersCommand: ISdkConsoleCommand
    {
        ...
        public SyncPaymentOrdersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.SyncPaymentOrders.Builder;
            ...
            SyncPaymentOrders operation = opBuilder.Build(
                End,
                Start
            );


            var response = wrapper.SyncPaymentOrders(operation);
