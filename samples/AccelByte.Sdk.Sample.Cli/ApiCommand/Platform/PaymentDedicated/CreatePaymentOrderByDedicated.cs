...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class CreatePaymentOrderByDedicatedCommand : ISdkConsoleCommand
    {
        ...
        public CreatePaymentOrderByDedicatedCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.CreatePaymentOrderByDedicated.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.ExternalPaymentOrderCreate)Body);



            CreatePaymentOrderByDedicated operation = opBuilder.Build(
                Namespace
            );
