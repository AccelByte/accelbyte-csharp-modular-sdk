...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class CreateKeyGroupCommand: ISdkConsoleCommand
    {
        ...
        public CreateKeyGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.CreateKeyGroup.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.KeyGroupCreate)Body);



            CreateKeyGroup operation = opBuilder.Build(
                Namespace
            );
