...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ChargePaymentOrderCommand : ISdkConsoleCommand
    {
        ...
        public ChargePaymentOrderCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.ChargePaymentOrder.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.PaymentOrderChargeRequest)Body);



            ChargePaymentOrder operation = opBuilder.Build(
                Namespace,
                PaymentOrderNo
            );
