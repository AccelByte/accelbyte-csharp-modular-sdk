...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetPaymentOrderChargeStatusCommand : ISdkConsoleCommand
    {
        ...
        public GetPaymentOrderChargeStatusCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetPaymentOrderChargeStatus.Builder;





            GetPaymentOrderChargeStatus operation = opBuilder.Build(
                Namespace,
                PaymentOrderNo
            );


            var response = wrapper.GetPaymentOrderChargeStatus(operation);
