...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class QueryRevocationHistoriesCommand : ISdkConsoleCommand
    {
        ...
        public QueryRevocationHistoriesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.QueryRevocationHistories.Builder;
            ...
            if (Source != null)
                opBuilder.SetSource(QueryRevocationHistoriesSource.NewValue(Source));
            if (StartTime != null)
                opBuilder.SetStartTime((string)StartTime);
            if (Status != null)
                opBuilder.SetStatus(QueryRevocationHistoriesStatus.NewValue(Status));
            ...
            QueryRevocationHistories operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.QueryRevocationHistories(operation);
