...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetPlatformDLCConfigCommand: ISdkConsoleCommand
    {
        ...
        public GetPlatformDLCConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetPlatformDLCConfig.Builder;





            GetPlatformDLCConfig operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetPlatformDLCConfig(operation);
