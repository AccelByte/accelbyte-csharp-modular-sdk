...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class UpdatePlatformDLCConfigCommand: ISdkConsoleCommand
    {
        ...
        [SdkCommandData("body")]
        public PlatformDLCConfigUpdate Body { get; set; } = new PlatformDLCConfigUpdate();

        public UpdatePlatformDLCConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.UpdatePlatformDLCConfig.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.PlatformDLCConfigUpdate)Body);



            UpdatePlatformDLCConfig operation = opBuilder.Build(
                Namespace
            );
