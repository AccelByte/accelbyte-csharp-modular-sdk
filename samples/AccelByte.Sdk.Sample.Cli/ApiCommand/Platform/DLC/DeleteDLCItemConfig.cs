...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class DeleteDLCItemConfigCommand : ISdkConsoleCommand
    {
        ...
        public DeleteDLCItemConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.DeleteDLCItemConfig.Builder;





            DeleteDLCItemConfig operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.DeleteDLCItemConfig(operation);
