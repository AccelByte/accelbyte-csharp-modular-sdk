...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class RestoreDLCItemConfigHistoryCommand: ISdkConsoleCommand
    {
        ...
        public RestoreDLCItemConfigHistoryCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.RestoreDLCItemConfigHistory.Builder;





            RestoreDLCItemConfigHistory operation = opBuilder.Build(
                Id,
                Namespace
            );


            var response = wrapper.RestoreDLCItemConfigHistory(operation);
