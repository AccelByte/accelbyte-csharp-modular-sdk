...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserDLCByPlatformCommand: ISdkConsoleCommand
    {
        ...
        public GetUserDLCByPlatformCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserDLCByPlatform.Builder;





            GetUserDLCByPlatform operation = opBuilder.Build(
                Namespace,
                UserId,
                Type
            );
            ...
            var response = wrapper.GetUserDLCByPlatform(operation);
