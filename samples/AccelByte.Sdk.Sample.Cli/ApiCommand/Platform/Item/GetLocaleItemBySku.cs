...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetLocaleItemBySkuCommand: ISdkConsoleCommand
    {
        ...
        public GetLocaleItemBySkuCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetLocaleItemBySku.Builder;
            ...
            GetLocaleItemBySku operation = opBuilder.Build(
                Namespace,
                Sku
            );


            var response = wrapper.GetLocaleItemBySku(operation);
