...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetItemByAppIdCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetItemByAppIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetItemByAppId.Builder;
            ...
            PublicGetItemByAppId operation = opBuilder.Build(
                Namespace,
                AppId
            );


            var response = wrapper.PublicGetItemByAppId(operation);
