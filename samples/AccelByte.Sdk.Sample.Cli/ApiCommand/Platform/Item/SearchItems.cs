...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class SearchItemsCommand: ISdkConsoleCommand
    {
        ...
        public SearchItemsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.SearchItems.Builder;

            if (ActiveOnly != null)
                opBuilder.SetActiveOnly((bool)ActiveOnly);
            if (ItemType != null)
                opBuilder.SetItemType(SearchItemsItemType.NewValue(ItemType));
            if (Limit != null)
            ...
            SearchItems operation = opBuilder.Build(
                Namespace,
                Keyword,
                Language
            );
            ...
            var response = wrapper.SearchItems(operation);
