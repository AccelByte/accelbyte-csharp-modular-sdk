...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetAppCommand: ISdkConsoleCommand
    {
        ...
        public GetAppCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetApp.Builder;
            ...
            GetApp operation = opBuilder.Build(
                ItemId,
                Namespace
            );


            var response = wrapper.GetApp(operation);
