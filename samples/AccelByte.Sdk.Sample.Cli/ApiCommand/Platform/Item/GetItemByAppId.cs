...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetItemByAppIdCommand : ISdkConsoleCommand
    {
        ...
        public GetItemByAppIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetItemByAppId.Builder;
            ...
            GetItemByAppId operation = opBuilder.Build(
                Namespace,
                AppId
            );


            var response = wrapper.GetItemByAppId(operation);
