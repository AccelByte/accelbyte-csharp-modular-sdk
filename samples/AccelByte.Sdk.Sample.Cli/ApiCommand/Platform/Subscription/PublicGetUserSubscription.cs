...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetUserSubscriptionCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetUserSubscriptionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetUserSubscription.Builder;





            PublicGetUserSubscription operation = opBuilder.Build(
                Namespace,
                SubscriptionId,
                UserId
            );
            ...
            var response = wrapper.PublicGetUserSubscription(operation);
