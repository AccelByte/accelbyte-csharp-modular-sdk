...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class CheckUserSubscriptionSubscribableByItemIdCommand : ISdkConsoleCommand
    {
        ...
        public CheckUserSubscriptionSubscribableByItemIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.CheckUserSubscriptionSubscribableByItemId.Builder;





            CheckUserSubscriptionSubscribableByItemId operation = opBuilder.Build(
                Namespace,
                UserId,
                ItemId
            );
            ...
            var response = wrapper.CheckUserSubscriptionSubscribableByItemId(operation);
