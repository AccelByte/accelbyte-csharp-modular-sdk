...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class CancelSubscriptionCommand: ISdkConsoleCommand
    {
        ...
        public CancelSubscriptionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.CancelSubscription.Builder;
            ...
            var response = wrapper.CancelSubscription(operation);
