...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserSubscriptionCommand: ISdkConsoleCommand
    {
        ...
        public GetUserSubscriptionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserSubscription.Builder;





            GetUserSubscription operation = opBuilder.Build(
                Namespace,
                SubscriptionId,
                UserId
            );
            ...
            var response = wrapper.GetUserSubscription(operation);
