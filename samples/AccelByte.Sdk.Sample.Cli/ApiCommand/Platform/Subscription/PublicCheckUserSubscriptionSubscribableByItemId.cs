...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicCheckUserSubscriptionSubscribableByItemIdCommand: ISdkConsoleCommand
    {
        ...
        public PublicCheckUserSubscriptionSubscribableByItemIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var response = wrapper.PublicCheckUserSubscriptionSubscribableByItemId(operation);
