...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicChangeSubscriptionBillingAccountCommand: ISdkConsoleCommand
    {
        ...
        public PublicChangeSubscriptionBillingAccountCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicChangeSubscriptionBillingAccount.Builder;





            PublicChangeSubscriptionBillingAccount operation = opBuilder.Build(
                Namespace,
                SubscriptionId,
                UserId
            );
            ...
            var response = wrapper.PublicChangeSubscriptionBillingAccount(operation);
