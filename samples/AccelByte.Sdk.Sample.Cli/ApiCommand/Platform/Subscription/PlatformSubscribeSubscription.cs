...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PlatformSubscribeSubscriptionCommand: ISdkConsoleCommand
    {
        ...
        public PlatformSubscribeSubscriptionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PlatformSubscribeSubscription.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.PlatformSubscribeRequest)Body);



            PlatformSubscribeSubscription operation = opBuilder.Build(
                Namespace,
                UserId
            );
