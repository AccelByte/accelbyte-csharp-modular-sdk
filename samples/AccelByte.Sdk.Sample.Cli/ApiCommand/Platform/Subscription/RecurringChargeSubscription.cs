...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class RecurringChargeSubscriptionCommand: ISdkConsoleCommand
    {
        ...
        public RecurringChargeSubscriptionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.RecurringChargeSubscription.Builder;





            RecurringChargeSubscription operation = opBuilder.Build(
                Namespace,
                SubscriptionId
            );


            var response = wrapper.RecurringChargeSubscription(operation);
