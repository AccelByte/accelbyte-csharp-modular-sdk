...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ProcessUserSubscriptionNotificationCommand: ISdkConsoleCommand
    {
        ...
        public ProcessUserSubscriptionNotificationCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.ProcessUserSubscriptionNotification.Builder;
            ...
            ProcessUserSubscriptionNotification operation = opBuilder.Build(
                Namespace,
                SubscriptionId,
                UserId
            );
