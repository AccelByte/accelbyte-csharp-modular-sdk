...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class AnonymizeRevocationCommand: ISdkConsoleCommand
    {
        ...
        public AnonymizeRevocationCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.AnonymizeRevocation.Builder;





            AnonymizeRevocation operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.AnonymizeRevocation(operation);
