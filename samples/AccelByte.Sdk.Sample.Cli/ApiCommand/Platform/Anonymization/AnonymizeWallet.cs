...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class AnonymizeWalletCommand: ISdkConsoleCommand
    {
        ...
        public AnonymizeWalletCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.AnonymizeWallet.Builder;





            AnonymizeWallet operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.AnonymizeWallet(operation);
