...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserOrderHistoriesCommand: ISdkConsoleCommand
    {
        ...
        public GetUserOrderHistoriesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserOrderHistories.Builder;





            GetUserOrderHistories operation = opBuilder.Build(
                Namespace,
                OrderNo,
                UserId
            );
            ...
            var response = wrapper.GetUserOrderHistories(operation);
