...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class DownloadUserOrderReceiptCommand: ISdkConsoleCommand
    {
        ...
        public DownloadUserOrderReceiptCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.DownloadUserOrderReceipt.Builder;





            DownloadUserOrderReceipt operation = opBuilder.Build(
                Namespace,
                OrderNo,
                UserId
            );
            ...
            Stream? response = wrapper.DownloadUserOrderReceipt(operation);
            if (response == null)
