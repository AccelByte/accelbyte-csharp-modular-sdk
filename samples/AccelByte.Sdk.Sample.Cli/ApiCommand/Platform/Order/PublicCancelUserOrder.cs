...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicCancelUserOrderCommand : ISdkConsoleCommand
    {
        ...
        public PublicCancelUserOrderCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicCancelUserOrder.Builder;





            PublicCancelUserOrder operation = opBuilder.Build(
                Namespace,
                OrderNo,
                UserId
            );
            ...
            var response = wrapper.PublicCancelUserOrder(operation);
