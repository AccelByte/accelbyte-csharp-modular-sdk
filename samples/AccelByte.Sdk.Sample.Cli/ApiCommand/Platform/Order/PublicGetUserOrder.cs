...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetUserOrderCommand : ISdkConsoleCommand
    {
        ...
        public PublicGetUserOrderCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetUserOrder.Builder;





            PublicGetUserOrder operation = opBuilder.Build(
                Namespace,
                OrderNo,
                UserId
            );
            ...
            var response = wrapper.PublicGetUserOrder(operation);
