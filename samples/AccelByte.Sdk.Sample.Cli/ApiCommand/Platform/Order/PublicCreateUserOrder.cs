...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicCreateUserOrderCommand : ISdkConsoleCommand
    {
        ...
        public PublicCreateUserOrderCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicCreateUserOrder.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.OrderCreate)Body);



            PublicCreateUserOrder operation = opBuilder.Build(
                Namespace,
                UserId
            );
