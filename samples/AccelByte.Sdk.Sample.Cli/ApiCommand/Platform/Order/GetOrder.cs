...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetOrderCommand : ISdkConsoleCommand
    {
        ...
        public GetOrderCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetOrder.Builder;





            GetOrder operation = opBuilder.Build(
                Namespace,
                OrderNo
            );


            var response = wrapper.GetOrder(operation);
