...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetUserOrderHistoriesCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetUserOrderHistoriesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetUserOrderHistories.Builder;





            PublicGetUserOrderHistories operation = opBuilder.Build(
                Namespace,
                OrderNo,
                UserId
            );
            ...
            var response = wrapper.PublicGetUserOrderHistories(operation);
