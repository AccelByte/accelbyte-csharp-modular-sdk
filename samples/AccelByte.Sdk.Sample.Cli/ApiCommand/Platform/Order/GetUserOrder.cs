...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserOrderCommand: ISdkConsoleCommand
    {
        ...
        public GetUserOrderCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserOrder.Builder;





            GetUserOrder operation = opBuilder.Build(
                Namespace,
                OrderNo,
                UserId
            );
            ...
            var response = wrapper.GetUserOrder(operation);
