...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class CreateFulfillmentScriptCommand : ISdkConsoleCommand
    {
        ...
        public CreateFulfillmentScriptCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.CreateFulfillmentScript.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.FulfillmentScriptCreate)Body);



            CreateFulfillmentScript operation = opBuilder.Build(
                Id
            );


            var response = wrapper.CreateFulfillmentScript(operation);
