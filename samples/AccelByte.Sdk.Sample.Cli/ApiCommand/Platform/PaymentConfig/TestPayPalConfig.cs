...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class TestPayPalConfigCommand : ISdkConsoleCommand
    {
        ...
        public TestPayPalConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.TestPayPalConfig.Builder;
            ...
            TestPayPalConfig operation = opBuilder.Build(
                Body
            );


            var response = wrapper.TestPayPalConfig(operation);
