...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class TestPayPalConfigByIdCommand: ISdkConsoleCommand
    {
        ...
        public TestPayPalConfigByIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.TestPayPalConfigById.Builder;
            ...
            TestPayPalConfigById operation = opBuilder.Build(
                Id
            );


            var response = wrapper.TestPayPalConfigById(operation);
