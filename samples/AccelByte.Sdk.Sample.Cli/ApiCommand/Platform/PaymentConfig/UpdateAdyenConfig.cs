...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class UpdateAdyenConfigCommand: ISdkConsoleCommand
    {
        ...
        public UpdateAdyenConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.UpdateAdyenConfig.Builder;
            ...
            UpdateAdyenConfig operation = opBuilder.Build(
                Body,
                Id
            );


            var response = wrapper.UpdateAdyenConfig(operation);
