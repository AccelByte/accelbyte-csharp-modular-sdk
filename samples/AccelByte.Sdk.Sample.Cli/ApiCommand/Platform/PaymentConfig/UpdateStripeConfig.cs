...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class UpdateStripeConfigCommand: ISdkConsoleCommand
    {
        ...
        public UpdateStripeConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.UpdateStripeConfig.Builder;
            ...
            UpdateStripeConfig operation = opBuilder.Build(
                Body,
                Id
            );


            var response = wrapper.UpdateStripeConfig(operation);
