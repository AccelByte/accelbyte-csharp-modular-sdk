...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class UpdateXsollaConfigCommand: ISdkConsoleCommand
    {
        ...
        public UpdateXsollaConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.UpdateXsollaConfig.Builder;
            ...
            UpdateXsollaConfig operation = opBuilder.Build(
                Body,
                Id
            );


            var response = wrapper.UpdateXsollaConfig(operation);
