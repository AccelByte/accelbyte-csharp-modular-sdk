...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class DeletePaymentProviderConfigCommand: ISdkConsoleCommand
    {
        ...
        public DeletePaymentProviderConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.DeletePaymentProviderConfig.Builder;





            DeletePaymentProviderConfig operation = opBuilder.Build(
                Id
            );


            var response = wrapper.DeletePaymentProviderConfig(operation);
