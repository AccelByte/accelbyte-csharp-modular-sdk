...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class TestAdyenConfigCommand: ISdkConsoleCommand
    {
        ...
        public TestAdyenConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.TestAdyenConfig.Builder;
            ...
            var response = wrapper.TestAdyenConfig(operation);
