...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class TestCheckoutConfigByIdCommand: ISdkConsoleCommand
    {
        ...
        public TestCheckoutConfigByIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.TestCheckoutConfigById.Builder;
            ...
            TestCheckoutConfigById operation = opBuilder.Build(
                Id
            );


            var response = wrapper.TestCheckoutConfigById(operation);
