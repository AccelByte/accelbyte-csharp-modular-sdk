...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class TestAliPayConfigCommand: ISdkConsoleCommand
    {
        ...
        public TestAliPayConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.TestAliPayConfig.Builder;
            ...
            var response = wrapper.TestAliPayConfig(operation);
