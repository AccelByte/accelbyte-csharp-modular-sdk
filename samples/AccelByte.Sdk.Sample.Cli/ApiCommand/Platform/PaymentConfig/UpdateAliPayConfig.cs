...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class UpdateAliPayConfigCommand: ISdkConsoleCommand
    {
        ...
        public UpdateAliPayConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.UpdateAliPayConfig.Builder;
            ...
            var response = wrapper.UpdateAliPayConfig(operation);
