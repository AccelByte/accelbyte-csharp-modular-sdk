...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetPaymentTaxConfigCommand : ISdkConsoleCommand
    {
        ...
        public GetPaymentTaxConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetPaymentTaxConfig.Builder;





            GetPaymentTaxConfig operation = opBuilder.Build(
            );


            var response = wrapper.GetPaymentTaxConfig(operation);
