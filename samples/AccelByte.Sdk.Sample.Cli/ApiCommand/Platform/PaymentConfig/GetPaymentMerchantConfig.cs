...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetPaymentMerchantConfigCommand : ISdkConsoleCommand
    {
        ...
        public GetPaymentMerchantConfigCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetPaymentMerchantConfig.Builder;
            ...
            var response = wrapper.GetPaymentMerchantConfig(operation);
