...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class TestXsollaConfigByIdCommand: ISdkConsoleCommand
    {
        ...
        public TestXsollaConfigByIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.TestXsollaConfigById.Builder;





            TestXsollaConfigById operation = opBuilder.Build(
                Id
            );


            var response = wrapper.TestXsollaConfigById(operation);
