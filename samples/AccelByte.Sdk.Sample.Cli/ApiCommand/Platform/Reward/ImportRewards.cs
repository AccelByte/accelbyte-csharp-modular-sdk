...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ImportRewardsCommand: ISdkConsoleCommand
    {
        ...
        public ImportRewardsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.ImportRewards.Builder;
            ...
            ImportRewards operation = opBuilder.Build(
                Namespace,
                ReplaceExisting
            );


            var response = wrapper.ImportRewards(operation);
