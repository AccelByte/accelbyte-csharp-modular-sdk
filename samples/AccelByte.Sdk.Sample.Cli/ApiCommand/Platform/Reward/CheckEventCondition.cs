...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class CheckEventConditionCommand: ISdkConsoleCommand
    {
        ...
        public CheckEventConditionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.CheckEventCondition.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.EventPayload)Body);



            CheckEventCondition operation = opBuilder.Build(
                Namespace,
                RewardId
            );


            var response = wrapper.CheckEventCondition(operation);
