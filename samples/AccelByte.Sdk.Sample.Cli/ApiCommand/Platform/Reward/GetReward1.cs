...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetReward1Command : ISdkConsoleCommand
    {
        ...
        public GetReward1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetReward1.Builder;





            GetReward1 operation = opBuilder.Build(
                Namespace,
                RewardId
            );


            var response = wrapper.GetReward1(operation);
