...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetRewardByCodeCommand: ISdkConsoleCommand
    {
        ...
        public GetRewardByCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetRewardByCode.Builder;





            GetRewardByCode operation = opBuilder.Build(
                Namespace,
                RewardCode
            );


            var response = wrapper.GetRewardByCode(operation);
