...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserEntitlementOwnershipByItemIdCommand: ISdkConsoleCommand
    {
        ...
        public GetUserEntitlementOwnershipByItemIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserEntitlementOwnershipByItemId.Builder;
            ...
            GetUserEntitlementOwnershipByItemId operation = opBuilder.Build(
                Namespace,
                UserId,
                ItemId
            );
            ...
            var response = wrapper.GetUserEntitlementOwnershipByItemId(operation);
