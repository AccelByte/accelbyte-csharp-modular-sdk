...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class UpdateUserEntitlementCommand: ISdkConsoleCommand
    {
        ...
        public UpdateUserEntitlementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.UpdateUserEntitlement.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Platform.Model.EntitlementUpdate)Body);



            UpdateUserEntitlement operation = opBuilder.Build(
                EntitlementId,
                Namespace,
                UserId
            );
