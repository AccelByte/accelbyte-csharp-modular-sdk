...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetUserEntitlementCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetUserEntitlementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetUserEntitlement.Builder;





            PublicGetUserEntitlement operation = opBuilder.Build(
                EntitlementId,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.PublicGetUserEntitlement(operation);
