...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserEntitlementCommand: ISdkConsoleCommand
    {
        ...
        public GetUserEntitlementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserEntitlement.Builder;





            GetUserEntitlement operation = opBuilder.Build(
                EntitlementId,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.GetUserEntitlement(operation);
