...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserEntitlementHistoriesCommand: ISdkConsoleCommand
    {
        ...
        public GetUserEntitlementHistoriesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserEntitlementHistories.Builder;





            GetUserEntitlementHistories operation = opBuilder.Build(
                EntitlementId,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.GetUserEntitlementHistories(operation);
