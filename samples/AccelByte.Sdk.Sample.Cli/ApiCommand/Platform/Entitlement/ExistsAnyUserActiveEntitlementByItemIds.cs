...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ExistsAnyUserActiveEntitlementByItemIdsCommand: ISdkConsoleCommand
    {
        ...
        public ExistsAnyUserActiveEntitlementByItemIdsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            ExistsAnyUserActiveEntitlementByItemIds operation = opBuilder.Build(
                Namespace,
                UserId,
                ItemIds
            );
            ...
            var response = wrapper.ExistsAnyUserActiveEntitlementByItemIds(operation);
