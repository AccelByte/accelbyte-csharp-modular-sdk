...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ConsumeUserEntitlementCommand: ISdkConsoleCommand
    {
        ...
        public ConsumeUserEntitlementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.ConsumeUserEntitlement.Builder;





            ConsumeUserEntitlement operation = opBuilder.Build(
                Body,
                EntitlementId,
                Namespace,
                UserId
            ...
            var response = wrapper.ConsumeUserEntitlement(operation);
