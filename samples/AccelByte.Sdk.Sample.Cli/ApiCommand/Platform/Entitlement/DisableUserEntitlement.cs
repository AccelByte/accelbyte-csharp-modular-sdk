...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class DisableUserEntitlementCommand : ISdkConsoleCommand
    {
        ...
        public DisableUserEntitlementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.DisableUserEntitlement.Builder;





            DisableUserEntitlement operation = opBuilder.Build(
                EntitlementId,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.DisableUserEntitlement(operation);
