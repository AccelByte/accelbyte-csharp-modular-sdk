...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ExistsAnyUserActiveEntitlementCommand : ISdkConsoleCommand
    {
        ...
        public ExistsAnyUserActiveEntitlementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.ExistsAnyUserActiveEntitlement.Builder;
            ...
            ExistsAnyUserActiveEntitlement operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.ExistsAnyUserActiveEntitlement(operation);
