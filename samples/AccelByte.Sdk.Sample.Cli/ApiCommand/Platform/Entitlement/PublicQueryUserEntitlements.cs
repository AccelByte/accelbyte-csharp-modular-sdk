...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicQueryUserEntitlementsCommand: ISdkConsoleCommand
    {
        ...
        public PublicQueryUserEntitlementsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicQueryUserEntitlements.Builder;

            if (AppType != null)
                opBuilder.SetAppType(PublicQueryUserEntitlementsAppType.NewValue(AppType));
            if (EntitlementClazz != null)
                opBuilder.SetEntitlementClazz(PublicQueryUserEntitlementsEntitlementClazz.NewValue(EntitlementClazz));
            ...
            PublicQueryUserEntitlements operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.PublicQueryUserEntitlements(operation);
