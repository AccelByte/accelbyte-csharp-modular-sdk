...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserAppEntitlementByAppIdCommand: ISdkConsoleCommand
    {
        ...
        public GetUserAppEntitlementByAppIdCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserAppEntitlementByAppId.Builder;
            ...
            GetUserAppEntitlementByAppId operation = opBuilder.Build(
                Namespace,
                UserId,
                AppId
            );
            ...
            var response = wrapper.GetUserAppEntitlementByAppId(operation);
