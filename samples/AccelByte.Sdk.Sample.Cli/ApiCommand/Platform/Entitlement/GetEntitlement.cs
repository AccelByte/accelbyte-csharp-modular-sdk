...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetEntitlementCommand : ISdkConsoleCommand
    {
        ...
        public GetEntitlementCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetEntitlement.Builder;





            GetEntitlement operation = opBuilder.Build(
                EntitlementId,
                Namespace
            );


            var response = wrapper.GetEntitlement(operation);
