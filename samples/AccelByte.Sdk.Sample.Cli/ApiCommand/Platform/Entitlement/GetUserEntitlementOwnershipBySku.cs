...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetUserEntitlementOwnershipBySkuCommand: ISdkConsoleCommand
    {
        ...
        public GetUserEntitlementOwnershipBySkuCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetUserEntitlementOwnershipBySku.Builder;

            if (EntitlementClazz != null)
                opBuilder.SetEntitlementClazz(GetUserEntitlementOwnershipBySkuEntitlementClazz.NewValue(EntitlementClazz));
            if (Platform != null)
            ...
            GetUserEntitlementOwnershipBySku operation = opBuilder.Build(
                Namespace,
                UserId,
                Sku
            );
            ...
            var response = wrapper.GetUserEntitlementOwnershipBySku(operation);
