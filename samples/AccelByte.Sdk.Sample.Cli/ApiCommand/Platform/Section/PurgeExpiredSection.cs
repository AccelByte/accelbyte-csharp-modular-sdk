...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PurgeExpiredSectionCommand: ISdkConsoleCommand
    {
        ...
        public PurgeExpiredSectionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PurgeExpiredSection.Builder;





            PurgeExpiredSection operation = opBuilder.Build(
                Namespace,
                StoreId
            );


            var response = wrapper.PurgeExpiredSection(operation);
