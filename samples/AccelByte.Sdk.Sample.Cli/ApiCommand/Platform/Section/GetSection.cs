...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetSectionCommand : ISdkConsoleCommand
    {
        ...
        public GetSectionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetSection.Builder;
            ...
            GetSection operation = opBuilder.Build(
                Namespace,
                SectionId
            );


            var response = wrapper.GetSection(operation);
