...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class DeleteSectionCommand : ISdkConsoleCommand
    {
        ...
        public DeleteSectionCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.DeleteSection.Builder;





            DeleteSection operation = opBuilder.Build(
                Namespace,
                SectionId,
                StoreId
            );
            ...
            var response = wrapper.DeleteSection(operation);
