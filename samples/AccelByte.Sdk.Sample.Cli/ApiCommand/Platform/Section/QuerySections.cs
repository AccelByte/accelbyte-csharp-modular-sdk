...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class QuerySectionsCommand: ISdkConsoleCommand
    {
        ...
        public QuerySectionsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.QuerySections.Builder;
            ...
            QuerySections operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.QuerySections(operation);
