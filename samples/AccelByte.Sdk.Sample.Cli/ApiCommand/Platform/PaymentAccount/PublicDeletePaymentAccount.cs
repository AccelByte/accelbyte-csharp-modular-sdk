...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicDeletePaymentAccountCommand: ISdkConsoleCommand
    {
        ...
        public PublicDeletePaymentAccountCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicDeletePaymentAccount.Builder;





            PublicDeletePaymentAccount operation = opBuilder.Build(
                Id,
                Namespace,
                Type,
                UserId
            ...
            var response = wrapper.PublicDeletePaymentAccount(operation);
