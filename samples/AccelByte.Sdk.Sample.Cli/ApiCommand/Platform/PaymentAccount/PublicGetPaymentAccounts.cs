...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetPaymentAccountsCommand: ISdkConsoleCommand
    {
        ...
        public PublicGetPaymentAccountsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetPaymentAccounts.Builder;





            PublicGetPaymentAccounts operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.PublicGetPaymentAccounts(operation);
