...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetDescendantCategoriesCommand : ISdkConsoleCommand
    {
        ...
        public PublicGetDescendantCategoriesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetDescendantCategories.Builder;
            ...
            PublicGetDescendantCategories operation = opBuilder.Build(
                CategoryPath,
                Namespace
            );


            var response = wrapper.PublicGetDescendantCategories(operation);
