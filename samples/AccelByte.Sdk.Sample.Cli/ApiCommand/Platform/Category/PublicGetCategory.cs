...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class PublicGetCategoryCommand : ISdkConsoleCommand
    {
        ...
        public PublicGetCategoryCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.PublicGetCategory.Builder;
            ...
            PublicGetCategory operation = opBuilder.Build(
                CategoryPath,
                Namespace
            );


            var response = wrapper.PublicGetCategory(operation);
