...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class ListCategoriesBasicCommand: ISdkConsoleCommand
    {
        ...
        public ListCategoriesBasicCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.ListCategoriesBasic.Builder;
            ...
            ListCategoriesBasic operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.ListCategoriesBasic(operation);
