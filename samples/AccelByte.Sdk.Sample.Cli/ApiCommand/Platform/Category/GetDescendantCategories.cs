...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetDescendantCategoriesCommand: ISdkConsoleCommand
    {
        ...
        public GetDescendantCategoriesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetDescendantCategories.Builder;
            ...
            GetDescendantCategories operation = opBuilder.Build(
                CategoryPath,
                Namespace
            );


            var response = wrapper.GetDescendantCategories(operation);
