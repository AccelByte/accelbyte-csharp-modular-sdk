...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Platform
{
    ...
    public class GetCategoryCommand : ISdkConsoleCommand
    {
        ...
        public GetCategoryCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Platform.Operation.GetCategory.Builder;
            ...
            GetCategory operation = opBuilder.Build(
                CategoryPath,
                Namespace
            );


            var response = wrapper.GetCategory(operation);
