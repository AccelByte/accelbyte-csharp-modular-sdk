...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class SingleAdminGetGroupContentsCommand : ISdkConsoleCommand
    {
        ...
        public SingleAdminGetGroupContentsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.SingleAdminGetGroupContents.Builder;
            ...
            SingleAdminGetGroupContents operation = opBuilder.Build(
                GroupId,
                Namespace
            );


            var response = wrapper.SingleAdminGetGroupContents(operation);
