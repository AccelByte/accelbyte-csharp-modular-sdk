...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminDeleteGroupCommand : ISdkConsoleCommand
    {
        ...
        public AdminDeleteGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminDeleteGroup.Builder;





            AdminDeleteGroup operation = opBuilder.Build(
                GroupId,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.AdminDeleteGroup(operation);
