...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class SingleAdminDeleteGroupCommand : ISdkConsoleCommand
    {
        ...
        public SingleAdminDeleteGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.SingleAdminDeleteGroup.Builder;





            SingleAdminDeleteGroup operation = opBuilder.Build(
                GroupId,
                Namespace
            );


            var response = wrapper.SingleAdminDeleteGroup(operation);
