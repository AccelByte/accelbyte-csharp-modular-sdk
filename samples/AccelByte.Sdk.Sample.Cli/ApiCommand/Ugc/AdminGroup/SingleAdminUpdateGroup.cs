...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class SingleAdminUpdateGroupCommand : ISdkConsoleCommand
    {
        ...
        public SingleAdminUpdateGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.SingleAdminUpdateGroup.Builder;





            SingleAdminUpdateGroup operation = opBuilder.Build(
                Body,
                GroupId,
                Namespace
            );
            ...
            var response = wrapper.SingleAdminUpdateGroup(operation);
