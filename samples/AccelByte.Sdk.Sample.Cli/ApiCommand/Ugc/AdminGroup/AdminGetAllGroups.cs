...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminGetAllGroupsCommand: ISdkConsoleCommand
    {
        ...
        public AdminGetAllGroupsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminGetAllGroups.Builder;
            ...
            AdminGetAllGroups operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.AdminGetAllGroups(operation);
