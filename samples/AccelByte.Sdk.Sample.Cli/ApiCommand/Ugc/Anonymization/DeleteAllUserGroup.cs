...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class DeleteAllUserGroupCommand: ISdkConsoleCommand
    {
        ...
        public DeleteAllUserGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.DeleteAllUserGroup.Builder;





            DeleteAllUserGroup operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.DeleteAllUserGroup(operation);
