...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class DeleteAllUserChannelCommand : ISdkConsoleCommand
    {
        ...
        public DeleteAllUserChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.DeleteAllUserChannel.Builder;





            DeleteAllUserChannel operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.DeleteAllUserChannel(operation);
