...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class GetTagCommand : ISdkConsoleCommand
    {
        ...
        public GetTagCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.GetTag.Builder;
            ...
            GetTag operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetTag(operation);
