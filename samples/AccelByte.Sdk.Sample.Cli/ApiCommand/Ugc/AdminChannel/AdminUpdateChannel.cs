...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminUpdateChannelCommand: ISdkConsoleCommand
    {
        ...
        public AdminUpdateChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminUpdateChannel.Builder;





            AdminUpdateChannel operation = opBuilder.Build(
                Body,
                ChannelId,
                Namespace,
                UserId
            ...
            var response = wrapper.AdminUpdateChannel(operation);
