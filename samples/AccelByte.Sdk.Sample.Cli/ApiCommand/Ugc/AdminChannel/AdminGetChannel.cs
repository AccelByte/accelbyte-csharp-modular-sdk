...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminGetChannelCommand: ISdkConsoleCommand
    {
        ...
        public AdminGetChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminGetChannel.Builder;
            ...
            AdminGetChannel operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.AdminGetChannel(operation);
