...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class SingleAdminGetChannelCommand: ISdkConsoleCommand
    {
        ...
        public SingleAdminGetChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.SingleAdminGetChannel.Builder;
            ...
            SingleAdminGetChannel operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.SingleAdminGetChannel(operation);
