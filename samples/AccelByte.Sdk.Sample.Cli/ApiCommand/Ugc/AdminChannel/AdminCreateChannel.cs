...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminCreateChannelCommand: ISdkConsoleCommand
    {
        ...
        public AdminCreateChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminCreateChannel.Builder;





            AdminCreateChannel operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.AdminCreateChannel(operation);
