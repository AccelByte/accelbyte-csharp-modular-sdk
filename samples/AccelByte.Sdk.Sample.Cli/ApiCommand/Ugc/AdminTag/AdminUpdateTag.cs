...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminUpdateTagCommand: ISdkConsoleCommand
    {
        ...
        public AdminUpdateTagCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminUpdateTag.Builder;





            AdminUpdateTag operation = opBuilder.Build(
                Body,
                Namespace,
                TagId
            );
            ...
            var response = wrapper.AdminUpdateTag(operation);
