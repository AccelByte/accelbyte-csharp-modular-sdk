...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class GetFollowedUsersCommand: ISdkConsoleCommand
    {
        ...
        public GetFollowedUsersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.GetFollowedUsers.Builder;
            ...
            GetFollowedUsers operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetFollowedUsers(operation);
