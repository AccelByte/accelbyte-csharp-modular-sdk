...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class GetPublicFollowersCommand: ISdkConsoleCommand
    {
        ...
        public GetPublicFollowersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.GetPublicFollowers.Builder;
            ...
            GetPublicFollowers operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.GetPublicFollowers(operation);
