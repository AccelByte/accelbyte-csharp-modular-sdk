...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class PublicSearchCreatorCommand: ISdkConsoleCommand
    {
        ...
        public PublicSearchCreatorCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.PublicSearchCreator.Builder;
            ...
            PublicSearchCreator operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.PublicSearchCreator(operation);
