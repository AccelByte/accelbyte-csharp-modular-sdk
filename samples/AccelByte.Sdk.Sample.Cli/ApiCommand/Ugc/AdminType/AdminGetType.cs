...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminGetTypeCommand: ISdkConsoleCommand
    {
        ...
        public AdminGetTypeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminGetType.Builder;
            ...
            AdminGetType operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.AdminGetType(operation);
