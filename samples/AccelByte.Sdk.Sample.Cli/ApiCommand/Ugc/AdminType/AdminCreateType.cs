...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminCreateTypeCommand: ISdkConsoleCommand
    {
        ...
        public AdminCreateTypeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminCreateType.Builder;





            AdminCreateType operation = opBuilder.Build(
                Body,
                Namespace
            );


            var response = wrapper.AdminCreateType(operation);
