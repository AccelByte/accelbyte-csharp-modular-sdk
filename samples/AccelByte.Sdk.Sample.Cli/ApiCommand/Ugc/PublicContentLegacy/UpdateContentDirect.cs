...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class UpdateContentDirectCommand: ISdkConsoleCommand
    {
        ...
        public UpdateContentDirectCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.UpdateContentDirect.Builder;





            UpdateContentDirect operation = opBuilder.Build(
                Body,
                ChannelId,
                ContentId,
                Namespace,
            ...
            var response = wrapper.UpdateContentDirect(operation);
