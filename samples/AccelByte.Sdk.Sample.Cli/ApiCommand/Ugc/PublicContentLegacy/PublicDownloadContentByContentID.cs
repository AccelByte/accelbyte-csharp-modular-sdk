...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class PublicDownloadContentByContentIDCommand: ISdkConsoleCommand
    {
        ...
        public PublicDownloadContentByContentIDCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.PublicDownloadContentByContentID.Builder;





            PublicDownloadContentByContentID operation = opBuilder.Build(
                ContentId,
                Namespace
            );


            var response = wrapper.PublicDownloadContentByContentID(operation);
