...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class PublicGetUserContentCommand : ISdkConsoleCommand
    {
        ...
        public PublicGetUserContentCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.PublicGetUserContent.Builder;
            ...
            PublicGetUserContent operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.PublicGetUserContent(operation);
