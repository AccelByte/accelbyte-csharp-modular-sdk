...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class UpdateScreenshotsCommand: ISdkConsoleCommand
    {
        ...
        public UpdateScreenshotsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.UpdateScreenshots.Builder;





            UpdateScreenshots operation = opBuilder.Build(
                Body,
                ContentId,
                Namespace,
                UserId
            ...
            var response = wrapper.UpdateScreenshots(operation);
