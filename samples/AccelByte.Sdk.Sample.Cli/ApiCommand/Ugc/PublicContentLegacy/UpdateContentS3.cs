...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class UpdateContentS3Command : ISdkConsoleCommand
    {
        ...
        public UpdateContentS3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.UpdateContentS3.Builder;





            UpdateContentS3 operation = opBuilder.Build(
                Body,
                ChannelId,
                ContentId,
                Namespace,
            ...
            var response = wrapper.UpdateContentS3(operation);
