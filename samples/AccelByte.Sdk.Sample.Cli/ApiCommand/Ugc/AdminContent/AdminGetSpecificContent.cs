...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminGetSpecificContentCommand: ISdkConsoleCommand
    {
        ...
        public AdminGetSpecificContentCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminGetSpecificContent.Builder;





            AdminGetSpecificContent operation = opBuilder.Build(
                ContentId,
                Namespace
            );


            var response = wrapper.AdminGetSpecificContent(operation);
