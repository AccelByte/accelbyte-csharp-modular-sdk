...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminGetUserContentByShareCodeCommand: ISdkConsoleCommand
    {
        ...
        public AdminGetUserContentByShareCodeCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminGetUserContentByShareCode.Builder;





            AdminGetUserContentByShareCode operation = opBuilder.Build(
                Namespace,
                ShareCode
            );


            var response = wrapper.AdminGetUserContentByShareCode(operation);
