...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminDownloadContentPreviewCommand : ISdkConsoleCommand
    {
        ...
        public AdminDownloadContentPreviewCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminDownloadContentPreview.Builder;





            AdminDownloadContentPreview operation = opBuilder.Build(
                ContentId,
                Namespace
            );


            var response = wrapper.AdminDownloadContentPreview(operation);
