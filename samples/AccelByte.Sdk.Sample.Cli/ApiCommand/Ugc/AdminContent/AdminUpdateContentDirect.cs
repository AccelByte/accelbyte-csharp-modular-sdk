...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminUpdateContentDirectCommand : ISdkConsoleCommand
    {
        ...
        public AdminUpdateContentDirectCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminUpdateContentDirect.Builder;





            AdminUpdateContentDirect operation = opBuilder.Build(
                Body,
                ChannelId,
                ContentId,
                Namespace,
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.AdminUpdateContentDirect(operation);
