...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminUpdateScreenshotsCommand : ISdkConsoleCommand
    {
        ...
        public AdminUpdateScreenshotsCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminUpdateScreenshots.Builder;





            AdminUpdateScreenshots operation = opBuilder.Build(
                Body,
                ContentId,
                Namespace
            );
            ...
            var response = wrapper.AdminUpdateScreenshots(operation);
