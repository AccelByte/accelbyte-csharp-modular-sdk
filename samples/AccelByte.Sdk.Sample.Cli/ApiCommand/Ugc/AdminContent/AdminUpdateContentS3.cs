...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminUpdateContentS3Command: ISdkConsoleCommand
    {
        ...
        public AdminUpdateContentS3Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminUpdateContentS3.Builder;





            AdminUpdateContentS3 operation = opBuilder.Build(
                Body,
                ChannelId,
                ContentId,
                Namespace,
            ...
            var response = wrapper.AdminUpdateContentS3(operation);
