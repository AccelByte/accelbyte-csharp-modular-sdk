...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminUploadContentDirectCommand : ISdkConsoleCommand
    {
        ...
        public AdminUploadContentDirectCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
...
#pragma warning disable ab_deprecated_operation
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminUploadContentDirect.Builder;





            AdminUploadContentDirect operation = opBuilder.Build(
                Body,
                ChannelId,
                Namespace
            );
...
#pragma warning disable ab_deprecated_operation_wrapper
            var response = wrapper.AdminUploadContentDirect(operation);
