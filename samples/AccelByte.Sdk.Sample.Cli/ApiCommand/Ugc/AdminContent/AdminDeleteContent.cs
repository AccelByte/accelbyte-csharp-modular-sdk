...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class AdminDeleteContentCommand: ISdkConsoleCommand
    {
        ...
        public AdminDeleteContentCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.AdminDeleteContent.Builder;





            AdminDeleteContent operation = opBuilder.Build(
                ChannelId,
                ContentId,
                Namespace,
                UserId
            ...
            var response = wrapper.AdminDeleteContent(operation);
