...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class DeleteChannelCommand: ISdkConsoleCommand
    {
        ...
        public DeleteChannelCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.DeleteChannel.Builder;





            DeleteChannel operation = opBuilder.Build(
                ChannelId,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.DeleteChannel(operation);
