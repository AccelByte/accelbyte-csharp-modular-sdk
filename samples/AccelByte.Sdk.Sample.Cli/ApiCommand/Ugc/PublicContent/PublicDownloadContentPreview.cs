...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class PublicDownloadContentPreviewCommand: ISdkConsoleCommand
    {
        ...
        public PublicDownloadContentPreviewCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.PublicDownloadContentPreview.Builder;





            PublicDownloadContentPreview operation = opBuilder.Build(
                ContentId,
                Namespace
            );
