...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class GetGroupContentCommand : ISdkConsoleCommand
    {
        ...
        public GetGroupContentCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.GetGroupContent.Builder;
            ...
            GetGroupContent operation = opBuilder.Build(
                GroupId,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.GetGroupContent(operation);
