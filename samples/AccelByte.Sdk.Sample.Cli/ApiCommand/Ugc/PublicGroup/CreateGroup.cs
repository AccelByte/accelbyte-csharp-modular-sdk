...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class CreateGroupCommand: ISdkConsoleCommand
    {
        ...
        public CreateGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.CreateGroup.Builder;





            CreateGroup operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.CreateGroup(operation);
