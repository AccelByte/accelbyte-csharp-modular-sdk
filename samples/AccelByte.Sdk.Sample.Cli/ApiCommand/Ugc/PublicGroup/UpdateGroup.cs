...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class UpdateGroupCommand: ISdkConsoleCommand
    {
        ...
        public UpdateGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.UpdateGroup.Builder;





            UpdateGroup operation = opBuilder.Build(
                Body,
                GroupId,
                Namespace,
                UserId
            ...
            var response = wrapper.UpdateGroup(operation);
