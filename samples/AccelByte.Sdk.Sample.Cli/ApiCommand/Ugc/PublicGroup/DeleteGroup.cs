...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Ugc
{
    ...
    public class DeleteGroupCommand: ISdkConsoleCommand
    {
        ...
        public DeleteGroupCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Ugc.Operation.DeleteGroup.Builder;





            DeleteGroup operation = opBuilder.Build(
                GroupId,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.DeleteGroup(operation);
