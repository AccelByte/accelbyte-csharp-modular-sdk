...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Inventory
{
    ...
    public class AdminUpdateInventoryCommand : ISdkConsoleCommand
    {
        ...
        public AdminUpdateInventoryCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Inventory.Operation.AdminUpdateInventory.Builder;





            AdminUpdateInventory operation = opBuilder.Build(
                Body,
                InventoryId,
                Namespace
            );
            ...
            AccelByte.Sdk.Api.Inventory.Model.ApimodelsInventoryResp? response = wrapper.AdminUpdateInventory(operation);
            if (response == null)
