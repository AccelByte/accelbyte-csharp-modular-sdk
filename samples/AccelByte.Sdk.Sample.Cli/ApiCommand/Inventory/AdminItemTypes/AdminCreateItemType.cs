...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Inventory
{
    ...
    public class AdminCreateItemTypeCommand: ISdkConsoleCommand
    {
        ...
        public AdminCreateItemTypeCommand(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            AccelByte.Sdk.Api.Inventory.Model.ApimodelsCreateItemTypeResp? response = wrapper.AdminCreateItemType(operation);
            if (response == null)
