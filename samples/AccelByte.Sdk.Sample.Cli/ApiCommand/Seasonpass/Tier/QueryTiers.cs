...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Seasonpass
{
    ...
    public class QueryTiersCommand: ISdkConsoleCommand
    {
        ...
        public QueryTiersCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Seasonpass.Operation.QueryTiers.Builder;
            ...
            QueryTiers operation = opBuilder.Build(
                Namespace,
                SeasonId
            );


            var response = wrapper.QueryTiers(operation);
