...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Seasonpass
{
    ...
    public class CreateTierCommand: ISdkConsoleCommand
    {
        ...
        public CreateTierCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Seasonpass.Operation.CreateTier.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Seasonpass.Model.TierCreate)Body);



            CreateTier operation = opBuilder.Build(
                Namespace,
                SeasonId
            );


            var response = wrapper.CreateTier(operation);
