...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Seasonpass
{
    ...
    public class UnpublishSeasonCommand : ISdkConsoleCommand
    {
        ...
        public UnpublishSeasonCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Seasonpass.Operation.UnpublishSeason.Builder;
            ...
            UnpublishSeason operation = opBuilder.Build(
                Namespace,
                SeasonId
            );


            var response = wrapper.UnpublishSeason(operation);
