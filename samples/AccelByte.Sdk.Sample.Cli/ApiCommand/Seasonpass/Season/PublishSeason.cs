...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Seasonpass
{
    ...
    public class PublishSeasonCommand: ISdkConsoleCommand
    {
        ...
        public PublishSeasonCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Seasonpass.Operation.PublishSeason.Builder;





            PublishSeason operation = opBuilder.Build(
                Namespace,
                SeasonId
            );


            var response = wrapper.PublishSeason(operation);
