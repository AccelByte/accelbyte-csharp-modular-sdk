...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Seasonpass
{
    ...
    public class CreateRewardCommand : ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Seasonpass.Operation.CreateReward.Builder;


            if (Body != null)
                opBuilder.SetBody((AccelByte.Sdk.Api.Seasonpass.Model.RewardCreate)Body);
            ...
            var response = wrapper.CreateReward(operation);
