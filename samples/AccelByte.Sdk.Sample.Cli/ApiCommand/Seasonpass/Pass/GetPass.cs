...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Seasonpass
{
    ...
    public class GetPassCommand: ISdkConsoleCommand
    {
        ...
        public GetPassCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Seasonpass.Operation.GetPass.Builder;





            GetPass operation = opBuilder.Build(
                Code,
                Namespace,
                SeasonId
            );
            ...
            var response = wrapper.GetPass(operation);
