...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Seasonpass
{
    ...
    public class QueryPassesCommand : ISdkConsoleCommand
    {
        ...
        public QueryPassesCommand(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Seasonpass.Operation.QueryPasses.Builder;





            QueryPasses operation = opBuilder.Build(
                Namespace,
                SeasonId
            );


            var response = wrapper.QueryPasses(operation);
