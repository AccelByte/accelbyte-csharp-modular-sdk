...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetCurrentMonthLeaderboardRankingAdminV1Command: ISdkConsoleCommand
    {
        ...
        public GetCurrentMonthLeaderboardRankingAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.GetCurrentMonthLeaderboardRankingAdminV1.Builder;
            ...
            GetCurrentMonthLeaderboardRankingAdminV1 operation = opBuilder.Build(
                LeaderboardCode,
                Namespace
            );


            var response = wrapper.GetCurrentMonthLeaderboardRankingAdminV1(operation);
