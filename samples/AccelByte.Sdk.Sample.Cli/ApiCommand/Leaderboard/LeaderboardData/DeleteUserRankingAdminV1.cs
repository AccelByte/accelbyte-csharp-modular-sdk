...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class DeleteUserRankingAdminV1Command : ISdkConsoleCommand
    {
        ...
        public DeleteUserRankingAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.DeleteUserRankingAdminV1.Builder;





            DeleteUserRankingAdminV1 operation = opBuilder.Build(
                LeaderboardCode,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.DeleteUserRankingAdminV1(operation);
