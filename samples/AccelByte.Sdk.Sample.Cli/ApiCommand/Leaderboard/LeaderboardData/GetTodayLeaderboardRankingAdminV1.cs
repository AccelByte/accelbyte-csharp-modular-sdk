...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetTodayLeaderboardRankingAdminV1Command: ISdkConsoleCommand
    {
        ...
        public GetTodayLeaderboardRankingAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.GetTodayLeaderboardRankingAdminV1.Builder;
            ...
            GetTodayLeaderboardRankingAdminV1 operation = opBuilder.Build(
                LeaderboardCode,
                Namespace
            );


            var response = wrapper.GetTodayLeaderboardRankingAdminV1(operation);
