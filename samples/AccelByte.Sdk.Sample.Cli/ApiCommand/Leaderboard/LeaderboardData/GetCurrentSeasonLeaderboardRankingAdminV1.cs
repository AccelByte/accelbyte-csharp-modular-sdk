...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetCurrentSeasonLeaderboardRankingAdminV1Command : ISdkConsoleCommand
    {
        ...
        public GetCurrentSeasonLeaderboardRankingAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.GetCurrentSeasonLeaderboardRankingAdminV1.Builder;
            ...
            GetCurrentSeasonLeaderboardRankingAdminV1 operation = opBuilder.Build(
                LeaderboardCode,
                Namespace
            );


            var response = wrapper.GetCurrentSeasonLeaderboardRankingAdminV1(operation);
