...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetCurrentSeasonLeaderboardRankingPublicV1Command: ISdkConsoleCommand
    {
        ...
        public GetCurrentSeasonLeaderboardRankingPublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.GetCurrentSeasonLeaderboardRankingPublicV1.Builder;
            ...
            GetCurrentSeasonLeaderboardRankingPublicV1 operation = opBuilder.Build(
                LeaderboardCode,
                Namespace
            );


            var response = wrapper.GetCurrentSeasonLeaderboardRankingPublicV1(operation);
