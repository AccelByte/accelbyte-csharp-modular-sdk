...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetAllTimeLeaderboardRankingPublicV1Command: ISdkConsoleCommand
    {
        ...
        public GetAllTimeLeaderboardRankingPublicV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.GetAllTimeLeaderboardRankingPublicV1.Builder;
            ...
            GetAllTimeLeaderboardRankingPublicV1 operation = opBuilder.Build(
                LeaderboardCode,
                Namespace
            );


            var response = wrapper.GetAllTimeLeaderboardRankingPublicV1(operation);
