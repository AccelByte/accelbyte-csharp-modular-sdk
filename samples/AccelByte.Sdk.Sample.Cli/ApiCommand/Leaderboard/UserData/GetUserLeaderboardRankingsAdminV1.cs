...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetUserLeaderboardRankingsAdminV1Command : ISdkConsoleCommand
    {
        ...
        public GetUserLeaderboardRankingsAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.GetUserLeaderboardRankingsAdminV1.Builder;
            ...
            GetUserLeaderboardRankingsAdminV1 operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.GetUserLeaderboardRankingsAdminV1(operation);
