...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class SetUserVisibilityStatusV2Command: ISdkConsoleCommand
    {
        ...
        public SetUserVisibilityStatusV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.SetUserVisibilityStatusV2.Builder;





            SetUserVisibilityStatusV2 operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.SetUserVisibilityStatusV2(operation);
