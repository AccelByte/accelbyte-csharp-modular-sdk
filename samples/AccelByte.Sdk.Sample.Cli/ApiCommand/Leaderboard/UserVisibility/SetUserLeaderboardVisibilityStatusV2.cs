...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class SetUserLeaderboardVisibilityStatusV2Command : ISdkConsoleCommand
    {
        ...
        public SetUserLeaderboardVisibilityStatusV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.SetUserLeaderboardVisibilityStatusV2.Builder;





            SetUserLeaderboardVisibilityStatusV2 operation = opBuilder.Build(
                Body,
                LeaderboardCode,
                Namespace,
                UserId
            ...
            var response = wrapper.SetUserLeaderboardVisibilityStatusV2(operation);
