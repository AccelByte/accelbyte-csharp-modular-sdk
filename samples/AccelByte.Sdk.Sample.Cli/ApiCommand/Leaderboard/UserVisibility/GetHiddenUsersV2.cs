...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetHiddenUsersV2Command : ISdkConsoleCommand
    {
        ...
        public GetHiddenUsersV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.GetHiddenUsersV2.Builder;
            ...
            GetHiddenUsersV2 operation = opBuilder.Build(
                LeaderboardCode,
                Namespace
            );


            var response = wrapper.GetHiddenUsersV2(operation);
