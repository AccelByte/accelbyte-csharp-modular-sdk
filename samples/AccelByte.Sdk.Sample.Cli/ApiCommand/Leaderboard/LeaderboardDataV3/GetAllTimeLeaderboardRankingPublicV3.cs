...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetAllTimeLeaderboardRankingPublicV3Command: ISdkConsoleCommand
    {
        ...
        public GetAllTimeLeaderboardRankingPublicV3Command(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            AccelByte.Sdk.Api.Leaderboard.Model.ModelsGetLeaderboardRankingResp? response = wrapper.GetAllTimeLeaderboardRankingPublicV3(operation);
            if (response == null)
