...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetCurrentCycleLeaderboardRankingPublicV3Command: ISdkConsoleCommand
    {
        ...
        public GetCurrentCycleLeaderboardRankingPublicV3Command(AccelByteSDK sdk)
        {
            _SDK = sdk;
        }
        ...
        public string Run()
        {
            ...
            AccelByte.Sdk.Api.Leaderboard.Model.ModelsGetLeaderboardRankingResp? response = wrapper.GetCurrentCycleLeaderboardRankingPublicV3(operation);
            if (response == null)
