...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class UpdateLeaderboardConfigurationAdminV1Command: ISdkConsoleCommand
    {
        ...
        public UpdateLeaderboardConfigurationAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.UpdateLeaderboardConfigurationAdminV1.Builder;





            UpdateLeaderboardConfigurationAdminV1 operation = opBuilder.Build(
                Body,
                LeaderboardCode,
                Namespace
            );
            ...
            var response = wrapper.UpdateLeaderboardConfigurationAdminV1(operation);
