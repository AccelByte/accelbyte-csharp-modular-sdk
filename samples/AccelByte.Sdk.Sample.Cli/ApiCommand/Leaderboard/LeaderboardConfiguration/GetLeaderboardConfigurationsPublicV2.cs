...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class GetLeaderboardConfigurationsPublicV2Command : ISdkConsoleCommand
    {
        ...
        public GetLeaderboardConfigurationsPublicV2Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.GetLeaderboardConfigurationsPublicV2.Builder;
            ...
            GetLeaderboardConfigurationsPublicV2 operation = opBuilder.Build(
                Namespace
            );


            var response = wrapper.GetLeaderboardConfigurationsPublicV2(operation);
