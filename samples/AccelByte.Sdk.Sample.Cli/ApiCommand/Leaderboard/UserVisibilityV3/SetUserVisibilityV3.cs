...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class SetUserVisibilityV3Command: ISdkConsoleCommand
    {
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.SetUserVisibilityV3.Builder;





            SetUserVisibilityV3 operation = opBuilder.Build(
                Body,
                Namespace,
                UserId
            );
            ...
            var response = wrapper.SetUserVisibilityV3(operation);
