...
namespace AccelByte.Sdk.Sample.Cli.ApiCommand.Leaderboard
{
    ...
    public class AdminAnonymizeUserLeaderboardAdminV1Command : ISdkConsoleCommand
    {
        ...
        public AdminAnonymizeUserLeaderboardAdminV1Command(IAccelByteSdk sdk)
        {
            _SDK = sdk;
        }
        ...
        public CommandResult Run()
        {
            ...
            var opBuilder = AccelByte.Sdk.Api.Leaderboard.Operation.AdminAnonymizeUserLeaderboardAdminV1.Builder;





            AdminAnonymizeUserLeaderboardAdminV1 operation = opBuilder.Build(
                Namespace,
                UserId
            );


            var response = wrapper.AdminAnonymizeUserLeaderboardAdminV1(operation);
