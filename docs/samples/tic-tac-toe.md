...
- Read [.NET (C#) SDK Getting Started Guide](https://docs.accelbyte.io/gaming-services/modules/foundations/extend/extend-sdk/get-started-with-extend-sdk/) on how to integrate SDK into your project.
